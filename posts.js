...
window.postsData = [
  ...
  },
  {
    ...
    "cat": "Astronomia",
    "catCls": "astronomia",
    "img": "https://assets.science.nasa.gov/content/dam/science/esd/eo/images/iotd/2026/digging-back-in-time-in-the-uae/fayapaleo_oli_20251023_th.jpg/jcr:content/renditions/cq5dam.web.1280.1280.jpeg",
    "inline_images": [
      {
        "src": "https://assets.science.nasa.gov/content/dam/science/esd/eo/images/iotd/2026/digging-back-in-time-in-the-uae/fayapaleo_oli_20251023_lrg.jpg",
        "alt": "",
        "alt_pt": "",
        "alt_en": "",
        "caption": "",
    ...
    "body": "<p>A paisagem ao redor de Jabal al Fāyah é caracterizada por uma série de cristas claras que se erguem dramaticamente da planície desértica, assemelhando-se a uma barbatana. A maior dessas formações, o próprio Jabal al Fāyah, atinge uma altitude de 412 metros (1.352 pés) acima do nível do mar. Essas cordilheiras, que cortam o Emirado de Sharjah, na parte norte dos Emirados Árabes Unidos, foram capturadas em uma imagem detalhada pelo OLI (Operational Land Imager) a bordo do satélite Landsat 8 em 23 de outubro de 2025. A oeste dessas cordilheiras calcárias, encontra-se a cidade de Dubai, enquanto a leste se estendem as imponentes montanhas Al-Hajar, delineando uma geografia que moldou a vida e a migração ao longo da história.</p><p>A inscrição de Jabal al Fāyah como Patrimônio Mundial da UNESCO em 2025 sublinha sua relevância arqueológica global. A área e partes da paisagem circundante estão repletas de dezenas de sítios arqueológicos que documentam a ocupação humana na Península Arábica. Esses locais abrangem um período extenso, datando de 210.000 a 120.000 anos atrás, correspondendo ao Paleolítico Médio. A riqueza de artefatos e vestígios encontrados oferece uma cronologia detalhada da presença humana, revelando padrões de assentamento, tecnologias e adaptações a ambientes em constante mudança.</p><p>Entre as descobertas mais significativas, alguns dos sítios arqueológicos em Jabal al Fāyah apresentam evidências de ocupação intermitente que se iniciou há impressionantes 210.000 anos. Este dado posiciona o local como um dos mais antigos registros de habitação humana na Península Arábica, fornecendo informações cruciais para a compreensão das rotas de dispersão dos primeiros humanos modernos para fora da África. A presença humana tão remota nesta região desafia e complementa teorias existentes sobre as migrações pré-históricas, sugerindo caminhos e cronologias mais complexas do que se pensava anteriormente.</p><p>A importância de Jabal al Fāyah reside não apenas na sua antiguidade, mas também na sua capacidade de conectar a história geológica com a evolução humana. A transição de um ambiente marinho para um desértico, juntamente com a persistência da vida humana ao longo de eras de mudanças climáticas, oferece um estudo de caso fascinante sobre resiliência e adaptação. Este Patrimônio Mundial da UNESCO é, portanto, um farol para pesquisadores e para o público, iluminando um capítulo fundamental da história da Terra e da humanidade, e reforçando a necessidade de preservar tais locais para futuras gerações.</p><p>O estudo de Jabal al Fāyah não se restringe à arqueologia; ele se insere em um contexto mais amplo da história da ciência, explorando as dimensões humanas da adaptação e do desenvolvimento. A análise dos padrões de assentamento e das ferramentas encontradas contribui para a compreensão de como as sociedades antigas interagiam com seu ambiente e como as inovações tecnológicas permitiram a sobrevivência em condições desafiadoras. Este local oferece uma perspectiva única sobre a evolução das comunidades humanas e sua capacidade de prosperar em paisagens que hoje parecem inóspitas, conectando o passado remoto com as discussões contemporâneas sobre sustentabilidade e resiliência.</p>",
    "body_pt": "<p>A paisagem ao redor de Jabal al Fāyah é caracterizada por uma série de cristas claras que se erguem dramaticamente da planície desértica, assemelhando-se a uma barbatana. A maior dessas formações, o próprio Jabal al Fāyah, atinge uma altitude de 412 metros (1.352 pés) acima do nível do mar. Essas cordilheiras, que cortam o Emirado de Sharjah, na parte norte dos Emirados Árabes Unidos, foram capturadas em uma imagem detalhada pelo OLI (Operational Land Imager) a bordo do satélite Landsat 8 em 23 de outubro de 2025. A oeste dessas cordilheiras calcárias, encontra-se a cidade de Dubai, enquanto a leste se estendem as imponentes montanhas Al-Hajar, delineando uma geografia que moldou a vida e a migração ao longo da história.</p><p>A inscrição de Jabal al Fāyah como Patrimônio Mundial da UNESCO em 2025 sublinha sua relevância arqueológica global. A área e partes da paisagem circundante estão repletas de dezenas de sítios arqueológicos que documentam a ocupação humana na Península Arábica. Esses locais abrangem um período extenso, datando de 210.000 a 120.000 anos atrás, correspondendo ao Paleolítico Médio. A riqueza de artefatos e vestígios encontrados oferece uma cronologia detalhada da presença humana, revelando padrões de assentamento, tecnologias e adaptações a ambientes em constante mudança.</p><p>Entre as descobertas mais significativas, alguns dos sítios arqueológicos em Jabal al Fāyah apresentam evidências de ocupação intermitente que se iniciou há impressionantes 210.000 anos. Este dado posiciona o local como um dos mais antigos registros de habitação humana na Península Arábica, fornecendo informações cruciais para a compreensão das rotas de dispersão dos primeiros humanos modernos para fora da África. A presença humana tão remota nesta região desafia e complementa teorias existentes sobre as migrações pré-históricas, sugerindo caminhos e cronologias mais complexas do que se pensava anteriormente.</p><p>A importância de Jabal al Fāyah reside não apenas na sua antiguidade, mas também na sua capacidade de conectar a história geológica com a evolução humana. A transição de um ambiente marinho para um desértico, juntamente com a persistência da vida humana ao longo de eras de mudanças climáticas, oferece um estudo de caso fascinante sobre resiliência e adaptação. Este Patrimônio Mundial da UNESCO é, portanto, um farol para pesquisadores e para o público, iluminando um capítulo fundamental da história da Terra e da humanidade, e reforçando a necessidade de preservar tais locais para futuras gerações.</p><p>O estudo de Jabal al Fāyah não se restringe à arqueologia; ele se insere em um contexto mais amplo da história da ciência, explorando as dimensões humanas da adaptação e do desenvolvimento. A análise dos padrões de assentamento e das ferramentas encontradas contribui para a compreensão de como as sociedades antigas interagiam com seu ambiente e como as inovações tecnológicas permitiram a sobrevivência em condições desafiadoras. Este local oferece uma perspectiva única sobre a evolução das comunidades humanas e sua capacidade de prosperar em paisagens que hoje parecem inóspitas, conectando o passado remoto com as discussões contemporâneas sobre sustentabilidade e resiliência.</p>",
    "body_en": "<p>Once below a shallow sea, Jabal al Fāyah now stands above the desert in the United Arab Emirates as a reminder of a watery past and early human survival. The institutional report frames the development in practical terms and ties it to the broader mission or observing effort.</p><p>This matters because astronomy does not advance on single detections. The field builds confidence by accumulating independent observations across different wavelengths, instruments and epochs until isolated signals become defensible conclusions. What looks convincing in one dataset can dissolve when a second instrument looks at the same target, and what looks marginal can solidify when follow-up campaigns confirm the original reading. The current standard requires that a result survive this triangulation before the community treats it as settled. Dubai lies to the west of the limestone ridges, and the Al-Hajar Mountains lie to the east, in an image acquired by the OLI (Operational Land Imager) on Landsat 8 on October 23. Cond é Nast Traveller (2025, July 15) This new UNESCO World Heritage site in the UAE preserves the Middle East’s earliest evidence of modern humans.</p><p>Stay up-to-date with the latest content from NASA as we explore the universe and discover more about our home planet. Earth Observatory Image of the Day NASA’s Earth Observatory brings you the Earth, every day, with in-depth stories and stunning imagery.</p><p>Article View more Images of the Day: Jun 5, 2026 Instruments: Landsat 8, OLI Topics: History of Science Human Dimensions Urban Development Jabal al Fāyah rises from the Rub’ al. A series of pale ridges rises finlike from the desert plain, with the largest, Jabal al Fāyah, standing 412 meters (1, 352 feet) above sea level.</p><p>The Landsat 8 satellite captured this image of the ridges cutting across the Emirate of Sharjah in the northern part of the United Arab Emirates on October 23, 2025. The ridges and parts of the surrounding landscape, inscribed as a UNESCO World Heritage site in 2025, are dotted with dozens of archaeological sites that trace human occupation on.</p><p>What gives the story weight is not just the object itself, but the way the measurement trims the range of plausible physical explanations. Astronomy has accumulated enough cases to know that the most interesting results are rarely the ones that confirm expectations cleanly; they are the ones that confirm some expectations while complicating others, or that open a parameter space that previous instruments could not reach. The scientific community evaluates these contributions by asking whether the new data constrain a model in a way that older data could not, and whether those constraints survive systematic review.</p><p>Some of the sites show evidence of intermittent occupation beginning as early as 210, 000 years ago, making this one of the earliest signs of human habitation on the Arabian. NASA&#x27;s Earth Observatory brings you the Earth, every day, with in-depth stories and stunning imagery.</p><p>Because the account originates with NASA News Releases, it functions best as a primary institutional report that is close to the data and operations, not as independent scientific validation. Institutional communications are produced by organizations with legitimate interests in presenting their work in a favorable light, which does not make them unreliable but does make them partial. Details that complicate the narrative, including instrument limitations, unexpected failures and results below projections, tend to be minimized relative to progress messages. Technical documentation and peer-reviewed publications, where they exist, provide the complementary layer that institutional releases cannot substitute.</p><p>The next step is to see whether other instruments and other wavelengths tell the same story. Campaigns with JWST, the VLT, the forthcoming Extremely Large Telescopes and radio arrays will provide the spectral coverage and spatial resolution needed to move from detection to physical characterization. The timeline for that kind of confirmation is typically measured in years, not months, which is worth keeping in mind when reading the current result.</p><p class=\"art-source\"><a href=\"https://science.nasa.gov/earth/earth-observatory/digging-back-in-time-in-the-uae/\" target=\"_blank\" rel=\"noopener noreferrer\">Source</a></p>",
    "highlights": [
      "Em foco: Outrora abaixo de um mar raso, Jabal al Fāyah agora está acima do deserto nos Emirados Árabes Unidos como uma lembrança de um passado aquático e da",
      "Detalhe: Origem institucional: distinguir anúncio de evidência",
      "Leitura editorial: release institucional, útil como fonte primária, mas não como validação independente."
    ],
    "highlights_pt": [
    ...
    "realUrl": "https://www.cosmosweek.com/?article=digging-back-in-time-in-the-uae",
    "realUrl_pt": "https://www.cosmosweek.com/?article=digging-back-in-time-in-the-uae",
    "realUrl_en": "https://www.cosmosweek.com/?article=digging-back-in-time-in-the-uae&lang=en",
    "shareUrl": "https://www.cosmosweek.com/noticia/digging-back-in-time-in-the-uae/",
    "shareUrl_pt": "https://www.cosmosweek.com/noticia/digging-back-in-time-in-the-uae/",
    "shareUrl_en": "https://www.cosmosweek.com/en/news/digging-back-in-time-in-the-uae/",
    "canonicalUrl": "https://www.cosmosweek.com/noticia/digging-back-in-time-in-the-uae/",
    "canonicalUrl_pt": "https://www.cosmosweek.com/noticia/digging-back-in-time-in-the-uae/",
    "canonicalUrl_en": "https://www.cosmosweek.com/en/news/digging-back-in-time-in-the-uae/",
    "defaultLanguage": "pt-BR",
    "availableLanguages": [
      "pt-BR",
      "en-US"
    ...
    "imageAlt": "Voltando no tempo nos Emirados Árabes Unidos",
    "imageAlt_pt": "Voltando no tempo nos Emirados Árabes Unidos",
    "imageAlt_en": "Digging Back in Time in the UAE",
    "coverageKind": "agency",
    "coverageKindLabel": "Fonte institucional",
    "coverageKindLabel_pt": "Fonte institucional",
    "coverageKindLabel_en": "Institutional source",
  ...
  },
  {
    ...
    "cat": "Ciências da Terra",
    "catCls": "terra",
    "img": "https://images-assets.nasa.gov/image/jsc2026e001967/jsc2026e001967~large.jpg",
    "inline_images": [
      {
    ...
    "realUrl": "https://www.cosmosweek.com/?article=nasa-s-artemis-ii-moon-mission-research-continues-on-earth",
    "realUrl_pt": "https://www.cosmosweek.com/?article=nasa-s-artemis-ii-moon-mission-research-continues-on-earth",
    "realUrl_en": "https://www.cosmosweek.com/?article=nasa-s-artemis-ii-moon-mission-research-continues-on-earth&lang=en",
    "shareUrl": "https://www.cosmosweek.com/noticia/nasa-s-artemis-ii-moon-mission-research-continues-on-earth/",
    "shareUrl_pt": "https://www.cosmosweek.com/noticia/nasa-s-artemis-ii-moon-mission-research-continues-on-earth/",
    "shareUrl_en": "https://www.cosmosweek.com/en/news/nasa-s-artemis-ii-moon-mission-research-continues-on-earth/",
    "canonicalUrl": "https://www.cosmosweek.com/noticia/nasa-s-artemis-ii-moon-mission-research-continues-on-earth/",
    "canonicalUrl_pt": "https://www.cosmosweek.com/noticia/nasa-s-artemis-ii-moon-mission-research-continues-on-earth/",
    "canonicalUrl_en": "https://www.cosmosweek.com/en/news/nasa-s-artemis-ii-moon-mission-research-continues-on-earth/",
    "defaultLanguage": "pt-BR",
    "availableLanguages": [
      "pt-BR",
      "en-US"
    ...
    "imageAlt": "A pesquisa da missão lunar Artemis II da NASA continua na Terra",
    "imageAlt_pt": "A pesquisa da missão lunar Artemis II da NASA continua na Terra",
    "imageAlt_en": "NASA’s Artemis II Moon Mission Research Continues on Earth",
    "coverageKind": "agency",
    "coverageKindLabel": "Fonte institucional",
    "coverageKindLabel_pt": "Fonte institucional",
    "coverageKindLabel_en": "Institutional source",
  ...
  },
  {
    ...
    "highlights": [
      "Ponto central: Ao longo da última década, incêndios florestais intensificaram a poluição por ozônio no nível do solo em grande parte dos Estados Unidos contíguos.",
      "Dado-chave: Ao longo da última década, incêndios florestais intensificaram a poluição por ozônio no nível do solo em grande parte dos Estados Unidos.",
      "Origem institucional: distinguir anúncio de evidência."
    ],
    "highlights_pt": [
      "Ponto central: Ao longo da última década, incêndios florestais intensificaram a poluição por ozônio no nível do solo em grande parte dos Estados Unidos contíguos.",
    ...
    "highlights_en": [
      ...
      "Key detail: Over the last decade, wildfires have worsened ground-level ozone pollution across much of the contiguous United States, creating unhealthy air.",
      "Institutional origin: separate announcement from evidence."
    ],
    "date": "04 jun 2026",
    "date_pt": "04 jun 2026",
