...
window.postsData = [
  ...
  },
  {
    ...
    "highlights": [
      "Ponto central: Utilizando dados do Observatório de Raios-X Chandra da NASA, astrônomos podem ter identificado um possível remanescente de supernova em uma região.",
      "Dado-chave: Utilizando dados do Observatório de Raios-X Chandra da NASA, astrônomos podem ter identificado um possível remanescente de supernova em uma.",
  ...
  },
  {
    ...
    "highlights": [
      ...
      "Dado-chave: Um novo tipo de sensor de raios gama desenvolvido pela NASA participará de uma demonstração de braço robótico na próxima missão Fly Foundational",
      "Origem institucional: distinguir anúncio de evidência."
    ],
    "highlights_pt": [
      "Ponto central: Um novo tipo de sensor de raios gama desenvolvido pela NASA participará de uma demonstração de braço robótico na próxima missão Fly Foundational.",
    ...
    "highlights_en": [
      ...
      "Key detail: A new type of gamma-ray sensor developed by NASA will take part in a robotic arm demonstration on the agency’s upcoming Fly Foundational Robots",
      "Institutional origin: separate announcement from evidence."
    ],
    "date": "11 jun 2026",
    "date_pt": "11 jun 2026",
