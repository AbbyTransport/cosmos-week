...
window.postsData = [
  {
    ...
    "catCls": "terra",
    "img": "https://www.nasa.gov/wp-content/uploads/2026/07/mmea.png",
    "inline_images": [],
    "video": null,
    "audio": null,
    "title": "NASA Busca Voluntários para Simulação de Missão à Lua e Marte",
    "title_pt": "NASA Busca Voluntários para Simulação de Missão à Lua e Marte",
    "title_en": "NASA Seeks Volunteers for New Yearlong Simulated Moon, Mars Mission",
    "sub": "A NASA está recrutando participantes para sua próxima missão simulada de exploração espacial profunda.",
    "sub_pt": "A NASA está recrutando participantes para sua próxima missão simulada de exploração espacial profunda.",
    "sub_en": "NASA is recruiting research participants for the agency’s next simulated deep space mission.",
    "excerpt": "A NASA está recrutando participantes para sua próxima missão simulada de exploração espacial profunda.",
    "excerpt_pt": "A NASA está recrutando participantes para sua próxima missão simulada de exploração espacial profunda.",
    ...
    "body": "<p>A NASA está ativamente recrutando participantes para sua próxima missão simulada de exploração espacial profunda, um projeto crucial para o avanço das futuras viagens tripuladas à Lua e a Marte. A partir de agosto de 2027, os voluntários selecionados embarcarão em uma experiência de um ano, vivendo e trabalhando em ambientes interplanetários simulados. Esta iniciativa, denominada Analógico de Exploração da Lua e de Marte, visa replicar as condições e desafios enfrentados por astronautas em missões de longa duração, fornecendo dados valiosos para garantir a segurança e a eficácia das operações espaciais.</p><p>Os participantes desta missão analógica residirão em habitats confinados no Centro Espacial Johnson da agência, em Houston, Texas. Durante o período de um ano, eles operarão sob condições de isolamento que espelham as expectativas para missões tripuladas ao satélite natural da Terra ou ao Planeta Vermelho. As tarefas incluirão atividades imersivas e interativas, simulando a vida e o trabalho em superfícies extraterrestres, com o objetivo de coletar informações detalhadas sobre a adaptação humana a esses ambientes extremos.</p><p>Os conhecimentos obtidos a partir desta experiência de um ano serão fundamentais para aprimorar os protocolos de segurança e a prontidão dos astronautas em futuras operações planetárias. Os resultados da missão Analógica de Exploração da Lua e de Marte também contribuirão significativamente para os planos da NASA de estabelecer uma presença lunar sustentada, por meio da Base Lunar, e para o desenvolvimento das futuras missões Artemis. Esta abordagem integrada busca agilizar a avaliação da adaptação da tripulação, combinando elementos das missões HERA (Human Exploration Research Analog) e CHAPEA (Crew Health And Performance Exploration Analog).</p><p>Para esta simulação de aproximadamente um ano, a agência espacial busca candidatos com um forte desejo por experiências únicas e gratificantes, além de um genuíno interesse em contribuir para os esforços da NASA na preparação para estadias prolongadas na superfície lunar e para a primeira missão tripulada a Marte. Os voluntários desempenharão um papel vital na compreensão dos desafios físicos e psicológicos associados a essas jornadas, ajudando a moldar as estratégias para o bem-estar e o desempenho da tripulação em ambientes de recursos limitados.</p><p>Durante a simulação, os participantes imitarão operações de superfície, incluindo caminhadas simuladas em Marte e o uso de um rover para explorar locais além do habitat principal. Ao longo de toda a missão Analógica de Exploração da Lua e de Marte, os pesquisadores conduzirão estudos aprofundados sobre a saúde e o desempenho da tripulação, considerando as limitações de recursos e as exigências rigorosas da missão. Esses dados serão cruciais para otimizar o design de futuras espaçonaves, habitats e procedimentos operacionais, garantindo o sucesso e a segurança das explorações humanas no espaço profundo.</p>",
    "body_pt": "<p>A NASA está ativamente recrutando participantes para sua próxima missão simulada de exploração espacial profunda, um projeto crucial para o avanço das futuras viagens tripuladas à Lua e a Marte. A partir de agosto de 2027, os voluntários selecionados embarcarão em uma experiência de um ano, vivendo e trabalhando em ambientes interplanetários simulados. Esta iniciativa, denominada Analógico de Exploração da Lua e de Marte, visa replicar as condições e desafios enfrentados por astronautas em missões de longa duração, fornecendo dados valiosos para garantir a segurança e a eficácia das operações espaciais.</p><p>Os participantes desta missão analógica residirão em habitats confinados no Centro Espacial Johnson da agência, em Houston, Texas. Durante o período de um ano, eles operarão sob condições de isolamento que espelham as expectativas para missões tripuladas ao satélite natural da Terra ou ao Planeta Vermelho. As tarefas incluirão atividades imersivas e interativas, simulando a vida e o trabalho em superfícies extraterrestres, com o objetivo de coletar informações detalhadas sobre a adaptação humana a esses ambientes extremos.</p><p>Os conhecimentos obtidos a partir desta experiência de um ano serão fundamentais para aprimorar os protocolos de segurança e a prontidão dos astronautas em futuras operações planetárias. Os resultados da missão Analógica de Exploração da Lua e de Marte também contribuirão significativamente para os planos da NASA de estabelecer uma presença lunar sustentada, por meio da Base Lunar, e para o desenvolvimento das futuras missões Artemis. Esta abordagem integrada busca agilizar a avaliação da adaptação da tripulação, combinando elementos das missões HERA (Human Exploration Research Analog) e CHAPEA (Crew Health And Performance Exploration Analog).</p><p>Para esta simulação de aproximadamente um ano, a agência espacial busca candidatos com um forte desejo por experiências únicas e gratificantes, além de um genuíno interesse em contribuir para os esforços da NASA na preparação para estadias prolongadas na superfície lunar e para a primeira missão tripulada a Marte. Os voluntários desempenharão um papel vital na compreensão dos desafios físicos e psicológicos associados a essas jornadas, ajudando a moldar as estratégias para o bem-estar e o desempenho da tripulação em ambientes de recursos limitados.</p><p>Durante a simulação, os participantes imitarão operações de superfície, incluindo caminhadas simuladas em Marte e o uso de um rover para explorar locais além do habitat principal. Ao longo de toda a missão Analógica de Exploração da Lua e de Marte, os pesquisadores conduzirão estudos aprofundados sobre a saúde e o desempenho da tripulação, considerando as limitações de recursos e as exigências rigorosas da missão. Esses dados serão cruciais para otimizar o design de futuras espaçonaves, habitats e procedimentos operacionais, garantindo o sucesso e a segurança das explorações humanas no espaço profundo.</p>",
    "body_en": "<p>NASA is recruiting research participants for the agency’s next simulated deep space mission. Beginning no earlier than August 2027, research volunteers will spend one year living and working in interplanetary environments at the agency’s. The institutional report frames the development in practical terms and ties it to the broader mission or observing effort.</p><p>It matters because Earth science becomes stronger when local observations can be placed inside a broader physical pattern that spans time and geography. The planet operates as a coupled system in which atmospheric, oceanic, cryospheric and solid-Earth processes interact across timescales from days to millions of years. A measurement that captures one variable at one location and one moment has limited interpretive value until it is embedded in the longer series and wider spatial coverage that allow natural variability to be separated from forced change. Participants selected for NASA’s first Moon and Mars Exploration Analog mission also will perform tasks in immersive, interactive environments while living inside habitats that. NASA NASA is recruiting research participants for the agency’s next simulated deep space mission.</p><p>Beginning no earlier than August 2027, research volunteers will spend one year living and working in interplanetary environments at the agency’s Johnson Space Center in Houston. Insights from this new, yearlong experience, called the Moon and Mars Exploration Analog, can be used to help keep astronauts safe and mission-ready during future planetary.</p><p>The results also could inform plans for a sustained lunar presence through the agency’s Moon Base and future Artemis missions. NASA is looking for applicants for the approximately year-long mission simulation, which will take place in two confined habitats.</p><p>Candidates also should have a strong desire for unique, rewarding experiences, and interest in contributing to NASA’s work to prepare for extended stays on the lunar surface and. They also will mimic surface operations, including mock Mars walks and using a rover to travel to exploration sites located beyond the main habitat.</p><p>The broader interest lies in linking the observation to climatic, geophysical or environmental dynamics that extend well beyond the immediate event or location. Earth science is unusual in that its most important questions operate on timescales that no single research career can observe directly, making the archival record, whether in ice, sediment, rock or satellite data, as important as any new measurement. Results that can be embedded in that record, and that either confirm or challenge the patterns it reveals, carry disproportionate scientific weight.</p><p>Throughout the Moon and Mars Exploration Analog mission, researchers will study crew health and performance under resource limitations and mission demands. The effort will provide valuable data for NASA’s Human Research Program, which innovates ways to keep astronauts healthy and mission-ready.</p><p>Because the account originates with NASA News Releases, it functions best as a primary institutional report that is close to the data and operations, not as independent scientific validation. Institutional communications are produced by organizations with legitimate interests in presenting their work in a favorable light, which does not make them unreliable but does make them partial. Details that complicate the narrative, including instrument limitations, unexpected failures and results below projections, tend to be minimized relative to progress messages. Technical documentation and peer-reviewed publications, where they exist, provide the complementary layer that institutional releases cannot substitute.</p><p>The next step is to place the result inside longer time series and to compare it with independent instruments and independent sites. Earth system observations gain most of their interpretive power from network density and temporal depth, not from any single measurement however precise. Model simulations that assimilate the new data will help clarify whether the observation fits comfortably within known natural variability or represents a shift that existing models do not reproduce.</p><p class=\"art-source\"><a href=\"https://www.nasa.gov/humans-in-space/nasa-seeks-volunteers-for-new-yearlong-simulated-moon-mars-mission/\" target=\"_blank\" rel=\"noopener noreferrer\">Source</a></p>",
    "highlights": [
      "Em foco: A NASA está recrutando participantes para sua próxima missão simulada de exploração espacial profunda",
    ...
    "realUrl": "https://www.cosmosweek.com/?article=nasa-seeks-volunteers-for-new-yearlong-simulated-moon-mars-mission",
    "realUrl_pt": "https://www.cosmosweek.com/?article=nasa-seeks-volunteers-for-new-yearlong-simulated-moon-mars-mission",
    "realUrl_en": "https://www.cosmosweek.com/?article=nasa-seeks-volunteers-for-new-yearlong-simulated-moon-mars-mission&lang=en",
    "shareUrl": "https://www.cosmosweek.com/noticia/nasa-seeks-volunteers-for-new-yearlong-simulated-moon-mars-mission/",
    "shareUrl_pt": "https://www.cosmosweek.com/noticia/nasa-seeks-volunteers-for-new-yearlong-simulated-moon-mars-mission/",
    "shareUrl_en": "https://www.cosmosweek.com/en/news/nasa-seeks-volunteers-for-new-yearlong-simulated-moon-mars-mission/",
    "canonicalUrl": "https://www.cosmosweek.com/noticia/nasa-seeks-volunteers-for-new-yearlong-simulated-moon-mars-mission/",
    "canonicalUrl_pt": "https://www.cosmosweek.com/noticia/nasa-seeks-volunteers-for-new-yearlong-simulated-moon-mars-mission/",
    "canonicalUrl_en": "https://www.cosmosweek.com/en/news/nasa-seeks-volunteers-for-new-yearlong-simulated-moon-mars-mission/",
    ...
    "imageAlt": "NASA Busca Voluntários para Simulação de Missão à Lua e Marte",
    "imageAlt_pt": "NASA Busca Voluntários para Simulação de Missão à Lua e Marte",
    "imageAlt_en": "NASA Seeks Volunteers for New Yearlong Simulated Moon, Mars Mission",
    "coverageKind": "agency",
  ...
  },
  {
    ...
    "cat": "Biologia",
    "catCls": "biologia",
    "img": "https://assets.science.nasa.gov/content/dam/science/missions/webb/science/2026/07/STScI-01KV8SMVYFK67J7RPRW1HB0SKS.jpg/jcr:content/renditions/cq5dam.web.1280.1280.jpeg",
    "inline_images": [],
    "video": null,
    "audio": null,
    "title": "O Telescópio Webb da NASA Investiga a Sobrevivência de um Planeta à Evolução de Sua Estrela",
    "title_pt": "O Telescópio Webb da NASA Investiga a Sobrevivência de um Planeta à Evolução de Sua Estrela",
    "title_en": "NASA’s Webb Studies How Planet Survived Death of its Star",
    "sub": "O Telescópio Espacial James Webb da NASA está revelando como exoplanetas podem sobreviver à fase final de suas estrelas hospedeiras, focando no gigante gasoso WD 1856 b.",
    "sub_pt": "O Telescópio Espacial James Webb da NASA está revelando como exoplanetas podem sobreviver à fase final de suas estrelas hospedeiras, focando no gigante gasoso WD 1856 b.",
    ...
    "excerpt": "O Telescópio Espacial James Webb da NASA está revelando como exoplanetas podem sobreviver à fase final de suas estrelas hospedeiras, focando no gigante gasoso WD 1856 b.",
    "excerpt_pt": "O Telescópio Espacial James Webb da NASA está revelando como exoplanetas podem sobreviver à fase final de suas estrelas hospedeiras, focando no gigante gasoso WD 1856 b.",
    "excerpt_en": "NASA’s James Webb Space Telescope is giving us new insight into the far-future of solar systems like our own, as the agency continues to reveal the secrets of the universe and our place in it.",
    "body": "<p>O Telescópio Espacial James Webb (JWST) da NASA está proporcionando uma nova e profunda compreensão sobre o futuro distante de sistemas solares como o nosso. À medida que a agência espacial continua a desvendar os segredos do universo e o nosso lugar nele, o estudo de exoplanetas em condições extremas torna-se crucial. Um desses objetos de interesse é o exoplaneta WD 1856 b, um gigante gasoso que orbita uma estrela anã branca, oferecendo um vislumbre de como planetas podem sobreviver à fase final de suas estrelas hospedeiras. Sua órbita peculiar, extremamente próxima de sua estrela, levanta questões fascinantes sobre a dinâmica e a resiliência planetária em cenários de evolução estelar.</p><p>Descoberto em 2020 por cientistas utilizando o Satélite de Pesquisa de Exoplanetas em Trânsito (TESS) da NASA e o já aposentado Telescópio Espacial Spitzer, o WD 1856 b está localizado a aproximadamente 80 anos-luz da Terra. Ele orbita a anã branca WD 1856+534, uma estrela que já passou por sua fase de gigante vermelha. A característica mais notável do WD 1856 b é sua proximidade com a estrela hospedeira: ele orbita a uma distância 50 vezes menor do que a Terra orbita o Sol. Essa órbita tão apertada é o cerne do mistério que os astrônomos buscam desvendar, pois sugere que o planeta de alguma forma escapou da destruição durante a expansão da estrela em sua fase de gigante vermelha.</p><p>Para resolver o enigma de como este exoplaneta sobreviveu a um evento tão cataclísmico, uma equipe internacional de astrônomos utilizou os dados precisos do Telescópio Espacial James Webb. Combinando as novas observações do Webb com modelos de como objetos subestelares, como o WD 1856 b, se resfriam ao longo do tempo, os pesquisadores conseguiram projetar a temperatura do planeta no passado. Essa análise permitiu deduzir há quanto tempo o aquecimento significativo do planeta deve ter ocorrido, fornecendo pistas cruciais sobre sua história orbital e os mecanismos que o permitiram persistir em um ambiente tão hostil. A capacidade do Webb de coletar dados infravermelhos detalhados foi fundamental para essa reconstrução temporal.</p><p>Recentemente, a equipe realizou observações adicionais, registrando mais quatro trânsitos do WD 1856 b com o Webb. O objetivo principal dessas novas medições é aprofundar o exame da química atmosférica do exoplaneta. Durante a passagem do WD 1856 b em frente à sua estrela, o Telescópio Espacial James Webb conseguiu medir os constituintes de sua atmosfera, encontrando sinais claros de metano. A detecção de metano é um passo importante para entender a composição e a evolução da atmosfera de um gigante gasoso que sobreviveu a um cenário estelar extremo, oferecendo informações valiosas sobre as condições que prevalecem em tais mundos.</p><p>O estudo do WD 1856 b não apenas revela a resiliência de exoplanetas, mas também oferece um vislumbre do possível futuro do nosso próprio Sistema Solar. Em aproximadamente cinco bilhões de anos, o Sol esgotará seu combustível de hidrogênio em seu núcleo e inchará, tornando-se uma estrela gigante vermelha mais de 100 vezes maior do que é atualmente. Durante essa fase, Mercúrio e Vênus serão engolidos, e a Terra poderá se tornar inabitável ou até mesmo ser absorvida. Compreender como planetas como o WD 1856 b conseguem sobreviver a tais transformações estelares é vital para prever o destino dos planetas remanescentes em nosso sistema e para expandir nosso conhecimento sobre a habitabilidade de mundos em diferentes estágios da vida estelar.</p>",
    "body_pt": "<p>O Telescópio Espacial James Webb (JWST) da NASA está proporcionando uma nova e profunda compreensão sobre o futuro distante de sistemas solares como o nosso. À medida que a agência espacial continua a desvendar os segredos do universo e o nosso lugar nele, o estudo de exoplanetas em condições extremas torna-se crucial. Um desses objetos de interesse é o exoplaneta WD 1856 b, um gigante gasoso que orbita uma estrela anã branca, oferecendo um vislumbre de como planetas podem sobreviver à fase final de suas estrelas hospedeiras. Sua órbita peculiar, extremamente próxima de sua estrela, levanta questões fascinantes sobre a dinâmica e a resiliência planetária em cenários de evolução estelar.</p><p>Descoberto em 2020 por cientistas utilizando o Satélite de Pesquisa de Exoplanetas em Trânsito (TESS) da NASA e o já aposentado Telescópio Espacial Spitzer, o WD 1856 b está localizado a aproximadamente 80 anos-luz da Terra. Ele orbita a anã branca WD 1856+534, uma estrela que já passou por sua fase de gigante vermelha. A característica mais notável do WD 1856 b é sua proximidade com a estrela hospedeira: ele orbita a uma distância 50 vezes menor do que a Terra orbita o Sol. Essa órbita tão apertada é o cerne do mistério que os astrônomos buscam desvendar, pois sugere que o planeta de alguma forma escapou da destruição durante a expansão da estrela em sua fase de gigante vermelha.</p><p>Para resolver o enigma de como este exoplaneta sobreviveu a um evento tão cataclísmico, uma equipe internacional de astrônomos utilizou os dados precisos do Telescópio Espacial James Webb. Combinando as novas observações do Webb com modelos de como objetos subestelares, como o WD 1856 b, se resfriam ao longo do tempo, os pesquisadores conseguiram projetar a temperatura do planeta no passado. Essa análise permitiu deduzir há quanto tempo o aquecimento significativo do planeta deve ter ocorrido, fornecendo pistas cruciais sobre sua história orbital e os mecanismos que o permitiram persistir em um ambiente tão hostil. A capacidade do Webb de coletar dados infravermelhos detalhados foi fundamental para essa reconstrução temporal.</p><p>Recentemente, a equipe realizou observações adicionais, registrando mais quatro trânsitos do WD 1856 b com o Webb. O objetivo principal dessas novas medições é aprofundar o exame da química atmosférica do exoplaneta. Durante a passagem do WD 1856 b em frente à sua estrela, o Telescópio Espacial James Webb conseguiu medir os constituintes de sua atmosfera, encontrando sinais claros de metano. A detecção de metano é um passo importante para entender a composição e a evolução da atmosfera de um gigante gasoso que sobreviveu a um cenário estelar extremo, oferecendo informações valiosas sobre as condições que prevalecem em tais mundos.</p><p>O estudo do WD 1856 b não apenas revela a resiliência de exoplanetas, mas também oferece um vislumbre do possível futuro do nosso próprio Sistema Solar. Em aproximadamente cinco bilhões de anos, o Sol esgotará seu combustível de hidrogênio em seu núcleo e inchará, tornando-se uma estrela gigante vermelha mais de 100 vezes maior do que é atualmente. Durante essa fase, Mercúrio e Vênus serão engolidos, e a Terra poderá se tornar inabitável ou até mesmo ser absorvida. Compreender como planetas como o WD 1856 b conseguem sobreviver a tais transformações estelares é vital para prever o destino dos planetas remanescentes em nosso sistema e para expandir nosso conhecimento sobre a habitabilidade de mundos em diferentes estágios da vida estelar.</p>",
    ...
    "highlights": [
      "Em foco: O Telescópio Espacial James Webb da NASA está revelando como exoplanetas podem sobreviver à fase final de suas estrelas hospedeiras, focando no",
      "Detalhe: Origem institucional: distinguir anúncio de evidência",
      "Leitura editorial: release institucional, útil como fonte primária, mas não como validação independente."
    ],
    "highlights_pt": [
    ...
    "highlights_en": [
      "Focus: NASA’s James Webb Space Telescope is giving us new insight into the far-future of solar systems like our own, as the agency continues to reveal the",
      "Detail: Institutional origin: separate announcement from evidence",
      "Editorial reading: institutional release, useful as a primary source but not independent validation."
    ],
    "date": "01 jul 2026",
    ...
    "realUrl": "https://www.cosmosweek.com/?article=nasa-s-webb-studies-how-planet-survived-death-of-its-star",
    "realUrl_pt": "https://www.cosmosweek.com/?article=nasa-s-webb-studies-how-planet-survived-death-of-its-star",
    "realUrl_en": "https://www.cosmosweek.com/?article=nasa-s-webb-studies-how-planet-survived-death-of-its-star&lang=en",
    "shareUrl": "https://www.cosmosweek.com/noticia/nasa-s-webb-studies-how-planet-survived-death-of-its-star/",
    "shareUrl_pt": "https://www.cosmosweek.com/noticia/nasa-s-webb-studies-how-planet-survived-death-of-its-star/",
    "shareUrl_en": "https://www.cosmosweek.com/en/news/nasa-s-webb-studies-how-planet-survived-death-of-its-star/",
    "canonicalUrl": "https://www.cosmosweek.com/noticia/nasa-s-webb-studies-how-planet-survived-death-of-its-star/",
    "canonicalUrl_pt": "https://www.cosmosweek.com/noticia/nasa-s-webb-studies-how-planet-survived-death-of-its-star/",
    "canonicalUrl_en": "https://www.cosmosweek.com/en/news/nasa-s-webb-studies-how-planet-survived-death-of-its-star/",
    "defaultLanguage": "pt-BR",
    "availableLanguages": [
      "pt-BR",
      "en-US"
    ...
    "imageAlt": "O Telescópio Webb da NASA Investiga a Sobrevivência de um Planeta à Evolução de Sua Estrela",
    "imageAlt_pt": "O Telescópio Webb da NASA Investiga a Sobrevivência de um Planeta à Evolução de Sua Estrela",
    "imageAlt_en": "NASA’s Webb Studies How Planet Survived Death of its Star",
    "coverageKind": "agency",
    "coverageKindLabel": "Fonte institucional",
    "coverageKindLabel_pt": "Fonte institucional",
    "coverageKindLabel_en": "Institutional source",
  ...
  },
  {
    ...
    "cat": "Exoplanetas",
    "catCls": "exoplanetas",
    "img": "https://assets.science.nasa.gov/content/dam/science/missions/rst/science/Brown%20superjupiter%20D2%201.jpg/jcr:content/renditions/cq5dam.web.1280.1280.jpeg",
    "inline_images": [
      {
    ...
    "video": {
      "kind": "embed",
      "platform": "youtube",
      "embedUrl": "https://www.youtube-nocookie.com/embed/vAna9jBZRd8?rel=0&modestbranding=1",
      "fileUrl": "",
      "poster": "",
      "title": "",
      "title_pt": "",
      ...
      "caption_pt": "",
      "caption_en": "",
      "sourcePage": "https://science.nasa.gov/missions/tess/nasas-tess-mission-finds-planetary-system-in-new-way/"
    },
    "audio": null,
    "title": "A missão TESS da NASA encontra um sistema planetário por um novo método",
    "title_pt": "A missão TESS da NASA encontra um sistema planetário por um novo método",
    "title_en": "NASA’s TESS Mission Finds Planetary System in New Way",
    "sub": "Pela primeira vez, a missão TESS da NASA identificou um planeta orbitando uma estrela distante utilizando o método de microlente gravitacional.",
    "sub_pt": "Pela primeira vez, a missão TESS da NASA identificou um planeta orbitando uma estrela distante utilizando o método de microlente gravitacional.",
    "sub_en": "For the first time, NASA’s TESS mission has identified a planet orbiting a distant star thanks to ripples in space-time.",
    "excerpt": "Pela primeira vez, a missão TESS da NASA identificou um planeta orbitando uma estrela distante utilizando o método de microlente gravitacional.",
    "excerpt_pt": "Pela primeira vez, a missão TESS da NASA identificou um planeta orbitando uma estrela distante utilizando o método de microlente gravitacional.",
    ...
    "realUrl": "https://www.cosmosweek.com/?article=nasa-s-tess-mission-finds-planetary-system-in-new-way",
    "realUrl_pt": "https://www.cosmosweek.com/?article=nasa-s-tess-mission-finds-planetary-system-in-new-way",
    "realUrl_en": "https://www.cosmosweek.com/?article=nasa-s-tess-mission-finds-planetary-system-in-new-way&lang=en",
    "shareUrl": "https://www.cosmosweek.com/noticia/nasa-s-tess-mission-finds-planetary-system-in-new-way/",
    "shareUrl_pt": "https://www.cosmosweek.com/noticia/nasa-s-tess-mission-finds-planetary-system-in-new-way/",
    "shareUrl_en": "https://www.cosmosweek.com/en/news/nasa-s-tess-mission-finds-planetary-system-in-new-way/",
    "canonicalUrl": "https://www.cosmosweek.com/noticia/nasa-s-tess-mission-finds-planetary-system-in-new-way/",
    "canonicalUrl_pt": "https://www.cosmosweek.com/noticia/nasa-s-tess-mission-finds-planetary-system-in-new-way/",
    "canonicalUrl_en": "https://www.cosmosweek.com/en/news/nasa-s-tess-mission-finds-planetary-system-in-new-way/",
    "defaultLanguage": "pt-BR",
    "availableLanguages": [
      "pt-BR",
      "en-US"
    ...
    "imageAlt": "A missão TESS da NASA encontra um sistema planetário por um novo método",
    "imageAlt_pt": "A missão TESS da NASA encontra um sistema planetário por um novo método",
    "imageAlt_en": "NASA’s TESS Mission Finds Planetary System in New Way",
    "coverageKind": "agency",
    "coverageKindLabel": "Fonte institucional",
    "coverageKindLabel_pt": "Fonte institucional",
    "coverageKindLabel_en": "Institutional source",
  ...
  },
  {
    ...
    "inline_images": [
      ...
      {
        "src": "https://assets.science.nasa.gov/dynamicimage/assets/science/astro/missions/Chandra20years.webp",
        "alt": "",
        "alt_pt": "",
        "alt_en": "",
        "caption": "",
    ...
    "video": null,
    "audio": null,
    "title": "XMM-Newton ajuda a revisar a distância dos braços espirais externos da Via Láctea",
    "title_pt": "XMM-Newton ajuda a revisar a distância dos braços espirais externos da Via Láctea",
    "title_en": "XMM-Newton helps revise distance to outer spiral arms",
    "sub": "Os telescópios espaciais de raios X XMM-Newton da Agência Espacial Europeia e Chandra da NASA detectaram ecos de três explosões brilhantes nos braços espirais externos da Via.",
    "sub_pt": "Os telescópios espaciais de raios X XMM-Newton da Agência Espacial Europeia e Chandra da NASA detectaram ecos de três explosões brilhantes nos braços espirais externos da Via.",
    ...
    "excerpt": "Os telescópios espaciais de raios X XMM-Newton da Agência Espacial Europeia e Chandra da NASA detectaram ecos de três explosões brilhantes nos braços espirais externos da Via Láctea, revelando que essas estruturas estão até 10% mais distantes do que se.",
    "excerpt_pt": "Os telescópios espaciais de raios X XMM-Newton da Agência Espacial Europeia e Chandra da NASA detectaram ecos de três explosões brilhantes nos braços espirais externos da Via Láctea, revelando que essas estruturas estão até 10% mais distantes do que se.",
    "excerpt_en": "The European Space Agency’s XMM-Newton and NASA’s Chandra X-ray space telescopes have spotted the aftermath of three bright explosions echoing through the outer spiral arms of our galaxy, the Milky Way.",
    "body": "<p>A luz de raios X emitida por essas três GRBs permitiu não apenas confirmar a distância já conhecida do braço de Perseu, mas também revelar que dois outros braços da Via Láctea – o Braço Externo Scutum-Centaurus e o Braço Externo – se encontram até 10% mais afastados do que as medições prévias indicavam. Essa precisão é crucial para aprimorar nossos modelos da estrutura galáctica e entender melhor a distribuição de matéria e estrelas nas regiões periféricas da Via Láctea, onde as observações são tradicionalmente mais desafiadoras.</p><p>Embora o telescópio espacial Gaia da ESA tenha revolucionado nossa compreensão da Via Láctea, fornecendo medições de distância sem precedentes para bilhões de estrelas, suas capacidades são menos precisas para as regiões mais distantes da galáxia, como os braços espirais externos. As estrelas nessas áreas são mais tênues e sujeitas a maior extinção interestelar, dificultando medições diretas e confiáveis. A nova metodologia baseada em ecos de raios X preenche essa lacuna, oferecendo uma ferramenta complementar para mapear essas fronteiras distantes com maior exatidão.</p><p>Essa descoberta ressalta a importância contínua de missões espaciais mais antigas da ESA, como o XMM-Newton, lançado em 1999. Erik Kuulkers, cientista do projeto XMM-Newton da ESA, afirma que o observatório ainda desempenha um papel fundamental na exploração do Universo. Em sua terceira década de operação, o XMM-Newton continua a gerar um fluxo constante de dados científicos inovadores, abrangendo desde os GRBs mais luminosos já registrados até a observação de estrelas sendo desintegradas por buracos negros e a captura de imagens de raios X de Marte, demonstrando sua versatilidade e longevidade.</p><p>A sinergia entre os dados do XMM-Newton e as futuras liberações de dados do Gaia, previstas para dezembro de 2026 e após o final de 2030, promete aprofundar ainda mais nosso conhecimento da Via Láctea. Além disso, o observatório de raios X de próxima geração da ESA, o NewAthena, está sendo preparado para transformar a astronomia de raios X. Com sua capacidade aprimorada, o NewAthena permitirá aos cientistas explorar ecos de raios X significativamente mais fracos, expandindo a capacidade de mapeamento para as regiões mais remotas e tênues da nossa galáxia e abrindo novas fronteiras na pesquisa astrofísica.</p>",
    "body_pt": "<p>A luz de raios X emitida por essas três GRBs permitiu não apenas confirmar a distância já conhecida do braço de Perseu, mas também revelar que dois outros braços da Via Láctea – o Braço Externo Scutum-Centaurus e o Braço Externo – se encontram até 10% mais afastados do que as medições prévias indicavam. Essa precisão é crucial para aprimorar nossos modelos da estrutura galáctica e entender melhor a distribuição de matéria e estrelas nas regiões periféricas da Via Láctea, onde as observações são tradicionalmente mais desafiadoras.</p><p>Embora o telescópio espacial Gaia da ESA tenha revolucionado nossa compreensão da Via Láctea, fornecendo medições de distância sem precedentes para bilhões de estrelas, suas capacidades são menos precisas para as regiões mais distantes da galáxia, como os braços espirais externos. As estrelas nessas áreas são mais tênues e sujeitas a maior extinção interestelar, dificultando medições diretas e confiáveis. A nova metodologia baseada em ecos de raios X preenche essa lacuna, oferecendo uma ferramenta complementar para mapear essas fronteiras distantes com maior exatidão.</p><p>Essa descoberta ressalta a importância contínua de missões espaciais mais antigas da ESA, como o XMM-Newton, lançado em 1999. Erik Kuulkers, cientista do projeto XMM-Newton da ESA, afirma que o observatório ainda desempenha um papel fundamental na exploração do Universo. Em sua terceira década de operação, o XMM-Newton continua a gerar um fluxo constante de dados científicos inovadores, abrangendo desde os GRBs mais luminosos já registrados até a observação de estrelas sendo desintegradas por buracos negros e a captura de imagens de raios X de Marte, demonstrando sua versatilidade e longevidade.</p><p>A sinergia entre os dados do XMM-Newton e as futuras liberações de dados do Gaia, previstas para dezembro de 2026 e após o final de 2030, promete aprofundar ainda mais nosso conhecimento da Via Láctea. Além disso, o observatório de raios X de próxima geração da ESA, o NewAthena, está sendo preparado para transformar a astronomia de raios X. Com sua capacidade aprimorada, o NewAthena permitirá aos cientistas explorar ecos de raios X significativamente mais fracos, expandindo a capacidade de mapeamento para as regiões mais remotas e tênues da nossa galáxia e abrindo novas fronteiras na pesquisa astrofísica.</p>",
    "body_en": "<p>The European Space Agency’s XMM-Newton and NASA’s Chandra X-ray space telescopes have spotted the aftermath of three bright explosions echoing through the outer spiral arms of our galaxy, the Milky Way. The institutional report frames the development in practical terms and ties it to the broader mission or observing effort.</p><p>That matters because astronomy does not advance on single detections. The field builds confidence by accumulating independent observations across different wavelengths, instruments and epochs until isolated signals become defensible conclusions. What looks convincing in one dataset can dissolve when a second instrument looks at the same target, and what looks marginal can solidify when follow-up campaigns confirm the original reading. The current standard requires that a result survive this triangulation before the community treats it as settled. By measuring the distance to these echoes, they find the outer arms to be up to 10% further away than we thought. We’ve learnt a huge amount since the launch of ESA’s star-surveying Gaia space telescope.</p><p>Now, another of ESA&#x27;s missions has found a new way to map the extremities of our galaxy. These explosions flung out X-rays that echoed through several of the Milky Way’s outer arms, and we measured the distances to these echoes directly.</p><p>Besides confirming the known distance to the Perseus arm, the scientists found that two of the Milky Way galaxy’s arms, Outer Scutum-Centaurus Arm and Outer Arm, lie up to 10%. While ESA’s Gaia has revolutionised our understanding of the Milky Way galaxy, the distance measurements available so far from the telescope are less precise for the outer arms.</p><p>This finding is a great example of how ESA’s longer-standing missions, such as XMM-Newton, which launched in 1999, still have a hugely important role to play in exploring the. Now in its third decade, XMM-Newton continues to return a steady stream of groundbreaking science on everything from the brightest-ever GRB, to stars being shredded by black.</p><p>What gives the story weight is not just the object itself, but the way the measurement trims the range of plausible physical explanations. Astronomy has accumulated enough cases to know that the most interesting results are rarely the ones that confirm expectations cleanly; they are the ones that confirm some expectations while complicating others, or that open a parameter space that previous instruments could not reach. The scientific community evaluates these contributions by asking whether the new data constrain a model in a way that older data could not, and whether those constraints survive systematic review.</p><p>Alongside ever more detailed data from Gaia’s fourth and fifth data releases (planned for December 2026 and after the end of 2030, respectively), ESA’s next generation X-ray. The researchers combined observations of GRBs 221009A (spotted in 2022), 160623A (2016), and 031203 (2003).</p><p>Because the account originates with ESA Space News, it functions best as a primary institutional report that is close to the data and operations, not as independent scientific validation. Institutional communications are produced by organizations with legitimate interests in presenting their work in a favorable light, which does not make them unreliable but does make them partial. Details that complicate the narrative, including instrument limitations, unexpected failures and results below projections, tend to be minimized relative to progress messages. Technical documentation and peer-reviewed publications, where they exist, provide the complementary layer that institutional releases cannot substitute.</p><p>The next step is to see whether other instruments and other wavelengths tell the same story. Campaigns with JWST, the VLT, the forthcoming Extremely Large Telescopes and radio arrays will provide the spectral coverage and spatial resolution needed to move from detection to physical characterization. The timeline for that kind of confirmation is typically measured in years, not months, which is worth keeping in mind when reading the current result.</p><p class=\"art-source\"><a href=\"https://www.esa.int/Science_Exploration/Space_Science/XMM-Newton/XMM-Newton_helps_revise_distance_to_outer_spiral_arms\" target=\"_blank\" rel=\"noopener noreferrer\">Source</a></p>",
    "highlights": [
      "Em foco: Os telescópios espaciais de raios X XMM-Newton da Agência Espacial Europeia e Chandra da NASA detectaram ecos de três explosões brilhantes nos braços",
      "Detalhe: Origem institucional: distinguir anúncio de evidência",
      "Leitura editorial: release institucional, útil como fonte primária, mas não como validação independente."
    ],
    "highlights_pt": [
    ...
    "realUrl": "https://www.cosmosweek.com/?article=xmm-newton-helps-revise-distance-to-outer-spiral-arms",
    "realUrl_pt": "https://www.cosmosweek.com/?article=xmm-newton-helps-revise-distance-to-outer-spiral-arms",
    "realUrl_en": "https://www.cosmosweek.com/?article=xmm-newton-helps-revise-distance-to-outer-spiral-arms&lang=en",
    "shareUrl": "https://www.cosmosweek.com/noticia/xmm-newton-helps-revise-distance-to-outer-spiral-arms/",
    "shareUrl_pt": "https://www.cosmosweek.com/noticia/xmm-newton-helps-revise-distance-to-outer-spiral-arms/",
    "shareUrl_en": "https://www.cosmosweek.com/en/news/xmm-newton-helps-revise-distance-to-outer-spiral-arms/",
    "canonicalUrl": "https://www.cosmosweek.com/noticia/xmm-newton-helps-revise-distance-to-outer-spiral-arms/",
    "canonicalUrl_pt": "https://www.cosmosweek.com/noticia/xmm-newton-helps-revise-distance-to-outer-spiral-arms/",
    "canonicalUrl_en": "https://www.cosmosweek.com/en/news/xmm-newton-helps-revise-distance-to-outer-spiral-arms/",
    "defaultLanguage": "pt-BR",
    "availableLanguages": [
      "pt-BR",
      "en-US"
    ...
    "imageAlt": "XMM-Newton ajuda a revisar a distância dos braços espirais externos da Via Láctea",
    "imageAlt_pt": "XMM-Newton ajuda a revisar a distância dos braços espirais externos da Via Láctea",
    "imageAlt_en": "XMM-Newton helps revise distance to outer spiral arms",
    "coverageKind": "agency",
    "coverageKindLabel": "Fonte institucional",
    "coverageKindLabel_pt": "Fonte institucional",
    "coverageKindLabel_en": "Institutional source",
  ...
  },
  {
    ...
    "highlights_en": [
      "Focus: NSF, DOE Rubin Observatory, funded by the U. S. National Science Foundation and the U. S",
      "Detail: Institutional origin: separate announcement from evidence",
      "Editorial reading: institutional release, useful as a primary source but not independent validation."
    ],
    "date": "30 jun 2026",
  ...
  {
    "id": 7,
    "slug": "the-location-of-the-upper-edge-of-the-pair-instability-supernovae-black-hole-mass-gap",
    "cat": "Cosmologia",
    "catCls": "cosmologia",
    ...
    "read_pt": "4 min de leitura",
    "read_en": "4 min read",
    "publishedIso": "2026-06-30T14:45:45+00:00",
    "lastModifiedIso": "2026-07-01T17:44:50+00:00",
    ...
    "keywords_en": [
      ...
      "arXiv Cosmology",
      "Cosmos Week",
      "The location of the upper edge of the black hole mass gap of pair instability supernovae"
    ],
    "srcUrl": "https://arxiv.org/abs/2606.31757v1",
    "realUrl": "https://www.cosmosweek.com/?article=the-location-of-the-upper-edge-of-the-pair-instability-supernovae-black-hole-mass-gap",
    "realUrl_pt": "https://www.cosmosweek.com/?article=the-location-of-the-upper-edge-of-the-pair-instability-supernovae-black-hole-mass-gap",
    "realUrl_en": "https://www.cosmosweek.com/?article=the-location-of-the-upper-edge-of-the-pair-instability-supernovae-black-hole-mass-gap&lang=en",
    "shareUrl": "https://www.cosmosweek.com/noticia/the-location-of-the-upper-edge-of-the-pair-instability-supernovae-black-hole-mass-gap/",
    "shareUrl_pt": "https://www.cosmosweek.com/noticia/the-location-of-the-upper-edge-of-the-pair-instability-supernovae-black-hole-mass-gap/",
    "shareUrl_en": "https://www.cosmosweek.com/en/news/the-location-of-the-upper-edge-of-the-pair-instability-supernovae-black-hole-mass-gap/",
    "canonicalUrl": "https://www.cosmosweek.com/noticia/the-location-of-the-upper-edge-of-the-pair-instability-supernovae-black-hole-mass-gap/",
    "canonicalUrl_pt": "https://www.cosmosweek.com/noticia/the-location-of-the-upper-edge-of-the-pair-instability-supernovae-black-hole-mass-gap/",
    "canonicalUrl_en": "https://www.cosmosweek.com/en/news/the-location-of-the-upper-edge-of-the-pair-instability-supernovae-black-hole-mass-gap/",
    "defaultLanguage": "pt-BR",
    "availableLanguages": [
      "pt-BR",
      "en-US"
    ...
    "imageAlt": "A localização da borda superior da lacuna de massa do buraco negro de supernovas de instabilidade de pares",
    "imageAlt_pt": "A localização da borda superior da lacuna de massa do buraco negro de supernovas de instabilidade de pares",
    "imageAlt_en": "The location of the upper edge of the pair-instability supernovae black hole mass gap",
  ...
  },
  {
    ...
    "cat": "Cosmologia",
    "catCls": "cosmologia",
    "img": "https://www.esa.int/var/esa/storage/images/esa_multimedia/images/2014/01/sentinel-1_radar_vision/13494392-1-eng-GB/Sentinel-1_radar_vision_pillars.jpg",
    "inline_images": [
      {
      ...
      {
        "src": "https://www.esa.int/var/esa/storage/images/esa_multimedia/images/2014/04/sentinel-1a_lifts_off/14366916-2-eng-GB/Sentinel-1A_lifts_off_pillars.jpg",
        "alt": "",
        "alt_pt": "",
        "alt_en": "",
        "caption": "",
      ...
      {
        "src": "https://www.esa.int/var/esa/storage/images/esa_multimedia/images/2014/04/sentinel-1a_lifts_off/14366916-2-eng-GB/Sentinel-1A_lifts_off.jpg",
        "alt": "",
        "alt_pt": "",
        "alt_en": "",
        "caption": "",
    ...
    "video": null,
    "audio": null,
    "title": "O Fim da Missão do Sentinel-1A: Um Legado de 12 Anos na Observação da Terra",
    "title_pt": "O Fim da Missão do Sentinel-1A: Um Legado de 12 Anos na Observação da Terra",
    "title_en": "Time to say goodbye to Sentinel-1A",
    "sub": "Após doze anos de serviço excepcional, o satélite radar pioneiro Copernicus Sentinel-1A encerrou sua missão, mas seu legado e a continuidade da observação da Terra são garantidos.",
    "sub_pt": "Após doze anos de serviço excepcional, o satélite radar pioneiro Copernicus Sentinel-1A encerrou sua missão, mas seu legado e a continuidade da observação da Terra são garantidos.",
    "sub_en": "After 12 years of exceptional service, the pioneering Copernicus Sentinel-1A radar satellite has reached the end of its mission.",
    "excerpt": "Após doze anos de serviço excepcional, o satélite radar pioneiro Copernicus Sentinel-1A encerrou sua missão, mas seu legado e a continuidade da observação da Terra são garantidos pelos satélites Sentinel-1C e Sentinel-1D.",
    "excerpt_pt": "Após doze anos de serviço excepcional, o satélite radar pioneiro Copernicus Sentinel-1A encerrou sua missão, mas seu legado e a continuidade da observação da Terra são garantidos pelos satélites Sentinel-1C e Sentinel-1D.",
    "excerpt_en": "After 12 years of exceptional service, the pioneering Copernicus Sentinel-1A radar satellite has reached the end of its mission.",
    "body": "<p>Após doze anos de serviço excepcional, o satélite radar pioneiro Copernicus Sentinel-1A encerrou oficialmente sua missão. Lançado com o objetivo de fornecer dados cruciais para a observação da Terra, este satélite desempenhou um papel fundamental no programa Copernicus da Europa, estabelecendo novos padrões para a coleta de informações geoespaciais. Embora a notável jornada do Sentinel-1A tenha chegado ao fim, a missão de observação radar da Terra continua com vigor, impulsionada pelos satélites Sentinel-1C e Sentinel-1D. Essa transição assegura que a Europa manterá uma vigilância constante sobre o planeta nos próximos anos, garantindo a continuidade de dados essenciais para diversas aplicações científicas e ambientais.</p><p>O Sentinel-1A foi lançado em 3 de abril de 2014, marcando não apenas o início de uma missão individual, mas também o alvorecer de uma nova era na observação da Terra. Equipado com um avançado radar de abertura sintética (SAR) de banda C, o satélite tinha a capacidade ímpar de fornecer imagens de alta resolução da superfície terrestre, independentemente das condições climáticas ou da iluminação solar. Essa característica permitiu a coleta contínua de dados dia e noite, atravessando nuvens e neblina, o que era crucial para monitorar mudanças ambientais, desastres naturais e atividades humanas em tempo real. Sua tecnologia de ponta o posicionou como um instrumento indispensável para a ciência e a gestão de recursos.</p><p>O satélite operou muito além de sua duração de missão planejada, demonstrando uma resiliência e confiabilidade notáveis. Sua importância tornou-se ainda mais crítica após a falha no sistema de energia de seu satélite irmão, o Sentinel-1B, ocorrida em 2021. Durante esse período desafiador, o Sentinel-1A assumiu grande parte da responsabilidade pela manutenção da capacidade de observação da Terra por radar da Europa. Ele garantiu que os fluxos de dados essenciais para monitoramento de gelo marinho, movimentos do solo, cobertura florestal e outras aplicações críticas não fossem interrompidos, sublinhando seu valor inestimável para a comunidade científica e para as agências de gestão de emergências.</p><p>O Centro de Operações da Agência Espacial Europeia (ESA) na Alemanha confirmou que as funções operacionais do Sentinel-1A foram oficialmente encerradas em 29 de junho de 2026. Nas semanas que antecederam sua aposentadoria, os controladores da missão executaram uma série de manobras orbitais complexas. Essas operações foram cuidadosamente planejadas para posicionar o Sentinel-1A e seus sucessores, Sentinel-1C e Sentinel-1D, em uma configuração otimizada de três satélites. Esse arranjo estratégico visa maximizar a cobertura e a frequência de revisita, garantindo uma transição suave e aprimorando a capacidade geral da constelação Sentinel-1 para as futuras demandas de observação.</p><p>Como o primeiro satélite do programa Copernicus, o Sentinel-1A abriu caminho para novas abordagens tanto nas operações espaciais quanto na ciência da observação da Terra. Ele estabeleceu os fundamentos para a coleta sistemática e contínua de dados de radar, que se tornaram um pilar para inúmeras pesquisas e aplicações. Seu legado inclui a demonstração da viabilidade de missões de longa duração e a capacidade de adaptação a desafios inesperados. Além disso, o Sentinel-1A permaneceu na vanguarda da observação da Terra, continuando a desempenhar um papel fundamental ao permitir a aplicação de inteligência artificial na análise de dados e no desenvolvimento de novos serviços, impulsionando a inovação tecnológica.</p><p>Atualmente, os satélites Sentinel-1C e Sentinel-1D estão operando com excelente desempenho, oferecendo capacidades aprimoradas em relação ao seu predecessor. Eles continuam a expandir o legado do Sentinel-1A, fornecendo dados de radar de alta qualidade que são cruciais para o monitoramento ambiental, a segurança marítima, a gestão de desastres e o estudo das mudanças climáticas. A continuidade da missão Sentinel-1, com sua constelação robusta e tecnologicamente avançada, garante que a Europa e o mundo terão acesso ininterrupto a informações vitais sobre o nosso planeta, consolidando o papel do programa Copernicus como líder global em observação da Terra.</p>",
    "body_pt": "<p>Após doze anos de serviço excepcional, o satélite radar pioneiro Copernicus Sentinel-1A encerrou oficialmente sua missão. Lançado com o objetivo de fornecer dados cruciais para a observação da Terra, este satélite desempenhou um papel fundamental no programa Copernicus da Europa, estabelecendo novos padrões para a coleta de informações geoespaciais. Embora a notável jornada do Sentinel-1A tenha chegado ao fim, a missão de observação radar da Terra continua com vigor, impulsionada pelos satélites Sentinel-1C e Sentinel-1D. Essa transição assegura que a Europa manterá uma vigilância constante sobre o planeta nos próximos anos, garantindo a continuidade de dados essenciais para diversas aplicações científicas e ambientais.</p><p>O Sentinel-1A foi lançado em 3 de abril de 2014, marcando não apenas o início de uma missão individual, mas também o alvorecer de uma nova era na observação da Terra. Equipado com um avançado radar de abertura sintética (SAR) de banda C, o satélite tinha a capacidade ímpar de fornecer imagens de alta resolução da superfície terrestre, independentemente das condições climáticas ou da iluminação solar. Essa característica permitiu a coleta contínua de dados dia e noite, atravessando nuvens e neblina, o que era crucial para monitorar mudanças ambientais, desastres naturais e atividades humanas em tempo real. Sua tecnologia de ponta o posicionou como um instrumento indispensável para a ciência e a gestão de recursos.</p><p>O satélite operou muito além de sua duração de missão planejada, demonstrando uma resiliência e confiabilidade notáveis. Sua importância tornou-se ainda mais crítica após a falha no sistema de energia de seu satélite irmão, o Sentinel-1B, ocorrida em 2021. Durante esse período desafiador, o Sentinel-1A assumiu grande parte da responsabilidade pela manutenção da capacidade de observação da Terra por radar da Europa. Ele garantiu que os fluxos de dados essenciais para monitoramento de gelo marinho, movimentos do solo, cobertura florestal e outras aplicações críticas não fossem interrompidos, sublinhando seu valor inestimável para a comunidade científica e para as agências de gestão de emergências.</p><p>O Centro de Operações da Agência Espacial Europeia (ESA) na Alemanha confirmou que as funções operacionais do Sentinel-1A foram oficialmente encerradas em 29 de junho de 2026. Nas semanas que antecederam sua aposentadoria, os controladores da missão executaram uma série de manobras orbitais complexas. Essas operações foram cuidadosamente planejadas para posicionar o Sentinel-1A e seus sucessores, Sentinel-1C e Sentinel-1D, em uma configuração otimizada de três satélites. Esse arranjo estratégico visa maximizar a cobertura e a frequência de revisita, garantindo uma transição suave e aprimorando a capacidade geral da constelação Sentinel-1 para as futuras demandas de observação.</p><p>Como o primeiro satélite do programa Copernicus, o Sentinel-1A abriu caminho para novas abordagens tanto nas operações espaciais quanto na ciência da observação da Terra. Ele estabeleceu os fundamentos para a coleta sistemática e contínua de dados de radar, que se tornaram um pilar para inúmeras pesquisas e aplicações. Seu legado inclui a demonstração da viabilidade de missões de longa duração e a capacidade de adaptação a desafios inesperados. Além disso, o Sentinel-1A permaneceu na vanguarda da observação da Terra, continuando a desempenhar um papel fundamental ao permitir a aplicação de inteligência artificial na análise de dados e no desenvolvimento de novos serviços, impulsionando a inovação tecnológica.</p><p>Atualmente, os satélites Sentinel-1C e Sentinel-1D estão operando com excelente desempenho, oferecendo capacidades aprimoradas em relação ao seu predecessor. Eles continuam a expandir o legado do Sentinel-1A, fornecendo dados de radar de alta qualidade que são cruciais para o monitoramento ambiental, a segurança marítima, a gestão de desastres e o estudo das mudanças climáticas. A continuidade da missão Sentinel-1, com sua constelação robusta e tecnologicamente avançada, garante que a Europa e o mundo terão acesso ininterrupto a informações vitais sobre o nosso planeta, consolidando o papel do programa Copernicus como líder global em observação da Terra.</p>",
    "body_en": "<p>After 12 years of exceptional service, the pioneering Copernicus Sentinel-1A radar satellite has reached the end of its mission. The institutional report frames the development in practical terms and ties it to the broader mission or observing effort.</p><p>This matters because cosmology operates at the edge of what current instruments can measure, where systematic errors and model assumptions are never trivial. Small discrepancies between independent measurements have historically pointed toward missing physics rather than simple calibration errors, and the ongoing tension in the Hubble constant is a live example of how a persistent disagreement between methods can reshape the theoretical landscape. Each new dataset that approaches this territory with independent systematics adds real information to a problem that has resisted easy resolution for more than a decade. While Sentinel-1A&#x27;s remarkable journey has come to an end, the mission lives on with gusto with Sentinel-1C and Sentinel-1D, ensuring that Europe maintains an unblinking radar eye. Launched on 3 April 2014, Sentinel-1A marked more than the start of a single mission.</p><p>Equipped with an advanced C-band synthetic aperture radar, it delivered high-resolution images of Earth day and night and no matter the weather. Sentinel-1A remained operational well beyond its planned mission duration, and became especially critical after its sister satellite, Sentinel-1B, suffered a power-system failure.</p><p>During those challenging years, Sentinel-1A shouldered much of the responsibility for maintaining Europe&#x27;s radar Earth observation capability. ESA’s Operations Centre in Germany confirmed that Sentinel-1A&#x27;s operational duties ended on 29 June 2026.</p><p>In the weeks leading up to retirement, mission controllers carried out some complex orbital manoeuvres, carefully coaxing Sentinel-1A and its younger siblings, Sentinel-1C and. ESA’s Sentinel-1 Mission Manager, Nuno Miranda, said, “Sentinel-1A holds a special place for all of us.</p><p>The relevance goes beyond one dataset because even small shifts in measured parameters can matter when the field is testing the limits of the standard cosmological model. The Lambda-CDM framework describes the observable universe with remarkable economy, but its success rests on two components, dark matter and dark energy, whose physical nature remains entirely unknown. Any credible measurement that tightens or loosens the constraints on those components moves the entire theoretical enterprise forward, regardless of whether the immediate result looks dramatic on its own terms.</p><p>As the first satellite of the Copernicus programme, it paved the way for new approaches in both operations and science. Sentinel-1A remains at the forefront of Earth observation and continues to play a key role in enabling the application of artificial intelligence in data and services.</p><p>Because the account originates with ESA Space News, it functions best as a primary institutional report that is close to the data and operations, not as independent scientific validation. Institutional communications are produced by organizations with legitimate interests in presenting their work in a favorable light, which does not make them unreliable but does make them partial. Details that complicate the narrative, including instrument limitations, unexpected failures and results below projections, tend to be minimized relative to progress messages. Technical documentation and peer-reviewed publications, where they exist, provide the complementary layer that institutional releases cannot substitute.</p><p>The next step is to see whether the effect survives when independent surveys, different calibration strategies and tighter control of systematic uncertainties enter the picture. Programmes such as Euclid, DESI and the Rubin Observatory will deliver datasets over the next several years that cover the same parameter space with largely independent methods. If the current signal persists through those tests, its theoretical implications will become impossible to set aside.</p><p class=\"art-source\"><a href=\"https://www.esa.int/Applications/Observing_the_Earth/Copernicus/Sentinel-1/Time_to_say_goodbye_to_Sentinel-1A\" target=\"_blank\" rel=\"noopener noreferrer\">Source</a></p>",
    "highlights": [
      "Ponto central: Após doze anos de serviço excepcional, o satélite radar pioneiro Copernicus Sentinel-1A encerrou sua missão, mas seu legado e a continuidade da.",
      "Dado-chave: Após doze anos de serviço excepcional, o satélite radar pioneiro Copernicus Sentinel-1A encerrou sua missão, mas seu legado e a continuidade da",
    ...
    "highlights_en": [
      "Core point: After 12 years of exceptional service, the pioneering Copernicus Sentinel-1A radar satellite has reached the end of its mission.",
    ...
    "lastModifiedIso": "2026-06-30T17:39:43+00:00",
    "source": "ESA Space News",
    "sourceDomain": "www. esa. int",
    "sourceType": "agency",
    "sourceTypeLabel": "Fonte institucional",
    ...
    "realUrl": "https://www.cosmosweek.com/?article=time-to-say-goodbye-to-sentinel-1a",
    "realUrl_pt": "https://www.cosmosweek.com/?article=time-to-say-goodbye-to-sentinel-1a",
    "realUrl_en": "https://www.cosmosweek.com/?article=time-to-say-goodbye-to-sentinel-1a&lang=en",
    "shareUrl": "https://www.cosmosweek.com/noticia/time-to-say-goodbye-to-sentinel-1a/",
    "shareUrl_pt": "https://www.cosmosweek.com/noticia/time-to-say-goodbye-to-sentinel-1a/",
    "shareUrl_en": "https://www.cosmosweek.com/en/news/time-to-say-goodbye-to-sentinel-1a/",
    "canonicalUrl": "https://www.cosmosweek.com/noticia/time-to-say-goodbye-to-sentinel-1a/",
    "canonicalUrl_pt": "https://www.cosmosweek.com/noticia/time-to-say-goodbye-to-sentinel-1a/",
    "canonicalUrl_en": "https://www.cosmosweek.com/en/news/time-to-say-goodbye-to-sentinel-1a/",
    "defaultLanguage": "pt-BR",
    "availableLanguages": [
      "pt-BR",
      "en-US"
    ...
    "imageAlt": "O Fim da Missão do Sentinel-1A: Um Legado de 12 Anos na Observação da Terra",
    "imageAlt_pt": "O Fim da Missão do Sentinel-1A: Um Legado de 12 Anos na Observação da Terra",
    "imageAlt_en": "Time to say goodbye to Sentinel-1A",
    "coverageKind": "agency",
    "coverageKindLabel": "Fonte institucional",
    "coverageKindLabel_pt": "Fonte institucional",
    "coverageKindLabel_en": "Institutional source",
  ...
  },
  {
    ...
    "inline_images": [
      {
        "src": "https://www.esa.int/var/esa/storage/images/esa_multimedia/images/2004/06/felled_trees_at_tunguska/10220612-2-eng-GB/Felled_trees_at_Tunguska_article.jpg",
        "alt": "Árvores derrubadas em Tunguska",
        "alt_pt": "Árvores derrubadas em Tunguska",
        "alt_en": "Felled trees at Tunguska",
        "caption": "Árvores derrubadas em Tunguska",
        "caption_pt": "Árvores derrubadas em Tunguska",
        "caption_en": "Felled trees at Tunguska"
      },
      {
        "src": "https://www.esa.int/var/esa/storage/images/esa_multimedia/images/2010/06/gaspra/9647485-3-eng-GB/Gaspra_article.jpg",
        "alt": "",
        "alt_pt": "",
        "alt_en": "",
        "caption": "",
      ...
      {
        "src": "https://www.esa.int/var/esa/storage/images/esa_multimedia/images/2014/06/chelyabinsk_fireball/14573452-1-eng-GB/Chelyabinsk_fireball_article.png",
        "alt": "Bola de fogo de Chelyabinsk",
        "alt_pt": "Bola de fogo de Chelyabinsk",
        "alt_en": "Chelyabinsk fireball",
        "caption": "Bola de fogo de Chelyabinsk",
        "caption_pt": "Bola de fogo de Chelyabinsk",
        "caption_en": "Chelyabinsk fireball"
      },
      {
      ...
      {
        "src": "https://www.esa.int/var/esa/storage/images/esa_multimedia/images/2026/06/near_shoemaker/27354905-1-eng-GB/NEAR_Shoemaker_article.jpg",
        "alt": "PERTO do Sapateiro",
        "alt_pt": "PERTO do Sapateiro",
        "alt_en": "NEAR Shoemaker",
        "caption": "PERTO do Sapateiro",
        "caption_pt": "PERTO do Sapateiro",
        "caption_en": "NEAR Shoemaker"
      },
      {
        "src": "https://www.esa.int/var/esa/storage/images/esa_multimedia/images/2026/06/hayabusa_touchdown/27354999-1-eng-GB/Hayabusa_touchdown_article.jpg",
        "alt": "Aterrissagem Hayabusa",
        "alt_pt": "Aterrissagem Hayabusa",
        "alt_en": "Hayabusa touchdown",
        "caption": "Aterrissagem Hayabusa",
        "caption_pt": "Aterrissagem Hayabusa",
        "caption_en": "Hayabusa touchdown"
      }
    ],
    "video": null,
    "audio": null,
    "title": "Dia do Asteroide e oito outras datas importantes na história dos asteroides",
    "title_pt": "Dia do Asteroide e oito outras datas importantes na história dos asteroides",
    "title_en": "Asteroid Day & eight other key dates in asteroid history",
    "sub": "O Dia do Asteroide é um evento global anual, reconhecido pela Organização das Nações Unidas (ONU), dedicado à promoção da educação pública sobre asteroides e à defesa planetária.",
    "sub_pt": "O Dia do Asteroide é um evento global anual, reconhecido pela Organização das Nações Unidas (ONU), dedicado à promoção da educação pública sobre asteroides e à defesa planetária.",
    "sub_en": "Happy Asteroid Day! . Today is the annual UN-recognised global event to promote public education on asteroids and planetary defence.",
    "excerpt": "O Dia do Asteroide é um evento global anual, reconhecido pela Organização das Nações Unidas (ONU), dedicado à promoção da educação pública sobre asteroides e à defesa planetária.",
    "excerpt_pt": "O Dia do Asteroide é um evento global anual, reconhecido pela Organização das Nações Unidas (ONU), dedicado à promoção da educação pública sobre asteroides e à defesa planetária.",
    "excerpt_en": "Happy Asteroid Day! . Today is the annual UN-recognised global event to promote public education on asteroids and planetary defence.",
    "body": "<p>O Dia do Asteroide é um evento global anual, reconhecido pela Organização das Nações Unidas (ONU), que visa promover a educação pública sobre asteroides e a defesa planetária. Esta iniciativa busca aumentar a conscientização sobre o papel dos asteroides na formação do nosso sistema solar, os riscos potenciais de impactos e as estratégias desenvolvidas para mitigar essas ameaças. A escolha da data para esta celebração não é aleatória, mas carrega um significado histórico profundo que remete a um dos eventos mais impactantes da história recente da Terra, envolvendo um objeto extraterrestre. Compreender o porquê desta data específica é fundamental para apreciar a urgência e a relevância da defesa planetária na atualidade.</p><p>A data de 30 de junho foi escolhida para comemorar o Aniversário do Evento de Tunguska, ocorrido em 1908. Naquela manhã, um objeto celeste, provavelmente um asteroide ou cometa, explodiu na atmosfera sobre a Sibéria Oriental, na Rússia, liberando uma energia equivalente a cerca de 10 a 15 megatons de TNT. Embora não tenha havido uma cratera de impacto, a explosão devastou uma área de mais de 2.000 quilômetros quadrados, derrubando cerca de 80 milhões de árvores. Este evento, o maior impacto terrestre registrado na história moderna, serviu como um lembrete sombrio da vulnerabilidade do nosso planeta a colisões cósmicas e impulsionou, décadas mais tarde, a criação de iniciativas de monitoramento e defesa.</p><p>A história da nossa compreensão sobre os asteroides, no entanto, precede o evento de Tunguska em mais de um século. O primeiro asteroide, Ceres, foi descoberto em 1º de janeiro de 1801 pelo astrônomo Giuseppe Piazzi. Inicialmente classificado como um planeta, Ceres foi posteriormente reclassificado como asteroide e, mais recentemente, como planeta anão. A descoberta de outros corpos celestes na mesma região entre Marte e Júpiter, que hoje conhecemos como o cinturão de asteroides, expandiu significativamente nosso conhecimento sobre a composição e a dinâmica do sistema solar. Em 1932, o asteroide 1862 Apollo foi o primeiro objeto próximo à Terra (NEA) a ser identificado, marcando o início da era da detecção de objetos potencialmente perigosos.</p><p>Eventos subsequentes continuaram a moldar a percepção pública e científica sobre os asteroides. Em julho de 1994, o impacto do cometa Shoemaker-Levy 9 em Júpiter, observado por telescópios em todo o mundo, demonstrou de forma espetacular o poder destrutivo de colisões cósmicas e a importância de Júpiter como um &quot;escudo gravitacional&quot; para o sistema solar interior. Mais recentemente, em 15 de fevereiro de 2013, o meteoro de Chelyabinsk explodiu sobre a Rússia, causando uma onda de choque que feriu mais de 1.500 pessoas e danificou milhares de edifícios. Este evento, embora de menor escala que Tunguska, ocorreu em uma área densamente povoada e foi amplamente documentado por câmeras, reforçando a necessidade urgente de sistemas de alerta e defesa planetária.</p><p>Avanços tecnológicos permitiram não apenas a detecção, mas também a exploração direta de asteroides. A missão NEAR Shoemaker, da NASA, fez história em 2001 ao se tornar a primeira espaçonave a pousar em um asteroide, Eros, fornecendo dados cruciais sobre sua composição e estrutura. Outras missões notáveis incluem a Hayabusa da JAXA, que trouxe amostras do asteroide Itokawa para a Terra em 2010, e a OSIRIS-REx da NASA, que coletou amostras do asteroide Bennu em 2020 e as entregou em setembro de 2023. Essas missões são fundamentais para entender a origem do sistema solar e a distribuição de recursos valiosos.</p><p>A defesa planetária, um campo relativamente novo, ganhou destaque com o desenvolvimento de tecnologias capazes de mitigar a ameaça de impactos. A missão DART (Double Asteroid Redirection Test) da NASA, lançada em 2021, representou um marco significativo. Em setembro de 2022, a espaçonave DART colidiu intencionalmente com Dimorphos, a lua do asteroide Didymos, alterando com sucesso sua órbita. Este teste demonstrou pela primeira vez a viabilidade de uma técnica de deflexão cinética, provando que a humanidade tem a capacidade tecnológica de proteger a Terra de futuros impactos de asteroides, caso seja necessário.</p><p>A &quot;era de ouro dos asteroides&quot; em que vivemos é caracterizada por um aumento sem precedentes na pesquisa, exploração e conscientização sobre esses corpos celestes. Desde a sua descoberta inicial até as missões de retorno de amostras e os testes de defesa planetária, os asteroides continuam a fascinar e a desafiar a ciência. O Dia do Asteroide serve como um lembrete anual da importância contínua de monitorar o espaço, aprimorar nossas capacidades de defesa e educar o público sobre a ciência e os riscos associados a esses viajantes cósmicos, garantindo a segurança e o futuro do nosso planeta.</p>",
    "body_pt": "<p>O Dia do Asteroide é um evento global anual, reconhecido pela Organização das Nações Unidas (ONU), que visa promover a educação pública sobre asteroides e a defesa planetária. Esta iniciativa busca aumentar a conscientização sobre o papel dos asteroides na formação do nosso sistema solar, os riscos potenciais de impactos e as estratégias desenvolvidas para mitigar essas ameaças. A escolha da data para esta celebração não é aleatória, mas carrega um significado histórico profundo que remete a um dos eventos mais impactantes da história recente da Terra, envolvendo um objeto extraterrestre. Compreender o porquê desta data específica é fundamental para apreciar a urgência e a relevância da defesa planetária na atualidade.</p><p>A data de 30 de junho foi escolhida para comemorar o Aniversário do Evento de Tunguska, ocorrido em 1908. Naquela manhã, um objeto celeste, provavelmente um asteroide ou cometa, explodiu na atmosfera sobre a Sibéria Oriental, na Rússia, liberando uma energia equivalente a cerca de 10 a 15 megatons de TNT. Embora não tenha havido uma cratera de impacto, a explosão devastou uma área de mais de 2.000 quilômetros quadrados, derrubando cerca de 80 milhões de árvores. Este evento, o maior impacto terrestre registrado na história moderna, serviu como um lembrete sombrio da vulnerabilidade do nosso planeta a colisões cósmicas e impulsionou, décadas mais tarde, a criação de iniciativas de monitoramento e defesa.</p><p>A história da nossa compreensão sobre os asteroides, no entanto, precede o evento de Tunguska em mais de um século. O primeiro asteroide, Ceres, foi descoberto em 1º de janeiro de 1801 pelo astrônomo Giuseppe Piazzi. Inicialmente classificado como um planeta, Ceres foi posteriormente reclassificado como asteroide e, mais recentemente, como planeta anão. A descoberta de outros corpos celestes na mesma região entre Marte e Júpiter, que hoje conhecemos como o cinturão de asteroides, expandiu significativamente nosso conhecimento sobre a composição e a dinâmica do sistema solar. Em 1932, o asteroide 1862 Apollo foi o primeiro objeto próximo à Terra (NEA) a ser identificado, marcando o início da era da detecção de objetos potencialmente perigosos.</p><p>Eventos subsequentes continuaram a moldar a percepção pública e científica sobre os asteroides. Em julho de 1994, o impacto do cometa Shoemaker-Levy 9 em Júpiter, observado por telescópios em todo o mundo, demonstrou de forma espetacular o poder destrutivo de colisões cósmicas e a importância de Júpiter como um &quot;escudo gravitacional&quot; para o sistema solar interior. Mais recentemente, em 15 de fevereiro de 2013, o meteoro de Chelyabinsk explodiu sobre a Rússia, causando uma onda de choque que feriu mais de 1.500 pessoas e danificou milhares de edifícios. Este evento, embora de menor escala que Tunguska, ocorreu em uma área densamente povoada e foi amplamente documentado por câmeras, reforçando a necessidade urgente de sistemas de alerta e defesa planetária.</p><p>Avanços tecnológicos permitiram não apenas a detecção, mas também a exploração direta de asteroides. A missão NEAR Shoemaker, da NASA, fez história em 2001 ao se tornar a primeira espaçonave a pousar em um asteroide, Eros, fornecendo dados cruciais sobre sua composição e estrutura. Outras missões notáveis incluem a Hayabusa da JAXA, que trouxe amostras do asteroide Itokawa para a Terra em 2010, e a OSIRIS-REx da NASA, que coletou amostras do asteroide Bennu em 2020 e as entregou em setembro de 2023. Essas missões são fundamentais para entender a origem do sistema solar e a distribuição de recursos valiosos.</p><p>A defesa planetária, um campo relativamente novo, ganhou destaque com o desenvolvimento de tecnologias capazes de mitigar a ameaça de impactos. A missão DART (Double Asteroid Redirection Test) da NASA, lançada em 2021, representou um marco significativo. Em setembro de 2022, a espaçonave DART colidiu intencionalmente com Dimorphos, a lua do asteroide Didymos, alterando com sucesso sua órbita. Este teste demonstrou pela primeira vez a viabilidade de uma técnica de deflexão cinética, provando que a humanidade tem a capacidade tecnológica de proteger a Terra de futuros impactos de asteroides, caso seja necessário.</p><p>A &quot;era de ouro dos asteroides&quot; em que vivemos é caracterizada por um aumento sem precedentes na pesquisa, exploração e conscientização sobre esses corpos celestes. Desde a sua descoberta inicial até as missões de retorno de amostras e os testes de defesa planetária, os asteroides continuam a fascinar e a desafiar a ciência. O Dia do Asteroide serve como um lembrete anual da importância contínua de monitorar o espaço, aprimorar nossas capacidades de defesa e educar o público sobre a ciência e os riscos associados a esses viajantes cósmicos, garantindo a segurança e o futuro do nosso planeta.</p>",
    "body_en": "<p>Happy Asteroid Day! Today is the annual UN-recognised global event to promote public education on asteroids and planetary defence. But why today, of all days. The institutional report frames the development in practical terms and ties it to the broader mission or observing effort.</p><p>This matters because astronomy does not advance on single detections. The field builds confidence by accumulating independent observations across different wavelengths, instruments and epochs until isolated signals become defensible conclusions. What looks convincing in one dataset can dissolve when a second instrument looks at the same target, and what looks marginal can solidify when follow-up campaigns confirm the original reading. The current standard requires that a result survive this triangulation before the community treats it as settled. Today is the annual UN-recognised global event to promote public education on asteroids and planetary defence. Read on to find out, and find out the other key dates in our current golden age of asteroids.</p><p>What gives the story weight is not just the object itself, but the way the measurement trims the range of plausible physical explanations. Astronomy has accumulated enough cases to know that the most interesting results are rarely the ones that confirm expectations cleanly; they are the ones that confirm some expectations while complicating others, or that open a parameter space that previous instruments could not reach. The scientific community evaluates these contributions by asking whether the new data constrain a model in a way that older data could not, and whether those constraints survive systematic review.</p><p>Because the account originates with ESA Space News, it functions best as a primary institutional report that is close to the data and operations, not as independent scientific validation. Institutional communications are produced by organizations with legitimate interests in presenting their work in a favorable light, which does not make them unreliable but does make them partial. Details that complicate the narrative, including instrument limitations, unexpected failures and results below projections, tend to be minimized relative to progress messages. Technical documentation and peer-reviewed publications, where they exist, provide the complementary layer that institutional releases cannot substitute.</p><p>The next step is to see whether other instruments and other wavelengths tell the same story. Campaigns with JWST, the VLT, the forthcoming Extremely Large Telescopes and radio arrays will provide the spectral coverage and spatial resolution needed to move from detection to physical characterization. The timeline for that kind of confirmation is typically measured in years, not months, which is worth keeping in mind when reading the current result.</p><p class=\"art-source\"><a href=\"https://www.esa.int/Space_Safety/Planetary_Defence/Asteroid_Day_eight_other_key_dates_in_asteroid_history\" target=\"_blank\" rel=\"noopener noreferrer\">Source</a></p>",
    "highlights": [
      "Ponto central: O Dia do Asteroide é um evento global anual, reconhecido pela Organização das Nações Unidas (ONU), dedicado à promoção da educação pública sobre.",
      "Dado-chave: O Dia do Asteroide é um evento global anual, reconhecido pela Organização das Nações Unidas (ONU), dedicado à promoção da educação pública sobre",
      "Origem institucional: distinguir anúncio de evidência."
    ],
    "highlights_pt": [
      "Ponto central: O Dia do Asteroide é um evento global anual, reconhecido pela Organização das Nações Unidas (ONU), dedicado à promoção da educação pública sobre.",
    ...
    "highlights_en": [
      "Core point: Happy Asteroid Day. Today is the annual UN-recognised global event to promote public education on asteroids and planetary defence.",
      "Key detail: Happy Asteroid Day. Today is the annual UN-recognised global event to promote public education on asteroids and planetary defence",
      "Institutional origin: separate announcement from evidence."
    ],
    "date": "30 jun 2026",
    "date_pt": "30 jun 2026",
    ...
    "realUrl": "https://www.cosmosweek.com/?article=asteroid-day-eight-other-key-dates-in-asteroid-history",
    "realUrl_pt": "https://www.cosmosweek.com/?article=asteroid-day-eight-other-key-dates-in-asteroid-history",
    "realUrl_en": "https://www.cosmosweek.com/?article=asteroid-day-eight-other-key-dates-in-asteroid-history&lang=en",
    "shareUrl": "https://www.cosmosweek.com/noticia/asteroid-day-eight-other-key-dates-in-asteroid-history/",
    "shareUrl_pt": "https://www.cosmosweek.com/noticia/asteroid-day-eight-other-key-dates-in-asteroid-history/",
    "shareUrl_en": "https://www.cosmosweek.com/en/news/asteroid-day-eight-other-key-dates-in-asteroid-history/",
    "canonicalUrl": "https://www.cosmosweek.com/noticia/asteroid-day-eight-other-key-dates-in-asteroid-history/",
    "canonicalUrl_pt": "https://www.cosmosweek.com/noticia/asteroid-day-eight-other-key-dates-in-asteroid-history/",
    "canonicalUrl_en": "https://www.cosmosweek.com/en/news/asteroid-day-eight-other-key-dates-in-asteroid-history/",
    "defaultLanguage": "pt-BR",
    "availableLanguages": [
      "pt-BR",
      "en-US"
    ...
    "imageAlt": "Dia do Asteroide e oito outras datas importantes na história dos asteroides",
    "imageAlt_pt": "Dia do Asteroide e oito outras datas importantes na história dos asteroides",
    "imageAlt_en": "Asteroid Day & eight other key dates in asteroid history",
    "coverageKind": "agency",
    "coverageKindLabel": "Fonte institucional",
    "coverageKindLabel_pt": "Fonte institucional",
    "coverageKindLabel_en": "Institutional source",
  ...
  },
  {
    ...
    "cat": "Astronomia",
    "catCls": "astronomia",
    "img": "https://www.nasa.gov/wp-content/uploads/2026/06/slide1.jpeg",
    "inline_images": [],
    "video": null,
    "audio": null,
    "title": "Destaques Científicos do Mês do Ames da NASA: Julho de 2026",
    "title_pt": "Destaques Científicos do Mês do Ames da NASA: Julho de 2026",
    "title_en": "Ames Science Stars of the Month July 2026",
    "sub": "A Diretoria Científica Ames da NASA reconhece as notáveis contribuições de Sungshin Choi, Yi-Chun Chen, Emma Yates e Eduardo Bendek, destacando seus papéis cruciais na missão da.",
    "sub_pt": "A Diretoria Científica Ames da NASA reconhece as notáveis contribuições de Sungshin Choi, Yi-Chun Chen, Emma Yates e Eduardo Bendek, destacando seus papéis cruciais na missão da.",
    ...
    "excerpt": "A Diretoria Científica Ames da NASA reconhece as notáveis contribuições de Sungshin Choi, Yi-Chun Chen, Emma Yates e Eduardo Bendek, destacando seus papéis cruciais na missão da agência em julho de 2026.",
    "excerpt_pt": "A Diretoria Científica Ames da NASA reconhece as notáveis contribuições de Sungshin Choi, Yi-Chun Chen, Emma Yates e Eduardo Bendek, destacando seus papéis cruciais na missão da agência em julho de 2026.",
    "excerpt_en": "NASA Ames Science Stars of the Month: July 2026 The NASA Ames Science Directorate recognizes the outstanding contributions of Sungshin Choi, Yi-Chun Chen, Emma Yates, Eduardo Bendek.",
    "body": "<p>A Diretoria Científica Ames da NASA anunciou os Destaques Científicos do Mês para julho de 2026, homenageando Sungshin Choi, Yi-Chun Chen, Emma Yates e Eduardo Bendek. Esses indivíduos foram reconhecidos por suas contribuições notáveis e seu compromisso com a missão da NASA, que exemplifica o espírito empreendedor, o conhecimento técnico e a disposição colaborativa necessários para explorar nosso mundo e além. A cerimônia de reconhecimento destacou a importância de suas pesquisas e o impacto de seu trabalho nas diversas áreas da ciência espacial e terrestre.</p><p>Emma Yates, uma cientista pesquisadora do Bay Area Environmental Research Institute, atua na Divisão de Ciências da Terra. Ela tem desempenhado um papel fundamental no avanço do projeto Ozone Where We Live (OWWL) da NASA. Suas responsabilidades incluem liderar o envolvimento da comunidade, fomentar parcerias entre cientistas cidadãos e coordenar implantações de campo em toda a Califórnia. O trabalho de Yates é crucial para a compreensão e monitoramento da qualidade do ar, contribuindo significativamente para a ciência ambiental e a conscientização pública sobre questões atmosféricas.</p><p>Yi-Chun Chen foi homenageada por seu apoio exemplar a diversas atividades de biologia espacial. Suas contribuições abrangem investigações de voo como MeF1, GEARS e ELISA MABL (Enzyme-Linked Immunosorbent Assay, Microgravity Associated Bone Loss). O trabalho de Chen é vital para o avanço da pesquisa em ambientes de microgravidade, ajudando a compreender os efeitos do espaço no corpo humano e a desenvolver contramedidas para futuras missões de longa duração. Sua dedicação garante o sucesso de experimentos complexos e a coleta de dados essenciais para a exploração espacial.</p><p>Eduardo Bendek, um cientista óptico afiliado ao Instituto SETI, integra a Divisão de Astrofísica da Divisão de Ciência Espacial e Astrobiologia. Sua expertise em óptica é fundamental para o desenvolvimento de tecnologias avançadas de observação, que são cruciais para a busca por vida extraterrestre e para a compreensão da formação e evolução de sistemas planetários. O trabalho de Bendek apoia diretamente os objetivos da NASA de explorar o universo e desvendar seus mistérios, contribuindo com inovações que permitem observações mais precisas e detalhadas do cosmos.</p><p>Sungshin Choi também foi reconhecida entre os Destaques Científicos do Mês. Embora os detalhes específicos de suas contribuições não tenham sido fornecidos no anúncio, sua inclusão ressalta a importância de seu trabalho para a Diretoria Científica Ames da NASA. A homenagem a Choi reforça o compromisso da agência em valorizar todos os pesquisadores que, com sua dedicação e expertise, impulsionam a inovação e o conhecimento científico em diversas frentes.</p><p>A Diretoria Científica Ames da NASA, ao reconhecer esses quatro cientistas, sublinha a diversidade e a excelência das pesquisas realizadas em suas instalações. O compromisso demonstrado por Sungshin Choi, Yi-Chun Chen, Emma Yates e Eduardo Bendek com a missão da NASA é um testemunho do espírito inovador e da colaboração interdisciplinar que são pilares da exploração científica. Tais reconhecimentos não apenas celebram conquistas individuais, mas também inspiram a próxima geração de cientistas e engenheiros a perseguir descobertas que expandam os limites do conhecimento humano.</p>",
    "body_pt": "<p>A Diretoria Científica Ames da NASA anunciou os Destaques Científicos do Mês para julho de 2026, homenageando Sungshin Choi, Yi-Chun Chen, Emma Yates e Eduardo Bendek. Esses indivíduos foram reconhecidos por suas contribuições notáveis e seu compromisso com a missão da NASA, que exemplifica o espírito empreendedor, o conhecimento técnico e a disposição colaborativa necessários para explorar nosso mundo e além. A cerimônia de reconhecimento destacou a importância de suas pesquisas e o impacto de seu trabalho nas diversas áreas da ciência espacial e terrestre.</p><p>Emma Yates, uma cientista pesquisadora do Bay Area Environmental Research Institute, atua na Divisão de Ciências da Terra. Ela tem desempenhado um papel fundamental no avanço do projeto Ozone Where We Live (OWWL) da NASA. Suas responsabilidades incluem liderar o envolvimento da comunidade, fomentar parcerias entre cientistas cidadãos e coordenar implantações de campo em toda a Califórnia. O trabalho de Yates é crucial para a compreensão e monitoramento da qualidade do ar, contribuindo significativamente para a ciência ambiental e a conscientização pública sobre questões atmosféricas.</p><p>Yi-Chun Chen foi homenageada por seu apoio exemplar a diversas atividades de biologia espacial. Suas contribuições abrangem investigações de voo como MeF1, GEARS e ELISA MABL (Enzyme-Linked Immunosorbent Assay, Microgravity Associated Bone Loss). O trabalho de Chen é vital para o avanço da pesquisa em ambientes de microgravidade, ajudando a compreender os efeitos do espaço no corpo humano e a desenvolver contramedidas para futuras missões de longa duração. Sua dedicação garante o sucesso de experimentos complexos e a coleta de dados essenciais para a exploração espacial.</p><p>Eduardo Bendek, um cientista óptico afiliado ao Instituto SETI, integra a Divisão de Astrofísica da Divisão de Ciência Espacial e Astrobiologia. Sua expertise em óptica é fundamental para o desenvolvimento de tecnologias avançadas de observação, que são cruciais para a busca por vida extraterrestre e para a compreensão da formação e evolução de sistemas planetários. O trabalho de Bendek apoia diretamente os objetivos da NASA de explorar o universo e desvendar seus mistérios, contribuindo com inovações que permitem observações mais precisas e detalhadas do cosmos.</p><p>Sungshin Choi também foi reconhecida entre os Destaques Científicos do Mês. Embora os detalhes específicos de suas contribuições não tenham sido fornecidos no anúncio, sua inclusão ressalta a importância de seu trabalho para a Diretoria Científica Ames da NASA. A homenagem a Choi reforça o compromisso da agência em valorizar todos os pesquisadores que, com sua dedicação e expertise, impulsionam a inovação e o conhecimento científico em diversas frentes.</p><p>A Diretoria Científica Ames da NASA, ao reconhecer esses quatro cientistas, sublinha a diversidade e a excelência das pesquisas realizadas em suas instalações. O compromisso demonstrado por Sungshin Choi, Yi-Chun Chen, Emma Yates e Eduardo Bendek com a missão da NASA é um testemunho do espírito inovador e da colaboração interdisciplinar que são pilares da exploração científica. Tais reconhecimentos não apenas celebram conquistas individuais, mas também inspiram a próxima geração de cientistas e engenheiros a perseguir descobertas que expandam os limites do conhecimento humano.</p>",
    "body_en": "<p>NASA Ames Science Stars of the Month: July 2026 The NASA Ames Science Directorate recognizes the outstanding contributions of Sungshin Choi, Yi-Chun Chen, Emma Yates, Eduardo Bendek. The institutional report frames the development in practical terms and ties it to the broader mission or observing effort.</p><p>It is relevant because astronomy does not advance on single detections. The field builds confidence by accumulating independent observations across different wavelengths, instruments and epochs until isolated signals become defensible conclusions. What looks convincing in one dataset can dissolve when a second instrument looks at the same target, and what looks marginal can solidify when follow-up campaigns confirm the original reading. The current standard requires that a result survive this triangulation before the community treats it as settled. NASA Ames Science Stars of the Month: July 2026 The NASA Ames Science Directorate recognizes the outstanding contributions of (pictured left to right) Sungshin Choi, Yi-Chun Chen. NASA Ames Science Stars of the Month: July 2026 Pictured left to right: Sungshin Choi, Yi-Chun Chen, Emma Yates, Eduardo Bendek The NASA Ames Science Directorate recognizes the.</p><p>Emma Yates Emma Yates is a research scientist with the Bay Area Environmental Research Institute in the Earth Science Division. Eduardo Bendek Eduardo Bendek is an optical scientist with the SETI Institute in the Astrophysics Branch in the Space Science and Astrobiology Division.</p><p>The NASA Ames Science Directorate recognizes the outstanding contributions of (pictured left to right) Sungshin Choi. Eduardo Bendek The NASA Ames Science Directorate recognizes the outstanding contributions of (pictured left to right) Sungshin Choi.</p><p>Their commitment to the NASA mission represents the entrepreneurial spirit, technical expertise, and collaborative disposition needed to explore this world and beyond. She is a tireless advocate for high-quality science and the principal investigators whom she represents.</p><p>What gives the story weight is not just the object itself, but the way the measurement trims the range of plausible physical explanations. Astronomy has accumulated enough cases to know that the most interesting results are rarely the ones that confirm expectations cleanly; they are the ones that confirm some expectations while complicating others, or that open a parameter space that previous instruments could not reach. The scientific community evaluates these contributions by asking whether the new data constrain a model in a way that older data could not, and whether those constraints survive systematic review.</p><p>Yi-Chun is recognized for her exemplary support of multiple space biology activities including the MeF1, GEARS, and ELISA MABL (Enzyme-Linked Immunosorbent Assay, Microgravity. Emma Yates is a research scientist with the Bay Area Environmental Research Institute in the Earth Science Division.</p><p>Because the account originates with NASA News Releases, it functions best as a primary institutional report that is close to the data and operations, not as independent scientific validation. Institutional communications are produced by organizations with legitimate interests in presenting their work in a favorable light, which does not make them unreliable but does make them partial. Details that complicate the narrative, including instrument limitations, unexpected failures and results below projections, tend to be minimized relative to progress messages. Technical documentation and peer-reviewed publications, where they exist, provide the complementary layer that institutional releases cannot substitute.</p><p>The next step is to see whether other instruments and other wavelengths tell the same story. Campaigns with JWST, the VLT, the forthcoming Extremely Large Telescopes and radio arrays will provide the spectral coverage and spatial resolution needed to move from detection to physical characterization. The timeline for that kind of confirmation is typically measured in years, not months, which is worth keeping in mind when reading the current result.</p><p class=\"art-source\"><a href=\"https://www.nasa.gov/general/ames-stars-of-the-month-july-2026/\" target=\"_blank\" rel=\"noopener noreferrer\">Source</a></p>",
    "highlights": [
      "Ponto central: A Diretoria Científica Ames da NASA reconhece as notáveis contribuições de Sungshin Choi, Yi-Chun Chen, Emma Yates e Eduardo Bendek, destacando seus.",
      "Dado-chave: A Diretoria Científica Ames da NASA reconhece as notáveis contribuições de Sungshin Choi, Yi-Chun Chen, Emma Yates e Eduardo Bendek, destacando.",
      "Origem institucional: distinguir anúncio de evidência."
    ],
    "highlights_pt": [
      "Ponto central: A Diretoria Científica Ames da NASA reconhece as notáveis contribuições de Sungshin Choi, Yi-Chun Chen, Emma Yates e Eduardo Bendek, destacando seus.",
    ...
    "highlights_en": [
      ...
      "Key detail: NASA Ames Science Stars of the Month: July 2026 The NASA Ames Science Directorate recognizes the outstanding contributions of Sungshin Choi.",
      "Institutional origin: separate announcement from evidence."
    ],
    "date": "30 jun 2026",
    "date_pt": "30 jun 2026",
    ...
    "realUrl": "https://www.cosmosweek.com/?article=ames-science-stars-of-the-month-july-2026",
    "realUrl_pt": "https://www.cosmosweek.com/?article=ames-science-stars-of-the-month-july-2026",
    "realUrl_en": "https://www.cosmosweek.com/?article=ames-science-stars-of-the-month-july-2026&lang=en",
    "shareUrl": "https://www.cosmosweek.com/noticia/ames-science-stars-of-the-month-july-2026/",
    "shareUrl_pt": "https://www.cosmosweek.com/noticia/ames-science-stars-of-the-month-july-2026/",
    "shareUrl_en": "https://www.cosmosweek.com/en/news/ames-science-stars-of-the-month-july-2026/",
    "canonicalUrl": "https://www.cosmosweek.com/noticia/ames-science-stars-of-the-month-july-2026/",
    "canonicalUrl_pt": "https://www.cosmosweek.com/noticia/ames-science-stars-of-the-month-july-2026/",
    "canonicalUrl_en": "https://www.cosmosweek.com/en/news/ames-science-stars-of-the-month-july-2026/",
    "defaultLanguage": "pt-BR",
    "availableLanguages": [
      "pt-BR",
      "en-US"
    ...
    "imageAlt": "Destaques Científicos do Mês do Ames da NASA: Julho de 2026",
    "imageAlt_pt": "Destaques Científicos do Mês do Ames da NASA: Julho de 2026",
    "imageAlt_en": "Ames Science Stars of the Month July 2026",
    "coverageKind": "agency",
    "coverageKindLabel": "Fonte institucional",
    "coverageKindLabel_pt": "Fonte institucional",
    "coverageKindLabel_en": "Institutional source",
  ...
  },
  {
    ...
    "highlights": [
      "Ponto central: Buracos negros de massa estelar em processo de acreção demonstram uma variabilidade significativa em todo o espectro eletromagnético, manifestada por.",
      "Dado-chave: Buracos negros de massa estelar em processo de acreção demonstram uma variabilidade significativa em todo o espectro eletromagnético.",
    ...
    "highlights_en": [
      "Core point: Accreting stellar-mass black holes exhibit dramatic variability across the electromagnetic spectrum, including spectral state transitions, outbursts.",
      "Key detail: Accreting stellar-mass black holes exhibit dramatic variability across the electromagnetic spectrum, including spectral state transitions.",
  ...
  },
  {
    ...
    "highlights": [
      "Ponto central: Pesquisadores confirmaram uma nova classe de objetos na Via Láctea, os 'fragmentos fósseis protuberantes', com Terzan 5 sendo o protótipo desses.",
      "Dado-chave: Pesquisadores confirmaram uma nova classe de objetos na Via Láctea, os 'fragmentos fósseis protuberantes', com Terzan 5 sendo o protótipo desses",
      "Origem institucional: distinguir anúncio de evidência."
    ],
    "highlights_pt": [
      "Ponto central: Pesquisadores confirmaram uma nova classe de objetos na Via Láctea, os 'fragmentos fósseis protuberantes', com Terzan 5 sendo o protótipo desses.",
    ...
    "highlights_en": [
      "Core point: Researchers have confirmed a new class of objects within our Milky Way galaxy: survivors called 'bulge fossil fragments.",
      "Key detail: Researchers have confirmed a new class of objects within our Milky Way galaxy: survivors called 'bulge fossil fragments",
      "Institutional origin: separate announcement from evidence."
    ],
    "date": "16 jun 2026",
    "date_pt": "16 jun 2026",
