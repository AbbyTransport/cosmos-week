...
window.postsData = [
  ...
  },
  {
    ...
    "highlights": [
      "Em foco: O Dia do Asteroide é um evento global anual, reconhecido pela Organização das Nações Unidas (ONU), dedicado à promoção da educação pública sobre",
      "Detalhe: Origem institucional: distinguir anúncio de evidência",
      "Leitura editorial: release institucional, útil como fonte primária, mas não como validação independente."
    ],
    "highlights_pt": [
    ...
    "highlights_en": [
      "Focus: Happy Asteroid Day. Today is the annual UN-recognised global event to promote public education on asteroids and planetary defence",
      "Detail: Institutional origin: separate announcement from evidence",
      "Editorial reading: institutional release, useful as a primary source but not independent validation."
    ],
    "date": "30 jun 2026",
  ...
  },
  {
    ...
    "highlights": [
      "Em foco: A Diretoria Científica Ames da NASA reconhece as notáveis contribuições de Sungshin Choi, Yi-Chun Chen, Emma Yates e Eduardo Bendek, destacando seus",
      "Detalhe: Origem institucional: distinguir anúncio de evidência",
      "Leitura editorial: release institucional, útil como fonte primária, mas não como validação independente."
    ],
    "highlights_pt": [
  ...
  },
  {
    ...
    "cat": "Astronomia",
    "catCls": "astronomia",
    "img": "https://assets.science.nasa.gov/content/dam/science/missions/swift-observatory/news/2026/launch-preview/NE201566_2611x1654.jpg/jcr:content/renditions/cq5dam.web.1280.1280.jpeg",
    "inline_images": [
      {
        "src": "https://svs.gsfc.nasa.gov/vis/a010000/a010100/a010171/Swift_Interview_Still_searchweb.png",
        "alt": "Baixe imagens e vídeos de alta resolução relacionados ao Swift por meio do Scientific Visualization Studio da NASA.",
        "alt_pt": "Baixe imagens e vídeos de alta resolução relacionados ao Swift por meio do Scientific Visualization Studio da NASA.",
        "alt_en": "Download high-resolution images and videos related to Swift through NASA's Scientific Visualization Studio.",
        "caption": "Baixe imagens e vídeos de alta resolução relacionados ao Swift por meio do Scientific Visualization Studio da NASA.",
        "caption_pt": "Baixe imagens e vídeos de alta resolução relacionados ao Swift por meio do Scientific Visualization Studio da NASA.",
        "caption_en": "Download high-resolution images and videos related to Swift through NASA's Scientific Visualization Studio."
      }
    ],
    "video": {
      "kind": "embed",
      "platform": "youtube",
      "embedUrl": "https://www.youtube-nocookie.com/embed/THcvpKWZq4M?rel=0&modestbranding=1",
      "fileUrl": "",
    ...
    "audio": null,
    "title": "NASA e Parceiros Se Preparam para a Missão de Elevação Orbital do Observatório Swift em Junho",
    "title_pt": "NASA e Parceiros Se Preparam para a Missão de Elevação Orbital do Observatório Swift em Junho",
    "title_en": "Partners, NASA Ready for June Launch of Swift Boost Mission",
    "sub": "A NASA e seus parceiros, Katalyst Space e Northrop Grumman, estão se preparando para a missão de elevação orbital do Observatório Neil Gehrels Swift, com lançamento previsto para.",
    "sub_pt": "A NASA e seus parceiros, Katalyst Space e Northrop Grumman, estão se preparando para a missão de elevação orbital do Observatório Neil Gehrels Swift, com lançamento previsto para.",
    ...
    "excerpt": "A NASA e seus parceiros, Katalyst Space e Northrop Grumman, estão se preparando para a missão de elevação orbital do Observatório Neil Gehrels Swift, com lançamento previsto para 30 de junho.",
    "excerpt_pt": "A NASA e seus parceiros, Katalyst Space e Northrop Grumman, estão se preparando para a missão de elevação orbital do Observatório Neil Gehrels Swift, com lançamento previsto para 30 de junho.",
    ...
    "body": "<p>A NASA, em colaboração com seus parceiros Katalyst Space e Northrop Grumman, está se preparando para uma missão crucial de elevação orbital do Observatório Neil Gehrels Swift. Este observatório, que tem sido um pilar nos esforços da agência para desvendar os mistérios do universo nas últimas duas décadas, terá sua órbita elevada para prolongar sua vida útil e continuar suas importantes observações. O lançamento desta missão está previsto para 30 de junho, marcando um passo significativo no avanço das capacidades de serviço em órbita e na manutenção de ativos espaciais valiosos. A iniciativa reflete o compromisso contínuo da NASA com a exploração espacial e a inovação tecnológica, garantindo que instrumentos científicos de longa data possam continuar a fornecer dados cruciais para a comunidade científica global.</p><p>Desde seu lançamento, o Observatório Swift tem desempenhado um papel fundamental na pesquisa astrofísica, especialmente no estudo de explosões de raios gama (GRBs) e outros fenômenos cósmicos de alta energia. Sua capacidade de detectar e localizar rapidamente esses eventos permitiu descobertas sem precedentes sobre o universo distante e a evolução estelar. A decisão de elevar sua órbita, em vez de permitir sua reentrada natural na atmosfera terrestre, sublinha o valor inestimável de seus dados e a necessidade de estender sua operação. Esta abordagem não apenas preserva um recurso científico vital, mas também serve como um campo de testes para tecnologias emergentes de serviço e manutenção de satélites, que são essenciais para o futuro da exploração espacial.</p><p>A missão de elevação será realizada pela espaçonave LINK, um veículo robótico projetado especificamente para essa finalidade. O LINK pesa aproximadamente 880 libras (cerca de 400 quilogramas) e tem cerca de 1, 5 metro de altura, o que representa aproximadamente um terço do tamanho total do Observatório Swift. Esta espaçonave foi desenvolvida para se encontrar com o Swift em órbita, acoplar-se a ele e, em seguida, usar seus propulsores para aumentar gradualmente a altitude do observatório ao longo de vários meses. O objetivo principal é evitar que o Swift reentre na atmosfera da Terra, permitindo que continue suas operações científicas por um período adicional.</p><p>O processo de elevação orbital do Swift é um exemplo da crescente capacidade dos Estados Unidos em implantar espaçonaves robóticas que podem reposicionar, reparar, reabastecer e reequipar satélites após o lançamento. Essa tecnologia é vista como um componente crucial para a sustentabilidade das operações espaciais futuras, oferecendo uma alternativa à substituição de satélites caros e complexos. Ao demonstrar a viabilidade e a eficácia do serviço em órbita com o Swift, a NASA e seus parceiros esperam abrir caminho para uma nova era de gerenciamento de ativos espaciais, onde a vida útil dos satélites pode ser significativamente estendida através de intervenções robóticas.</p><p>A preparação para a missão LINK envolveu uma série rigorosa de testes e avaliações. Engenheiros da Katalyst Space foram fotografados fixando o LINK a uma placa de base dentro do Simulador de Ambiente Espacial do Centro de Voos Espaciais Goddard da NASA em 28 de abril, como parte dos preparativos. A espaçonave LINK concluiu com sucesso testes ambientais que simularam as condições extremas de lançamento e do espaço, realizados no NASA Goddard. Além disso, avaliações pré-voo adicionais foram realizadas nas instalações da Katalyst em Broomfield, Colorado, garantindo que o veículo esteja totalmente pronto para os desafios de sua missão.</p><p>Embora a missão de elevação orbital do Swift esteja programada para ser lançada em 30 de junho, o texto original também menciona que os veículos Stargazer, Pegasus XL e LINK aguardam a decolagem na quarta-feira, 17 de junho de 2026, no Wallops Flight Facility da NASA, na Virgínia. Esta informação sugere uma complexidade no cronograma ou pode indicar uma fase futura do programa de serviço em órbita, ou até mesmo um lançamento de teste para os veículos envolvidos. A coexistência dessas datas no material fornecido destaca a natureza multifacetada e de longo prazo dos projetos de exploração espacial, onde diferentes componentes e fases podem ter cronogramas distintos.</p>",
    "body_pt": "<p>A NASA, em colaboração com seus parceiros Katalyst Space e Northrop Grumman, está se preparando para uma missão crucial de elevação orbital do Observatório Neil Gehrels Swift. Este observatório, que tem sido um pilar nos esforços da agência para desvendar os mistérios do universo nas últimas duas décadas, terá sua órbita elevada para prolongar sua vida útil e continuar suas importantes observações. O lançamento desta missão está previsto para 30 de junho, marcando um passo significativo no avanço das capacidades de serviço em órbita e na manutenção de ativos espaciais valiosos. A iniciativa reflete o compromisso contínuo da NASA com a exploração espacial e a inovação tecnológica, garantindo que instrumentos científicos de longa data possam continuar a fornecer dados cruciais para a comunidade científica global.</p><p>Desde seu lançamento, o Observatório Swift tem desempenhado um papel fundamental na pesquisa astrofísica, especialmente no estudo de explosões de raios gama (GRBs) e outros fenômenos cósmicos de alta energia. Sua capacidade de detectar e localizar rapidamente esses eventos permitiu descobertas sem precedentes sobre o universo distante e a evolução estelar. A decisão de elevar sua órbita, em vez de permitir sua reentrada natural na atmosfera terrestre, sublinha o valor inestimável de seus dados e a necessidade de estender sua operação. Esta abordagem não apenas preserva um recurso científico vital, mas também serve como um campo de testes para tecnologias emergentes de serviço e manutenção de satélites, que são essenciais para o futuro da exploração espacial.</p><p>A missão de elevação será realizada pela espaçonave LINK, um veículo robótico projetado especificamente para essa finalidade. O LINK pesa aproximadamente 880 libras (cerca de 400 quilogramas) e tem cerca de 1, 5 metro de altura, o que representa aproximadamente um terço do tamanho total do Observatório Swift. Esta espaçonave foi desenvolvida para se encontrar com o Swift em órbita, acoplar-se a ele e, em seguida, usar seus propulsores para aumentar gradualmente a altitude do observatório ao longo de vários meses. O objetivo principal é evitar que o Swift reentre na atmosfera da Terra, permitindo que continue suas operações científicas por um período adicional.</p><p>O processo de elevação orbital do Swift é um exemplo da crescente capacidade dos Estados Unidos em implantar espaçonaves robóticas que podem reposicionar, reparar, reabastecer e reequipar satélites após o lançamento. Essa tecnologia é vista como um componente crucial para a sustentabilidade das operações espaciais futuras, oferecendo uma alternativa à substituição de satélites caros e complexos. Ao demonstrar a viabilidade e a eficácia do serviço em órbita com o Swift, a NASA e seus parceiros esperam abrir caminho para uma nova era de gerenciamento de ativos espaciais, onde a vida útil dos satélites pode ser significativamente estendida através de intervenções robóticas.</p><p>A preparação para a missão LINK envolveu uma série rigorosa de testes e avaliações. Engenheiros da Katalyst Space foram fotografados fixando o LINK a uma placa de base dentro do Simulador de Ambiente Espacial do Centro de Voos Espaciais Goddard da NASA em 28 de abril, como parte dos preparativos. A espaçonave LINK concluiu com sucesso testes ambientais que simularam as condições extremas de lançamento e do espaço, realizados no NASA Goddard. Além disso, avaliações pré-voo adicionais foram realizadas nas instalações da Katalyst em Broomfield, Colorado, garantindo que o veículo esteja totalmente pronto para os desafios de sua missão.</p><p>Embora a missão de elevação orbital do Swift esteja programada para ser lançada em 30 de junho, o texto original também menciona que os veículos Stargazer, Pegasus XL e LINK aguardam a decolagem na quarta-feira, 17 de junho de 2026, no Wallops Flight Facility da NASA, na Virgínia. Esta informação sugere uma complexidade no cronograma ou pode indicar uma fase futura do programa de serviço em órbita, ou até mesmo um lançamento de teste para os veículos envolvidos. A coexistência dessas datas no material fornecido destaca a natureza multifacetada e de longo prazo dos projetos de exploração espacial, onde diferentes componentes e fases podem ter cronogramas distintos.</p>",
    "body_en": "<p>5 min read Partners, NASA Ready for June Launch of Swift Boost Mission NASA is on a mission to lift its Neil Gehrels Swift Observatory along with partners Katalyst Space and Northrop Grumman. The institutional report frames the development in practical terms and ties it to the broader mission or observing effort.</p><p>That matters because astronomy does not advance on single detections. The field builds confidence by accumulating independent observations across different wavelengths, instruments and epochs until isolated signals become defensible conclusions. What looks convincing in one dataset can dissolve when a second instrument looks at the same target, and what looks marginal can solidify when follow-up campaigns confirm the original reading. The current standard requires that a result survive this triangulation before the community treats it as settled. A mission to raise the orbit of NASA’s Swift observatory is poised for launch June 30. For the last two decades, Swift has been a key player in NASA’s efforts to understand how the universe works, and we’re looking forward to getting back to that work after the.</p><p>That means deploying robotic spacecraft that can reposition, repair, refuel, and refit satellites after launch. NASA/Sophia Roberts The LINK spacecraft weighs about 880 pounds and stands about 5 feet tall, about a third of Swift’s overall size.</p><p>Stargazer, Pegasus XL, and LINK await takeoff on Wednesday, June 17, 2026, at NASA’s Wallops Flight Facility in Virginia. Article NASA is on a mission to lift its Neil Gehrels Swift Observatory along with partners Katalyst Space and Northrop Grumman.</p><p>NASA’s Goddard Space Flight Center/Katalyst Space/Northrop Grumman A mission to raise the orbit of NASA’s Neil Gehrels Swift Observatory is poised for launch no earlier than. LINK will rendezvous with, grapple, and slowly raise Swift’s altitude over several months, preventing it from re-entering Earth’s atmosphere later this year.</p><p>What gives the story weight is not just the object itself, but the way the measurement trims the range of plausible physical explanations. Astronomy has accumulated enough cases to know that the most interesting results are rarely the ones that confirm expectations cleanly; they are the ones that confirm some expectations while complicating others, or that open a parameter space that previous instruments could not reach. The scientific community evaluates these contributions by asking whether the new data constrain a model in a way that older data could not, and whether those constraints survive systematic review.</p><p>LINK completed environmental testing that mimicked launch and space-like conditions at NASA Goddard this spring, as well as additional preflight assessments at Katalyst’s facility. We can deploy Pegasus from almost anywhere in the world using our Stargazer, a modified L-1011 aircraft,” said Wes Collier, vice president of launch systems at Northrop Grumman.</p><p>Because the account originates with NASA News Releases, it functions best as a primary institutional report that is close to the data and operations, not as independent scientific validation. Institutional communications are produced by organizations with legitimate interests in presenting their work in a favorable light, which does not make them unreliable but does make them partial. Details that complicate the narrative, including instrument limitations, unexpected failures and results below projections, tend to be minimized relative to progress messages. Technical documentation and peer-reviewed publications, where they exist, provide the complementary layer that institutional releases cannot substitute.</p><p>The next step is to see whether other instruments and other wavelengths tell the same story. Campaigns with JWST, the VLT, the forthcoming Extremely Large Telescopes and radio arrays will provide the spectral coverage and spatial resolution needed to move from detection to physical characterization. The timeline for that kind of confirmation is typically measured in years, not months, which is worth keeping in mind when reading the current result.</p><p class=\"art-source\"><a href=\"https://science.nasa.gov/missions/swift/swift-boost-mission/partners-nasa-ready-for-june-launch-of-swift-boost-mission/\" target=\"_blank\" rel=\"noopener noreferrer\">Source</a></p>",
    "highlights": [
      "Ponto central: A NASA e seus parceiros, Katalyst Space e Northrop Grumman, estão se preparando para a missão de elevação orbital do Observatório Neil Gehrels Swift.",
      "Dado-chave: A NASA e seus parceiros, Katalyst Space e Northrop Grumman, estão se preparando para a missão de elevação orbital do Observatório Neil Gehrels.",
    ...
    "highlights_en": [
      ...
      "Key detail: 5 min read Partners, NASA Ready for June Launch of Swift Boost Mission NASA is on a mission to lift its Neil Gehrels Swift Observatory along with",
    ...
    "lastModifiedIso": "2026-06-27T16:45:42+00:00",
    "source": "NASA News Releases",
    ...
    "realUrl": "https://www.cosmosweek.com/?article=partners-nasa-ready-for-june-launch-of-swift-boost-mission",
    "realUrl_pt": "https://www.cosmosweek.com/?article=partners-nasa-ready-for-june-launch-of-swift-boost-mission",
    "realUrl_en": "https://www.cosmosweek.com/?article=partners-nasa-ready-for-june-launch-of-swift-boost-mission&lang=en",
    "shareUrl": "https://www.cosmosweek.com/noticia/partners-nasa-ready-for-june-launch-of-swift-boost-mission/",
    "shareUrl_pt": "https://www.cosmosweek.com/noticia/partners-nasa-ready-for-june-launch-of-swift-boost-mission/",
    "shareUrl_en": "https://www.cosmosweek.com/en/news/partners-nasa-ready-for-june-launch-of-swift-boost-mission/",
    "canonicalUrl": "https://www.cosmosweek.com/noticia/partners-nasa-ready-for-june-launch-of-swift-boost-mission/",
    "canonicalUrl_pt": "https://www.cosmosweek.com/noticia/partners-nasa-ready-for-june-launch-of-swift-boost-mission/",
    "canonicalUrl_en": "https://www.cosmosweek.com/en/news/partners-nasa-ready-for-june-launch-of-swift-boost-mission/",
    "defaultLanguage": "pt-BR",
    "availableLanguages": [
      "pt-BR",
      "en-US"
    ...
    "imageAlt": "NASA e Parceiros Se Preparam para a Missão de Elevação Orbital do Observatório Swift em Junho",
    "imageAlt_pt": "NASA e Parceiros Se Preparam para a Missão de Elevação Orbital do Observatório Swift em Junho",
    "imageAlt_en": "Partners, NASA Ready for June Launch of Swift Boost Mission",
    "coverageKind": "agency",
    "coverageKindLabel": "Fonte institucional",
    "coverageKindLabel_pt": "Fonte institucional",
    "coverageKindLabel_en": "Institutional source",
  ...
  },
  {
    ...
    "sub": "A NASA selecionou 41 propostas de 37 empresas para desenvolver tecnologias que apoiarão seus objetivos de estabelecer uma presença de longo prazo na Lua e possibilitar a.",
    "sub_pt": "A NASA selecionou 41 propostas de 37 empresas para desenvolver tecnologias que apoiarão seus objetivos de estabelecer uma presença de longo prazo na Lua e possibilitar a.",
    ...
    "excerpt": "A NASA selecionou 41 propostas de 37 empresas para desenvolver tecnologias que apoiarão seus objetivos de estabelecer uma presença de longo prazo na Lua e possibilitar a exploração humana de Marte.",
    "excerpt_pt": "A NASA selecionou 41 propostas de 37 empresas para desenvolver tecnologias que apoiarão seus objetivos de estabelecer uma presença de longo prazo na Lua e possibilitar a exploração humana de Marte.",
    "excerpt_en": "NASA selected 41 proposals from 37 companies to advance technologies in support of the agency’s goals to establish a long-term presence on the Moon and enable human exploration of Mars.",
    "body": "<p>A NASA selecionou 41 propostas de 37 empresas americanas para o desenvolvimento de tecnologias cruciais que apoiarão os ambiciosos objetivos da agência: estabelecer uma presença de longo prazo na Lua e viabilizar a exploração humana de Marte. Essas empresas, escolhidas no Anúncio de Oportunidade de Colaboração (ACO) de 2025 da NASA, focarão no amadurecimento de soluções inovadoras para transporte espacial, operações de superfície planetária e lunar, e infraestrutura de superfície lunar. A iniciativa visa impulsionar a capacidade tecnológica dos Estados Unidos, preparando o terreno para futuras missões governamentais e expandindo o mercado comercial no setor espacial.</p><p>Greg Stover, diretor da Divisão de Pesquisa Avançada e Tecnologia da Diretoria de Missão de Pesquisa e Tecnologia da NASA em Washington, enfatizou a importância dessa parceria. Ele afirmou: &quot;Estamos capacitando a indústria americana para se tornar parceira ativa nas missões da NASA à Lua, Marte e além&quot;. Essa colaboração estratégica permite que as empresas aproveitem as instalações especializadas, softwares, hardwares e o conhecimento de especialistas da NASA. Tal acesso é fundamental para acelerar o desenvolvimento e o amadurecimento de suas tecnologias, beneficiando tanto os mercados comerciais quanto as futuras necessidades de missões governamentais.</p><p>Desde o lançamento do primeiro Anúncio de Oportunidade de Colaboração em 2015, a NASA tem apoiado mais de 110 projetos, demonstrando um compromisso contínuo com a inovação e a parceria com o setor privado. As tecnologias selecionadas abrangem uma vasta gama de aplicações, desde sistemas avançados de propulsão e robótica para exploração, até soluções para habitats sustentáveis e gerenciamento de recursos no espaço. O foco é criar capacidades que não apenas permitam a sobrevivência e o trabalho em ambientes extraterrestres, mas que também otimizem a eficiência e a segurança das operações espaciais.</p><p>O valor total estimado dos recursos da agência para apoiar esses acordos de colaboração é de aproximadamente US$ 30 milhões. Este investimento significativo da NASA é alavancado por um adicional de US$ 32 milhões em contribuições da própria indústria, totalizando um esforço conjunto de mais de US$ 60 milhões. Essa estrutura de financiamento demonstra o engajamento e o interesse mútuo entre a agência espacial e as empresas privadas no avanço da exploração espacial. O prazo de execução para cada contrato será negociado individualmente, com uma duração prevista que varia de 12 a 24 meses, permitindo flexibilidade para o desenvolvimento tecnológico.</p><p>Entre as inovações esperadas, destacam-se tecnologias para materiais e componentes que possam suportar as condições extremas do espaço. Por exemplo, o desenvolvimento de coberturas duráveis é crucial para proteger equipamentos como rovers, juntas robóticas, mangueiras e outros dispositivos articulados. A resistência a temperaturas extremas, radiação e poeira lunar ou marciana é essencial para garantir a longevidade e a funcionalidade desses equipamentos em operações de longo prazo na Lua e em Marte. Tais avanços são vitais para a sustentabilidade das futuras bases e missões de exploração.</p><p>A colaboração entre a NASA e a indústria privada é um pilar fundamental para o sucesso das futuras missões espaciais. Ao fomentar o desenvolvimento de tecnologias de ponta, a agência não apenas avança em seus próprios objetivos de exploração, mas também estimula a inovação no setor comercial, criando novas oportunidades e mercados. Este modelo de parceria garante que os Estados Unidos permaneçam na vanguarda da exploração espacial, impulsionando descobertas científicas e benefícios tecnológicos que podem ter aplicações significativas tanto no espaço quanto na Terra.</p>",
    "body_pt": "<p>A NASA selecionou 41 propostas de 37 empresas americanas para o desenvolvimento de tecnologias cruciais que apoiarão os ambiciosos objetivos da agência: estabelecer uma presença de longo prazo na Lua e viabilizar a exploração humana de Marte. Essas empresas, escolhidas no Anúncio de Oportunidade de Colaboração (ACO) de 2025 da NASA, focarão no amadurecimento de soluções inovadoras para transporte espacial, operações de superfície planetária e lunar, e infraestrutura de superfície lunar. A iniciativa visa impulsionar a capacidade tecnológica dos Estados Unidos, preparando o terreno para futuras missões governamentais e expandindo o mercado comercial no setor espacial.</p><p>Greg Stover, diretor da Divisão de Pesquisa Avançada e Tecnologia da Diretoria de Missão de Pesquisa e Tecnologia da NASA em Washington, enfatizou a importância dessa parceria. Ele afirmou: &quot;Estamos capacitando a indústria americana para se tornar parceira ativa nas missões da NASA à Lua, Marte e além&quot;. Essa colaboração estratégica permite que as empresas aproveitem as instalações especializadas, softwares, hardwares e o conhecimento de especialistas da NASA. Tal acesso é fundamental para acelerar o desenvolvimento e o amadurecimento de suas tecnologias, beneficiando tanto os mercados comerciais quanto as futuras necessidades de missões governamentais.</p><p>Desde o lançamento do primeiro Anúncio de Oportunidade de Colaboração em 2015, a NASA tem apoiado mais de 110 projetos, demonstrando um compromisso contínuo com a inovação e a parceria com o setor privado. As tecnologias selecionadas abrangem uma vasta gama de aplicações, desde sistemas avançados de propulsão e robótica para exploração, até soluções para habitats sustentáveis e gerenciamento de recursos no espaço. O foco é criar capacidades que não apenas permitam a sobrevivência e o trabalho em ambientes extraterrestres, mas que também otimizem a eficiência e a segurança das operações espaciais.</p><p>O valor total estimado dos recursos da agência para apoiar esses acordos de colaboração é de aproximadamente US$ 30 milhões. Este investimento significativo da NASA é alavancado por um adicional de US$ 32 milhões em contribuições da própria indústria, totalizando um esforço conjunto de mais de US$ 60 milhões. Essa estrutura de financiamento demonstra o engajamento e o interesse mútuo entre a agência espacial e as empresas privadas no avanço da exploração espacial. O prazo de execução para cada contrato será negociado individualmente, com uma duração prevista que varia de 12 a 24 meses, permitindo flexibilidade para o desenvolvimento tecnológico.</p><p>Entre as inovações esperadas, destacam-se tecnologias para materiais e componentes que possam suportar as condições extremas do espaço. Por exemplo, o desenvolvimento de coberturas duráveis é crucial para proteger equipamentos como rovers, juntas robóticas, mangueiras e outros dispositivos articulados. A resistência a temperaturas extremas, radiação e poeira lunar ou marciana é essencial para garantir a longevidade e a funcionalidade desses equipamentos em operações de longo prazo na Lua e em Marte. Tais avanços são vitais para a sustentabilidade das futuras bases e missões de exploração.</p><p>A colaboração entre a NASA e a indústria privada é um pilar fundamental para o sucesso das futuras missões espaciais. Ao fomentar o desenvolvimento de tecnologias de ponta, a agência não apenas avança em seus próprios objetivos de exploração, mas também estimula a inovação no setor comercial, criando novas oportunidades e mercados. Este modelo de parceria garante que os Estados Unidos permaneçam na vanguarda da exploração espacial, impulsionando descobertas científicas e benefícios tecnológicos que podem ter aplicações significativas tanto no espaço quanto na Terra.</p>",
    "body_en": "<p>NASA selected 41 proposals from 37 companies to advance technologies in support of the agency’s goals to establish a long-term presence on the Moon and enable human exploration of Mars. The institutional report frames the development in practical terms and ties it to the broader mission or observing effort.</p><p>This matters because astronomy does not advance on single detections. The field builds confidence by accumulating independent observations across different wavelengths, instruments and epochs until isolated signals become defensible conclusions. What looks convincing in one dataset can dissolve when a second instrument looks at the same target, and what looks marginal can solidify when follow-up campaigns confirm the original reading. The current standard requires that a result survive this triangulation before the community treats it as settled. These American companies, picked from NASA’s 2025 Announcement of Collaboration Opportunity (ACO), will mature technologies creating solutions for space transportation, planetary. NASA NASA selected 41 proposals from 37 companies to advance technologies in support of the agency’s goals to establish a long-term presence on the Moon and enable human.</p><p>RELEASE 26-042 NASA Headquarters Credit: NASA NASA selected 41 proposals from 37 companies to advance technologies in support of the agency’s goals to establish a long-term. We are empowering American industry to become active partners in NASA’s missions to the Moon, Mars, and beyond,” said Greg Stover, director, Advanced Research and Technology.</p><p>Through this opportunity, companies leverage NASA’s specialized facilities, software, hardware, and subject matter experts, allowing them to rapidly mature their technologies for. Since launching the first ACO in 2015, NASA has supported more than 110 projects.</p><p>The total estimated value of agency resources to support the agreements is approximately $30 million, which leverages an additional $32 million of industry contributions. The period of performance will be negotiated for each agreement, with an expected duration of 12 to 24 months.</p><p>What gives the story weight is not just the object itself, but the way the measurement trims the range of plausible physical explanations. Astronomy has accumulated enough cases to know that the most interesting results are rarely the ones that confirm expectations cleanly; they are the ones that confirm some expectations while complicating others, or that open a parameter space that previous instruments could not reach. The scientific community evaluates these contributions by asking whether the new data constrain a model in a way that older data could not, and whether those constraints survive systematic review.</p><p>These durable covers could be used on rovers, robotic joints, hoses, and other articulated equipment to support long-term operations on the Moon and Mars. Organizations interested in developing space technology with NASA can explore opportunities online.</p><p>Because the account originates with NASA News Releases, it functions best as a primary institutional report that is close to the data and operations, not as independent scientific validation. Institutional communications are produced by organizations with legitimate interests in presenting their work in a favorable light, which does not make them unreliable but does make them partial. Details that complicate the narrative, including instrument limitations, unexpected failures and results below projections, tend to be minimized relative to progress messages. Technical documentation and peer-reviewed publications, where they exist, provide the complementary layer that institutional releases cannot substitute.</p><p>The next step is to see whether other instruments and other wavelengths tell the same story. Campaigns with JWST, the VLT, the forthcoming Extremely Large Telescopes and radio arrays will provide the spectral coverage and spatial resolution needed to move from detection to physical characterization. The timeline for that kind of confirmation is typically measured in years, not months, which is worth keeping in mind when reading the current result.</p><p class=\"art-source\"><a href=\"https://www.nasa.gov/news-release/nasa-identifies-more-than-40-space-technologies-for-collaboration/\" target=\"_blank\" rel=\"noopener noreferrer\">Source</a></p>",
    "highlights": [
      "Ponto central: A NASA selecionou 41 propostas de 37 empresas para desenvolver tecnologias que apoiarão seus objetivos de estabelecer uma presença de longo prazo na.",
      "Dado-chave: A NASA selecionou 41 propostas de 37 empresas para desenvolver tecnologias que apoiarão seus objetivos de estabelecer uma presença de longo.",
      "Origem institucional: distinguir anúncio de evidência."
    ],
    "highlights_pt": [
      "Ponto central: A NASA selecionou 41 propostas de 37 empresas para desenvolver tecnologias que apoiarão seus objetivos de estabelecer uma presença de longo prazo na.",
    ...
    "realUrl": "https://www.cosmosweek.com/?article=nasa-identifies-more-than-40-space-technologies-for-collaboration",
    "realUrl_pt": "https://www.cosmosweek.com/?article=nasa-identifies-more-than-40-space-technologies-for-collaboration",
    "realUrl_en": "https://www.cosmosweek.com/?article=nasa-identifies-more-than-40-space-technologies-for-collaboration&lang=en",
    "shareUrl": "https://www.cosmosweek.com/noticia/nasa-identifies-more-than-40-space-technologies-for-collaboration/",
    "shareUrl_pt": "https://www.cosmosweek.com/noticia/nasa-identifies-more-than-40-space-technologies-for-collaboration/",
    "shareUrl_en": "https://www.cosmosweek.com/en/news/nasa-identifies-more-than-40-space-technologies-for-collaboration/",
    "canonicalUrl": "https://www.cosmosweek.com/noticia/nasa-identifies-more-than-40-space-technologies-for-collaboration/",
    "canonicalUrl_pt": "https://www.cosmosweek.com/noticia/nasa-identifies-more-than-40-space-technologies-for-collaboration/",
    "canonicalUrl_en": "https://www.cosmosweek.com/en/news/nasa-identifies-more-than-40-space-technologies-for-collaboration/",
    "defaultLanguage": "pt-BR",
    "availableLanguages": [
      "pt-BR",
      "en-US"
    ...
    "imageAlt": "NASA identifica mais de 40 tecnologias espaciais para colaboração",
    "imageAlt_pt": "NASA identifica mais de 40 tecnologias espaciais para colaboração",
    "imageAlt_en": "NASA Identifies More Than 40 Space Technologies for Collaboration",
    "coverageKind": "agency",
    "coverageKindLabel": "Fonte institucional",
    "coverageKindLabel_pt": "Fonte institucional",
    "coverageKindLabel_en": "Institutional source",
  ...
  },
  {
    ...
    "highlights": [
      ...
      "Dado-chave: O satélite EarthCARE da Agência Espacial Europeia foi desenvolvido para realizar um conjunto único de medições simultâneas, que lançam uma nova.",
      "Origem institucional: distinguir anúncio de evidência."
    ],
    "highlights_pt": [
      "Ponto central: O satélite EarthCARE da Agência Espacial Europeia foi desenvolvido para realizar um conjunto único de medições simultâneas, que lançam uma nova luz.",
    ...
    "highlights_en": [
      ...
      "Key detail: The European Space Agency’s EarthCARE satellite was developed to make a unique set of simultaneous measurements that shed new light on the role.",
      "Institutional origin: separate announcement from evidence."
    ],
    "date": "25 jun 2026",
    "date_pt": "25 jun 2026",
  ...
  },
  {
    ...
    "highlights": [
      "Ponto central: O Observatório SKA possibilitará medições da relação Tully-Fisher para amostras estatísticas de galáxias selecionadas pelo hidrogênio neutro (HI) em.",
      "Dado-chave: O Observatório SKA possibilitará medições da relação Tully-Fisher para amostras estatísticas de galáxias selecionadas pelo hidrogênio neutro.",
    ...
    "highlights_en": [
      "Core point: The SKA Observatory will enable measurements of the Tully-Fisher relation for statistical samples of HI selected galaxies out to unprecedented depths.",
      "Key detail: The SKA Observatory will enable measurements of the Tully-Fisher relation for statistical samples of HI selected galaxies out to unprecedented.",
