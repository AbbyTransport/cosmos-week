...
window.postsData = [
  ...
  },
  {
    ...
    "highlights": [
      "Em foco: Os cientistas da missão MAVEN da NASA descobriram uma peça chave do quebra-cabeça para a compreensão de certos tipos de auroras em Marte, descobrindo",
      "Detalhe: Origem institucional: distinguir anúncio de evidência",
      "Leitura editorial: release institucional, útil como fonte primária, mas não como validação independente."
    ],
    "highlights_pt": [
    ...
    "highlights_en": [
      "Focus: NASA MAVEN mission scientists have uncovered a key puzzle piece in understanding certain types of auroras on Mars, finding that they form in a",
      "Detail: Institutional origin: separate announcement from evidence",
      "Editorial reading: institutional release, useful as a primary source but not independent validation."
    ],
    "date": "23 jul 2026",
  ...
  },
  {
    ...
    "highlights": [
      "Em foco: Os setores ocultos são uma previsão genérica das compactações da teoria das cordas e resultam em um cenário promissor para a construção de modelos de",
    ...
    "highlights_en": [
      "Focus: Hidden sectors are a generic prediction of string theory compactifications and result in a promising landscape for dark matter model building",
  ...
  },
  {
    ...
    "highlights": [
      "Em foco: As observações do Telescópio Espacial James Webb revelam uma população de objetos com alto desvio para o vermelho, os pequenos pontos vermelhos",
      "Detalhe: Resultado ainda sem revisão por pares",
      "Leitura editorial: resultado provisório, ainda sem revisão por pares formal."
    ],
    "highlights_pt": [
