...
window.postsData = [
  ...
  },
  {
    ...
    "excerpt": "O código modernizado preserva a compatibilidade retroativa com fluxos de trabalho de entrada CEA legados, ao mesmo tempo que permite o uso direto de ambientes de análise modernos, incluindo Python, C, MATLAB e estudos.",
    "excerpt_pt": "O código modernizado preserva a compatibilidade retroativa com fluxos de trabalho de entrada CEA legados, ao mesmo tempo que permite o uso direto de ambientes de análise modernos, incluindo Python, C, MATLAB e estudos.",
    ...
    "body": "<p>Líder, Glenn Research Center, mark. Gov Baixe a versão em PDF O código Chemical Equilibrium with Applications da NASA é uma ferramenta fundamental para análise de sistemas de propulsão.</p><p>Líder, Glenn Research Center, mark. leader@nasa. gov Baixe a versão em PDF O código de Equilíbrio Químico com Aplicações (CEA) da NASA é uma ferramenta fundamental para análise de sistemas de propulsão. Orientação para uso de engenharia Os usuários de engenharia da NASA devem considerar a seguinte orientação: Use o CEA v3 para novas análises de propulsão e termoquímica quando possível para aproveitar as interfaces modernizadas, o banco de dados expandido e a integração.</p><p>Líder, Glenn Research Center, mark. leader@nasa. gov O código Chemical Equilibrium with Applications (CEA) da NASA é uma ferramenta fundamental para análise de sistemas de propulsão. A atividade TI-22-01730 do Centro de Engenharia e Segurança da NASA (NESC) modernizou o código legado CEA2 Fortran em CEA v3, um pacote de software orientado a objetos Fortran 2008 com suporte de interface expandido, dados termoquímicos atualizados, capacidade de manutenção.</p><p>O código modernizado preserva a compatibilidade retroativa com fluxos de trabalho de entrada CEA legados, ao mesmo tempo que permite o uso direto de ambientes de análise modernos, incluindo Python, C, MATLAB e estudos de design automatizados. Antecedentes O CEA2 foi lançado em 2002 e permaneceu amplamente utilizado para propulsão e análise termoquímica.</p><p>Melhorias técnicas Arquitetura de software moderna CEA v3 é implementado em Fortran 2008 usando estruturas de dados orientadas a objetos, tipagem mais rigorosa e uma arquitetura de solução de equilíbrio segura para threads. Em um benchmark, uma varredura de 108.500 casos foi concluída em aproximadamente 1, 11 segundos com o CEA v3, em comparação com aproximadamente 15 minutos usando o CEA2.</p><p class=\"art-source\"><a href=\"https://www.nasa.gov/centers-and-facilities/nesc/tb-26-04-updates-and-modernization-of-nasas-chemical-equilibrium-with-applications-cea-code/\" target=\"_blank\" rel=\"noopener noreferrer\">Fonte</a></p>",
    ...
    "imageAlt": "TB 26-04 Atualizações e Modernização do Código de Equilíbrio Químico com Aplicações (CEA) da NASA",
    "imageAlt_pt": "TB 26-04 Atualizações e Modernização do Código de Equilíbrio Químico com Aplicações (CEA) da NASA",
  ...
  },
  {
    ...
    "highlights": [
      ...
      "Dado-chave: O astronauta da NASA L. Gordon Cooper Jr. tirou 29 fotografias coloridas da Terra com uma câmera de 70 mm enquanto orbitava nosso planeta.",
    ...
    "highlights_en": [
      ...
      "Key detail: NASA astronaut L. Gordon Cooper, Jr. took 29 color photographs of the Earth with a 70mm camera as he orbited our planet during the Mercury-Atlas.",
  ...
  },
  {
    ...
    "lastModifiedIso": "2026-08-19T16:01:37+00:00",
