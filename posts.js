...
window.postsData = [
  ...
  {
    "id": 2,
    "slug": "imprint-of-swampland-inspired-coupled-early-dark-energy",
    "cat": "Cosmologia",
    "catCls": "cosmologia",
    ...
    "video": null,
    "audio": null,
    "title": "Impressão da energia escura inicial acoplada inspirada nos pântanos",
    "title_pt": "Impressão da energia escura inicial acoplada inspirada nos pântanos",
    "title_en": "Imprint of swampland-inspired coupled early dark energy",
    "sub": "Inspirados na Conjectura da Distância do Pântano, investigamos as implicações cosmológicas de um acoplamento fracionário entre a matéria escura e a energia escura inicial à luz.",
    "sub_pt": "Inspirados na Conjectura da Distância do Pântano, investigamos as implicações cosmológicas de um acoplamento fracionário entre a matéria escura e a energia escura inicial à luz.",
    "sub_en": "Inspired by the Swampland Distance Conjecture, we investigate the cosmological implications of a fractional coupling between dark matter and early dark energy in light of the.",
    "excerpt": "Inspirados na Conjectura da Distância do Pântano, investigamos as implicações cosmológicas de um acoplamento fracionário entre a matéria escura e a energia escura inicial à luz dos dados recentes do DESI DR2 BAO.",
    "excerpt_pt": "Inspirados na Conjectura da Distância do Pântano, investigamos as implicações cosmológicas de um acoplamento fracionário entre a matéria escura e a energia escura inicial à luz dos dados recentes do DESI DR2 BAO.",
    "excerpt_en": "Inspired by the Swampland Distance Conjecture, we investigate the cosmological implications of a fractional coupling between dark matter and early dark energy in light of the recent DESI DR2 BAO data.",
    "body": "<p>Inspirados na Conjectura da Distância do Pântano, investigamos as implicações cosmológicas de um acoplamento fracionário entre a matéria escura e a energia escura inicial à luz dos dados recentes do DESI DR2 BAO. Inspirados na Conjectura da Distância do Pântano, investigamos as implicações cosmológicas de um acoplamento fracionário entre a matéria escura (DM) e a energia escura inicial (EDE) à luz dos dados recentes do DESI DR2 BAO.</p><p>Tanto indivíduos como organizações que trabalham com arXivLabs abraçaram e aceitaram nossos valores de abertura, comunidade, excelência e privacidade dos dados do usuário. ArXiv está comprometido com esses valores e só trabalha com parceiros que os aderem.</p><p>Tem uma ideia de um projeto que agregue valor à comunidade arXiv? . Saiba mais sobre o arXivLabs.</p><p>Resumo: Inspirados na Conjectura da Distância do Pântano, investigamos as implicações cosmológicas de um acoplamento fracionário entre a matéria escura (DM) e a energia escura inicial (EDE) à luz dos dados recentes do DESI DR2 BAO. Usamos uma rede de fluxo de normalização condicional para amostrar com eficiência o espaço de parâmetros de alta dimensão e realizar uma análise conjunta dos dados do Planck CMB, DESI DR2 BAO, supernovas PantheonPlus e SH0ES.</p><p>Descobrimos que a construção detalhada do potencial EDE além da mera existência de um componente EDE possivelmente altera as restrições cosmológicas na energia escura tardia quando o acoplamento entre DM e EDE é considerado.</p><p class=\"art-source\"><a href=\"https://arxiv.org/abs/2607.06147v1\" target=\"_blank\" rel=\"noopener noreferrer\">Fonte</a></p>",
    "body_pt": "<p>Inspirados na Conjectura da Distância do Pântano, investigamos as implicações cosmológicas de um acoplamento fracionário entre a matéria escura e a energia escura inicial à luz dos dados recentes do DESI DR2 BAO. Inspirados na Conjectura da Distância do Pântano, investigamos as implicações cosmológicas de um acoplamento fracionário entre a matéria escura (DM) e a energia escura inicial (EDE) à luz dos dados recentes do DESI DR2 BAO.</p><p>Tanto indivíduos como organizações que trabalham com arXivLabs abraçaram e aceitaram nossos valores de abertura, comunidade, excelência e privacidade dos dados do usuário. ArXiv está comprometido com esses valores e só trabalha com parceiros que os aderem.</p><p>Tem uma ideia de um projeto que agregue valor à comunidade arXiv? . Saiba mais sobre o arXivLabs.</p><p>Resumo: Inspirados na Conjectura da Distância do Pântano, investigamos as implicações cosmológicas de um acoplamento fracionário entre a matéria escura (DM) e a energia escura inicial (EDE) à luz dos dados recentes do DESI DR2 BAO. Usamos uma rede de fluxo de normalização condicional para amostrar com eficiência o espaço de parâmetros de alta dimensão e realizar uma análise conjunta dos dados do Planck CMB, DESI DR2 BAO, supernovas PantheonPlus e SH0ES.</p><p>Descobrimos que a construção detalhada do potencial EDE além da mera existência de um componente EDE possivelmente altera as restrições cosmológicas na energia escura tardia quando o acoplamento entre DM e EDE é considerado.</p><p class=\"art-source\"><a href=\"https://arxiv.org/abs/2607.06147v1\" target=\"_blank\" rel=\"noopener noreferrer\">Fonte</a></p>",
    "body_en": "<p>Inspired by the Swampland Distance Conjecture, we investigate the cosmological implications of a fractional coupling between dark matter and early dark energy in light of the recent DESI DR2 BAO data. The new analysis still awaits peer review, but it already lays out the central claim clearly.</p><p>That matters because cosmology operates at the edge of what current instruments can measure, where systematic errors and model assumptions are never trivial. Small discrepancies between independent measurements have historically pointed toward missing physics rather than simple calibration errors, and the ongoing tension in the Hubble constant is a live example of how a persistent disagreement between methods can reshape the theoretical landscape. Each new dataset that approaches this territory with independent systematics adds real information to a problem that has resisted easy resolution for more than a decade. Inspired by the Swampland Distance Conjecture, we investigate the cosmological implications of a fractional coupling between dark matter (DM) and early dark energy (EDE) in light. Both individuals and organizations that work with arXivLabs have embraced and accepted our values of openness, community, excellence, and user data privacy.</p><p>ArXiv is committed to these values and only works with partners that adhere to them. Have an idea for a project that will add value for arXiv&#x27;s community.</p><p>We use a conditional normalizing flow network to efficiently sample the high-dimensional parameter space, and perform a joint analysis of Planck CMB data, DESI DR2 BAO. We find that the detailed construction of the EDE potential beyond the mere existence of an EDE component possibly alter cosmological constraints on late-time dark energy when the.</p><p>The relevance goes beyond one dataset because even small shifts in measured parameters can matter when the field is testing the limits of the standard cosmological model. The Lambda-CDM framework describes the observable universe with remarkable economy, but its success rests on two components, dark matter and dark energy, whose physical nature remains entirely unknown. Any credible measurement that tightens or loosens the constraints on those components moves the entire theoretical enterprise forward, regardless of whether the immediate result looks dramatic on its own terms.</p><p>Because this is still a preprint, the result should be read with genuine interest and proportionate caution. Peer review is not a guarantee of correctness, but it is a process that forces authors to respond to technical criticism from specialists who have no stake in a particular outcome. Preprints that survive that process, often with substantive revisions, emerge with a stronger evidential base than the version that first appeared. Until that stage is complete, the responsible reading keeps uncertainty explicitly visible rather than treating the claims as established findings.</p><p>The next step is to see whether the effect survives when independent surveys, different calibration strategies and tighter control of systematic uncertainties enter the picture. Programmes such as Euclid, DESI and the Rubin Observatory will deliver datasets over the next several years that cover the same parameter space with largely independent methods. If the current signal persists through those tests, its theoretical implications will become impossible to set aside. Until peer review and independent follow-up address those open questions, skepticism is not a failure of appreciation for the work; it is part of how science decides what to keep.</p><p class=\"art-source\"><a href=\"https://arxiv.org/abs/2607.06147v1\" target=\"_blank\" rel=\"noopener noreferrer\">Source</a></p>",
    "highlights": [
      "Em foco: Inspirados na Conjectura da Distância do Pântano, investigamos as implicações cosmológicas de um acoplamento fracionário entre a matéria escura e a",
    ...
    "highlights_en": [
      "Focus: Inspired by the Swampland Distance Conjecture, we investigate the cosmological implications of a fractional coupling between dark matter and early",
    ...
    "read_pt": "4 min de leitura",
    "read_en": "4 min read",
    "publishedIso": "2026-07-07T11:15:39+00:00",
    "lastModifiedIso": "2026-07-08T17:16:19+00:00",
    ...
    "keywords": [
      ...
      "arXiv Cosmology",
      "Cosmos Week",
      "Impressão da energia escura inicial acoplada inspirada nos pântanos"
    ],
    "keywords_pt": [
      "Cosmologia",
      "arXiv Cosmology",
    ...
    "keywords_en": [
      ...
      "arXiv Cosmology",
      "Cosmos Week",
      "Swamp-Inspired Early Coupled Dark Energy Print"
    ],
    "srcUrl": "https://arxiv.org/abs/2607.06147v1",
    "realUrl": "https://www.cosmosweek.com/?article=imprint-of-swampland-inspired-coupled-early-dark-energy",
    "realUrl_pt": "https://www.cosmosweek.com/?article=imprint-of-swampland-inspired-coupled-early-dark-energy",
    "realUrl_en": "https://www.cosmosweek.com/?article=imprint-of-swampland-inspired-coupled-early-dark-energy&lang=en",
    "shareUrl": "https://www.cosmosweek.com/noticia/imprint-of-swampland-inspired-coupled-early-dark-energy/",
    "shareUrl_pt": "https://www.cosmosweek.com/noticia/imprint-of-swampland-inspired-coupled-early-dark-energy/",
    "shareUrl_en": "https://www.cosmosweek.com/en/news/imprint-of-swampland-inspired-coupled-early-dark-energy/",
    "canonicalUrl": "https://www.cosmosweek.com/noticia/imprint-of-swampland-inspired-coupled-early-dark-energy/",
    "canonicalUrl_pt": "https://www.cosmosweek.com/noticia/imprint-of-swampland-inspired-coupled-early-dark-energy/",
    "canonicalUrl_en": "https://www.cosmosweek.com/en/news/imprint-of-swampland-inspired-coupled-early-dark-energy/",
    "defaultLanguage": "pt-BR",
    "availableLanguages": [
      "pt-BR",
      "en-US"
    ...
    "imageAlt": "Impressão da energia escura inicial acoplada inspirada nos pântanos",
    "imageAlt_pt": "Impressão da energia escura inicial acoplada inspirada nos pântanos",
    "imageAlt_en": "Imprint of swampland-inspired coupled early dark energy",
  ...
  {
    "id": 3,
    "slug": "a-possible-triple-formation-scenario-of-binary-black-hole-merge-with-one-in-pair-instability-sup",
    "cat": "Astrofísica",
    "catCls": "astrofisica",
    ...
    "video": null,
    "audio": null,
    "title": "Um possível cenário de formação tripla de fusão de buraco negro binário com uma lacuna de massa de supernova com instabilidade de par",
    "title_pt": "Um possível cenário de formação tripla de fusão de buraco negro binário com uma lacuna de massa de supernova com instabilidade de par",
    "title_en": "A Possible Triple Formation Scenario of Binary Black Hole Merge With One In Pair-instability Supernova Mass Gap",
    "sub": "Observações de fusões de buracos negros binários detectadas pelo LIGO, como GW170729, GW190620, GW190706, GW230107, GW230820 e GW230928, apresentam rotações altamente efetivas e.",
    "sub_pt": "Observações de fusões de buracos negros binários detectadas pelo LIGO, como GW170729, GW190620, GW190706, GW230107, GW230820 e GW230928, apresentam rotações altamente efetivas e.",
    "sub_en": "Observations of binary black hole mergers detected by LIGO -- such as GW170729, GW190620, GW190706, GW230107, GW230820, and GW230928 -- feature high effective spins and primary.",
    "excerpt": "Observações de fusões de buracos negros binários detectadas pelo LIGO, como GW170729, GW190620, GW190706, GW230107, GW230820 e GW230928, apresentam rotações altamente efetivas e buracos negros primários que caem diretamente na instabilidade do par.",
    "excerpt_pt": "Observações de fusões de buracos negros binários detectadas pelo LIGO, como GW170729, GW190620, GW190706, GW230107, GW230820 e GW230928, apresentam rotações altamente efetivas e buracos negros primários que caem diretamente na instabilidade do par.",
    "excerpt_en": "Observations of binary black hole mergers detected by LIGO -- such as GW170729, GW190620, GW190706, GW230107, GW230820, and GW230928 -- feature high effective spins and primary black holes that fall squarely into the pair-instability.",
    "body": "<p>Observações de fusões de buracos negros binários detectadas pelo LIGO, como GW170729, GW190620, GW190706, GW230107, GW230820 e GW230928, apresentam rotações altamente efetivas e buracos negros primários que caem diretamente na instabilidade do par. Tanto indivíduos como organizações que trabalham com arXivLabs abraçaram e aceitaram nossos valores de abertura, comunidade, excelência e privacidade dos dados do usuário.</p><p>ArXiv está comprometido com esses valores e só trabalha com parceiros que os aderem. Tem uma ideia de um projeto que agregue valor à comunidade arXiv? .</p><p>Saiba mais sobre o arXivLabs. Esses eventos representam um desafio significativo para as teorias padrão da evolução estelar e binária.</p><p>Para resolver isso, propomos um canal de evolução estelar triplo hierárquico isolado. Nesta estrutura, a sincronização das marés em binários internos rígidos impulsiona a evolução quimicamente homogênea (CHE), contornando completamente a expansão gigante.</p><p>Uma evolução subsequente do envelope triplo comum (TCE), desencadeada pelo companheiro terciário, leva rapidamente o BBH interno à coalescência. Nosso modelo pode fornecer um caminho evolutivo detalhado que reproduz com elegância as propriedades desses GWs, como o GW190706.</p><p>Assumindo um ambiente de baixa metalicidade ($Z = 0, 001$), nossa estrutura prevê uma taxa de fusão volumétrica de aproximadamente $0, 011 \\, \\mathrm{Gpc}^{-3}\\mathrm{yr}^{-1}$ em $z \\approx 0, 68$, representando $22\\%$ da taxa empírica para este regime de massa no catálogo GWTC-4.</p><p class=\"art-source\"><a href=\"https://arxiv.org/abs/2607.06067v1\" target=\"_blank\" rel=\"noopener noreferrer\">Fonte</a></p>",
    "body_pt": "<p>Observações de fusões de buracos negros binários detectadas pelo LIGO, como GW170729, GW190620, GW190706, GW230107, GW230820 e GW230928, apresentam rotações altamente efetivas e buracos negros primários que caem diretamente na instabilidade do par. Tanto indivíduos como organizações que trabalham com arXivLabs abraçaram e aceitaram nossos valores de abertura, comunidade, excelência e privacidade dos dados do usuário.</p><p>ArXiv está comprometido com esses valores e só trabalha com parceiros que os aderem. Tem uma ideia de um projeto que agregue valor à comunidade arXiv? .</p><p>Saiba mais sobre o arXivLabs. Esses eventos representam um desafio significativo para as teorias padrão da evolução estelar e binária.</p><p>Para resolver isso, propomos um canal de evolução estelar triplo hierárquico isolado. Nesta estrutura, a sincronização das marés em binários internos rígidos impulsiona a evolução quimicamente homogênea (CHE), contornando completamente a expansão gigante.</p><p>Uma evolução subsequente do envelope triplo comum (TCE), desencadeada pelo companheiro terciário, leva rapidamente o BBH interno à coalescência. Nosso modelo pode fornecer um caminho evolutivo detalhado que reproduz com elegância as propriedades desses GWs, como o GW190706.</p><p>Assumindo um ambiente de baixa metalicidade ($Z = 0, 001$), nossa estrutura prevê uma taxa de fusão volumétrica de aproximadamente $0, 011 \\, \\mathrm{Gpc}^{-3}\\mathrm{yr}^{-1}$ em $z \\approx 0, 68$, representando $22\\%$ da taxa empírica para este regime de massa no catálogo GWTC-4.</p><p class=\"art-source\"><a href=\"https://arxiv.org/abs/2607.06067v1\" target=\"_blank\" rel=\"noopener noreferrer\">Fonte</a></p>",
    "body_en": "<p>Observations of binary black hole mergers detected by LIGO -- such as GW170729, GW190620, GW190706, GW230107, GW230820, and GW230928 -- feature high effective spins and primary black holes that fall squarely into the pair-instability. The new analysis still awaits peer review, but it already lays out the central claim clearly.</p><p>The significance lies in astrophysics becomes persuasive only when an observed signal can be tied to a physically defensible explanation. Compact objects such as neutron stars and black holes are natural laboratories for extreme physics, but the distance and complexity of these systems make interpretation difficult without multi-wavelength coverage and careful modeling. A detection without a mechanism is only half a result. the other half comes from showing that the signal fits quantitatively inside a coherent physical picture rather than merely being consistent with a broad family of models. Observations of binary black hole (BBH) mergers detected by LIGO -- such as GW170729, GW190620, GW190706, GW230107, GW230820, and GW230928 -- feature high effective spins and. Both individuals and organizations that work with arXivLabs have embraced and accepted our values of openness, community, excellence, and user data privacy.</p><p>ArXiv is committed to these values and only works with partners that adhere to them. Have an idea for a project that will add value for arXiv&#x27;s community.</p><p>These events pose a significant challenge to standard stellar and binary evolution theories. To address this, we propose an isolated hierarchical triple stellar evolution channel.</p><p>In this framework, tidal synchronization in tight inner binaries drives chemically homogeneous evolution (CHE), entirely bypassing giant expansion. A subsequent triple common envelope (TCE) evolution, triggered by the tertiary companion, rapidly drives the inner BBH to coalescence.</p><p>The broader interest lies in turning an observational clue into something that can be weighed against competing models of the underlying physics. Astrophysics does not have the luxury of controlled experiments; everything is inferred from radiation that traveled across cosmic distances under conditions that cannot be reproduced in a terrestrial laboratory. This makes the interpretation chain longer and more uncertain than in bench science, but it also means that a well-constrained measurement of an extreme object carries theoretical information that no earthbound experiment can provide.</p><p>Our model can provide a detailed evolutionary pathway that elegantly reproduces the properties of these GWs, such as GW190706. This study demonstrates that primordial triple interactions are a highly efficient avenue for populating the PISN mass gap.</p><p>Because this is still a preprint, the result should be read with genuine interest and proportionate caution. Peer review is not a guarantee of correctness, but it is a process that forces authors to respond to technical criticism from specialists who have no stake in a particular outcome. Preprints that survive that process, often with substantive revisions, emerge with a stronger evidential base than the version that first appeared. Until that stage is complete, the responsible reading keeps uncertainty explicitly visible rather than treating the claims as established findings.</p><p>The next step is to see whether independent datasets and physical modeling converge on the same interpretation. Multi-wavelength follow-up, combining X-ray, radio and optical data where possible, is typically what separates a compelling detection from a robust physical characterization. In high-energy astrophysics, results that initially looked definitive have been revised when data from a second messenger arrived; the current result should be read with that history in mind. Until peer review and independent follow-up address those open questions, skepticism is not a failure of appreciation for the work; it is part of how science decides what to keep.</p><p class=\"art-source\"><a href=\"https://arxiv.org/abs/2607.06067v1\" target=\"_blank\" rel=\"noopener noreferrer\">Source</a></p>",
    "highlights": [
      "Em foco: Observações de fusões de buracos negros binários detectadas pelo LIGO, como GW170729, GW190620, GW190706, GW230107, GW230820 e GW230928, apresentam",
      "Detalhe: Resultado ainda sem revisão por pares",
      "Leitura editorial: resultado provisório, ainda sem revisão por pares formal."
    ],
    "highlights_pt": [
    ...
    "highlights_en": [
      "Focus: Observations of binary black hole mergers detected by LIGO -- such as GW170729, GW190620, GW190706, GW230107, GW230820, and GW230928 -- feature high",
      "Editorial reading: provisional result, not yet formally peer reviewed."
    ],
    "date": "07 jul 2026",
    "date_pt": "07 jul 2026",
    ...
    "read_pt": "4 min de leitura",
    "read_en": "4 min read",
    "publishedIso": "2026-07-07T09:39:16+00:00",
    "lastModifiedIso": "2026-07-08T17:16:19+00:00",
    ...
    "keywords": [
      ...
      "Cosmos Week",
      "Um possível cenário de formação tripla de fusão de buraco negro binário com uma lacuna de massa de supernova com instabilidade de par"
    ],
    "keywords_pt": [
      "Astrofísica",
      "arXiv High Energy Astrophysics",
    ...
    "keywords_en": [
      ...
      "arXiv High Energy Astrophysics",
      "Cosmos Week",
      "A possible triple binary black hole merger formation scenario with a supernova mass gap with pair instability"
    ],
    "srcUrl": "https://arxiv.org/abs/2607.06067v1",
    "realUrl": "https://www.cosmosweek.com/?article=a-possible-triple-formation-scenario-of-binary-black-hole-merge-with-one-in-pair-instability-sup",
    "realUrl_pt": "https://www.cosmosweek.com/?article=a-possible-triple-formation-scenario-of-binary-black-hole-merge-with-one-in-pair-instability-sup",
    "realUrl_en": "https://www.cosmosweek.com/?article=a-possible-triple-formation-scenario-of-binary-black-hole-merge-with-one-in-pair-instability-sup&lang=en",
    "shareUrl": "https://www.cosmosweek.com/noticia/a-possible-triple-formation-scenario-of-binary-black-hole-merge-with-one-in-pair-instability-sup/",
    "shareUrl_pt": "https://www.cosmosweek.com/noticia/a-possible-triple-formation-scenario-of-binary-black-hole-merge-with-one-in-pair-instability-sup/",
    "shareUrl_en": "https://www.cosmosweek.com/en/news/a-possible-triple-formation-scenario-of-binary-black-hole-merge-with-one-in-pair-instability-sup/",
    "canonicalUrl": "https://www.cosmosweek.com/noticia/a-possible-triple-formation-scenario-of-binary-black-hole-merge-with-one-in-pair-instability-sup/",
    "canonicalUrl_pt": "https://www.cosmosweek.com/noticia/a-possible-triple-formation-scenario-of-binary-black-hole-merge-with-one-in-pair-instability-sup/",
    "canonicalUrl_en": "https://www.cosmosweek.com/en/news/a-possible-triple-formation-scenario-of-binary-black-hole-merge-with-one-in-pair-instability-sup/",
    "defaultLanguage": "pt-BR",
    "availableLanguages": [
      "pt-BR",
      "en-US"
    ...
    "imageAlt": "Um possível cenário de formação tripla de fusão de buraco negro binário com uma lacuna de massa de supernova com instabilidade de par",
    "imageAlt_pt": "Um possível cenário de formação tripla de fusão de buraco negro binário com uma lacuna de massa de supernova com instabilidade de par",
    "imageAlt_en": "A Possible Triple Formation Scenario of Binary Black Hole Merge With One In Pair-instability Supernova Mass Gap",
    "coverageKind": "preprint",
    "coverageKindLabel": "Preprint",
    "coverageKindLabel_pt": "Preprint",
    "coverageKindLabel_en": "Preprint",
  ...
  },
  {
    ...
    "highlights_en": [
      ...
      "Key detail: In new images from NASA’s James Webb Space Telescope to celebrate its fourth science anniversary, a familiar galaxy transforms into something far",
  ...
  },
  {
    ...
    "highlights": [
      "Ponto central: A Agência Espacial Europeia (ESA) concedeu à Airbus Defence and Space no Reino Unido a autorização para desenvolver o Aeolus-2, sucessor da.",
      "Dado-chave: A Agência Espacial Europeia (ESA) concedeu à Airbus Defence and Space no Reino Unido a autorização para desenvolver o Aeolus-2, sucessor da",
      "Origem institucional: distinguir anúncio de evidência."
    ],
    "highlights_pt": [
      "Ponto central: A Agência Espacial Europeia (ESA) concedeu à Airbus Defence and Space no Reino Unido a autorização para desenvolver o Aeolus-2, sucessor da.",
