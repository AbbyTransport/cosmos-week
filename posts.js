...
window.postsData = [
  {
    ...
    "highlights": [
      "Em foco: Fully autonomous space mission operations require the ability to detect faults and compensate for them without human intervention",
    ...
    "highlights_en": [
      "Focus: Fully autonomous space mission operations require the ability to detect faults and compensate for them without human intervention",
  ...
  },
  {
    ...
    "highlights": [
      "Em foco: Coverage plans are ready for NASA’s Nancy Grace Roman Space Telescope prelaunch and launch activities",
      "Detalhe: Origem institucional: distinguir anúncio de evidência",
      "Leitura editorial: release institucional, útil como fonte primária, mas não como validação independente."
    ],
    "highlights_pt": [
    ...
    "highlights_en": [
      "Focus: Coverage plans are ready for NASA’s Nancy Grace Roman Space Telescope prelaunch and launch activities",
      "Detail: Institutional origin: separate announcement from evidence",
      "Editorial reading: institutional release, useful as a primary source but not independent validation."
    ],
    "date": "24 ago 2026",
  ...
  },
  {
    ...
    "highlights": [
      "Em foco: At the center of our solar system, the Sun influences every planet that orbits it",
      "Detalhe: Origem institucional: distinguir anúncio de evidência",
      "Leitura editorial: release institucional, útil como fonte primária, mas não como validação independente."
    ],
    "highlights_pt": [
    ...
    "highlights_en": [
      "Focus: At the center of our solar system, the Sun influences every planet that orbits it",
      "Detail: Institutional origin: separate announcement from evidence",
      "Editorial reading: institutional release, useful as a primary source but not independent validation."
    ],
    "date": "24 ago 2026",
  ...
  },
  {
    ...
    "highlights": [
      "Em foco: As a natural extension of the single-field fuzzy dark matter model, multifield FDM has attracted increasing attention in recent years",
    ...
    "highlights_en": [
      "Focus: As a natural extension of the single-field fuzzy dark matter model, multifield FDM has attracted increasing attention in recent years",
  ...
  {
    "id": 5,
    "slug": "tidal-disruption-of-stellar-binaries-as-a-pathway-to-exotic-transients",
    "cat": "Astrofísica",
    "catCls": "astrofisica",
    ...
    "title_pt": "Tidal disruption of stellar binaries as a pathway to exotic transients",
    "title_en": "Tidal disruption of stellar binaries as a pathway to exotic transients",
    "sub": "Tidal disruption event progenitors are commonly modelled as single stars on parabolic orbits around a supermassive black hole, yet observations point to a richer diversity of.",
    "sub_pt": "Tidal disruption event progenitors are commonly modelled as single stars on parabolic orbits around a supermassive black hole, yet observations point to a richer diversity of.",
    "sub_en": "Tidal disruption event progenitors are commonly modelled as single stars on parabolic orbits around a supermassive black hole, yet observations point to a richer diversity of.",
    "excerpt": "Tidal disruption event progenitors are commonly modelled as single stars on parabolic orbits around a supermassive black hole, yet observations point to a richer diversity of dynamical pathways.",
    "excerpt_pt": "Tidal disruption event progenitors are commonly modelled as single stars on parabolic orbits around a supermassive black hole, yet observations point to a richer diversity of dynamical pathways.",
    "excerpt_en": "Tidal disruption event progenitors are commonly modelled as single stars on parabolic orbits around a supermassive black hole, yet observations point to a richer diversity of dynamical pathways.",
    "body": "<p>Tidal disruption event progenitors are commonly modelled as single stars on parabolic orbits around a supermassive black hole, yet observations point to a richer diversity of dynamical pathways. Tidal disruption event (TDE) progenitors are commonly modelled as single stars on parabolic orbits around a supermassive black hole (SMBH), yet observations point to a richer diversity of dynamical pathways.</p><p>We show that the tidal separation of stellar binaries by a $10^6\\, M_\\odot$ SMBH provides a natural mechanism for producing eccentric TDEs. Using restricted three-body dynamics and smoothed particle hydrodynamics (SPH) simulations, we model a binary composed of a solar-like star (SLS) and a white dwarf (WD) on a parabolic orbit.</p><p>The binary orbital phase governs the outcome: one component is captured onto a tightly bound orbit while the other is ejected as a hypervelocity object, naturally producing TDEs with eccentricities $e \\neq 1$. We classify the resulting events into Elliptical TDEs (eTDEs) and Hyperbolic TDEs (hTDEs), which occur with equal probability.</p><p>For $\\sim 88\\%$ of binary orientations the disruption is clean, with no mass accreted by the WD. The remaining $\\sim 12\\%$ lies in two narrow windows of binary phase in which the WD captures material and becomes a WD with debris envelope (WDDE).</p><p>About a third of that range, $\\sim 4\\%$ of all orientations, involves a direct WD--SLS collision near pericenter, giving fallback that peaks up to five times earlier and twenty times higher than in the single-star case. For the innermost $\\sim 1.5\\%$ the total WDDE mass exceeds $1.4\\, M_\\odot$, although the degenerate core itself does not, since the captured material forms a non-degenerate envelope.</p><p>This suggests outcomes ranging from nova-like events to peculiar red giant-like objects.</p><p class=\"art-source\"><a href=\"https://arxiv.org/abs/2608.22735v1\" target=\"_blank\" rel=\"noopener noreferrer\">Fonte</a></p>",
    "body_pt": "<p>Tidal disruption event progenitors are commonly modelled as single stars on parabolic orbits around a supermassive black hole, yet observations point to a richer diversity of dynamical pathways. Tidal disruption event (TDE) progenitors are commonly modelled as single stars on parabolic orbits around a supermassive black hole (SMBH), yet observations point to a richer diversity of dynamical pathways.</p><p>We show that the tidal separation of stellar binaries by a $10^6\\, M_\\odot$ SMBH provides a natural mechanism for producing eccentric TDEs. Using restricted three-body dynamics and smoothed particle hydrodynamics (SPH) simulations, we model a binary composed of a solar-like star (SLS) and a white dwarf (WD) on a parabolic orbit.</p><p>The binary orbital phase governs the outcome: one component is captured onto a tightly bound orbit while the other is ejected as a hypervelocity object, naturally producing TDEs with eccentricities $e \\neq 1$. We classify the resulting events into Elliptical TDEs (eTDEs) and Hyperbolic TDEs (hTDEs), which occur with equal probability.</p><p>For $\\sim 88\\%$ of binary orientations the disruption is clean, with no mass accreted by the WD. The remaining $\\sim 12\\%$ lies in two narrow windows of binary phase in which the WD captures material and becomes a WD with debris envelope (WDDE).</p><p>About a third of that range, $\\sim 4\\%$ of all orientations, involves a direct WD--SLS collision near pericenter, giving fallback that peaks up to five times earlier and twenty times higher than in the single-star case. For the innermost $\\sim 1.5\\%$ the total WDDE mass exceeds $1.4\\, M_\\odot$, although the degenerate core itself does not, since the captured material forms a non-degenerate envelope.</p><p>This suggests outcomes ranging from nova-like events to peculiar red giant-like objects.</p><p class=\"art-source\"><a href=\"https://arxiv.org/abs/2608.22735v1\" target=\"_blank\" rel=\"noopener noreferrer\">Fonte</a></p>",
    "body_en": "<p>Tidal disruption event progenitors are commonly modelled as single stars on parabolic orbits around a supermassive black hole, yet observations point to a richer diversity of dynamical pathways. The new analysis still awaits peer review, but it already lays out the central claim clearly.</p><p>That matters because astrophysics becomes persuasive only when an observed signal can be tied to a physically defensible explanation. Compact objects such as neutron stars and black holes are natural laboratories for extreme physics, but the distance and complexity of these systems make interpretation difficult without multi-wavelength coverage and careful modeling. A detection without a mechanism is only half a result. the other half comes from showing that the signal fits quantitatively inside a coherent physical picture rather than merely being consistent with a broad family of models. Tidal disruption event (TDE) progenitors are commonly modelled as single stars on parabolic orbits around a supermassive black hole (SMBH), yet observations point to a richer. We show that the tidal separation of stellar binaries by a $10^6\\, M_\\odot$ SMBH provides a natural mechanism for producing eccentric TDEs.</p><p>The binary orbital phase governs the outcome: one component is captured onto a tightly bound orbit while the other is ejected as a hypervelocity object, naturally producing TDEs. We classify the resulting events into Elliptical TDEs (eTDEs) and Hyperbolic TDEs (hTDEs), which occur with equal probability.</p><p>For $\\sim 88\\%$ of binary orientations the disruption is clean, with no mass accreted by the WD. The remaining $\\sim 12\\%$ lies in two narrow windows of binary phase in which the WD captures material and becomes a WD with debris envelope (WDDE).</p><p>About a third of that range, $\\sim 4\\%$ of all orientations, involves a direct WD--SLS collision near pericenter, giving fallback that peaks up to five times earlier and twenty. For the innermost $\\sim 1.5\\%$ the total WDDE mass exceeds $1.4\\, M_\\odot$, although the degenerate core itself does not, since the captured material forms a non-degenerate.</p><p>The broader interest lies in turning an observational clue into something that can be weighed against competing models of the underlying physics. Astrophysics does not have the luxury of controlled experiments; everything is inferred from radiation that traveled across cosmic distances under conditions that cannot be reproduced in a terrestrial laboratory. This makes the interpretation chain longer and more uncertain than in bench science, but it also means that a well-constrained measurement of an extreme object carries theoretical information that no earthbound experiment can provide.</p><p>This suggests outcomes ranging from nova-like events to peculiar red giant-like objects. Binary--SMBH encounters thus provide a robust channel for generating diverse TDEs with distinct observational signatures.</p><p>Because this is still a preprint, the result should be read with genuine interest and proportionate caution. Peer review is not a guarantee of correctness, but it is a process that forces authors to respond to technical criticism from specialists who have no stake in a particular outcome. Preprints that survive that process, often with substantive revisions, emerge with a stronger evidential base than the version that first appeared. Until that stage is complete, the responsible reading keeps uncertainty explicitly visible rather than treating the claims as established findings.</p><p>The next step is to see whether independent datasets and physical modeling converge on the same interpretation. Multi-wavelength follow-up, combining X-ray, radio and optical data where possible, is typically what separates a compelling detection from a robust physical characterization. In high-energy astrophysics, results that initially looked definitive have been revised when data from a second messenger arrived; the current result should be read with that history in mind. Until peer review and independent follow-up address those open questions, skepticism is not a failure of appreciation for the work; it is part of how science decides what to keep.</p><p class=\"art-source\"><a href=\"https://arxiv.org/abs/2608.22735v1\" target=\"_blank\" rel=\"noopener noreferrer\">Source</a></p>",
    "highlights": [
      "Em foco: Tidal disruption event progenitors are commonly modelled as single stars on parabolic orbits around a supermassive black hole, yet observations point",
      "Detalhe: Resultado ainda sem revisão por pares",
      "Leitura editorial: resultado provisório, ainda sem revisão por pares formal."
    ],
    "highlights_pt": [
    ...
    "highlights_en": [
      "Focus: Tidal disruption event progenitors are commonly modelled as single stars on parabolic orbits around a supermassive black hole, yet observations point",
      "Editorial reading: provisional result, not yet formally peer reviewed."
    ],
    "date": "24 ago 2026",
    "date_pt": "24 ago 2026",
    ...
    "read_pt": "4 min de leitura",
    "read_en": "4 min read",
    "publishedIso": "2026-08-24T02:44:06+00:00",
    "lastModifiedIso": "2026-08-25T16:13:24+00:00",
    ...
    "srcUrl": "https://arxiv.org/abs/2608.22735v1",
    "realUrl": "https://www.cosmosweek.com/?article=tidal-disruption-of-stellar-binaries-as-a-pathway-to-exotic-transients",
    "realUrl_pt": "https://www.cosmosweek.com/?article=tidal-disruption-of-stellar-binaries-as-a-pathway-to-exotic-transients",
    "realUrl_en": "https://www.cosmosweek.com/?article=tidal-disruption-of-stellar-binaries-as-a-pathway-to-exotic-transients&lang=en",
    "shareUrl": "https://www.cosmosweek.com/noticia/tidal-disruption-of-stellar-binaries-as-a-pathway-to-exotic-transients/",
    "shareUrl_pt": "https://www.cosmosweek.com/noticia/tidal-disruption-of-stellar-binaries-as-a-pathway-to-exotic-transients/",
    "shareUrl_en": "https://www.cosmosweek.com/en/news/tidal-disruption-of-stellar-binaries-as-a-pathway-to-exotic-transients/",
    "canonicalUrl": "https://www.cosmosweek.com/noticia/tidal-disruption-of-stellar-binaries-as-a-pathway-to-exotic-transients/",
    "canonicalUrl_pt": "https://www.cosmosweek.com/noticia/tidal-disruption-of-stellar-binaries-as-a-pathway-to-exotic-transients/",
    "canonicalUrl_en": "https://www.cosmosweek.com/en/news/tidal-disruption-of-stellar-binaries-as-a-pathway-to-exotic-transients/",
    "defaultLanguage": "pt-BR",
    "availableLanguages": [
      "pt-BR",
      "en-US"
    ...
    "imageAlt": "Tidal disruption of stellar binaries as a pathway to exotic transients",
    "imageAlt_pt": "Tidal disruption of stellar binaries as a pathway to exotic transients",
    "imageAlt_en": "Tidal disruption of stellar binaries as a pathway to exotic transients",
    "coverageKind": "preprint",
    "coverageKindLabel": "Preprint",
    "coverageKindLabel_pt": "Preprint",
    "coverageKindLabel_en": "Preprint",
  ...
  },
  {
    ...
    "video": {
      ...
      "title": "NASA compartilha vistas do eclipse solar de agosto do solo, do ar e do espaço - NASA Science",
      "title_pt": "NASA compartilha vistas do eclipse solar de agosto do solo, do ar e do espaço - NASA Science",
    ...
    "lastModifiedIso": "2026-08-22T15:52:38+00:00",
    "source": "NASA News Releases",
    "sourceDomain": "science. nasa. gov",
    "sourceType": "agency",
    "sourceTypeLabel": "Fonte institucional",
    ...
    "imageAlt": "NASA compartilha vistas do eclipse solar de agosto do solo, do ar e do espaço",
    "imageAlt_pt": "NASA compartilha vistas do eclipse solar de agosto do solo, do ar e do espaço",
