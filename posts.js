...
window.postsData = [
  ...
  {
    "id": 10,
    "slug": "wide-binaries-in-ultra-faint-dwarf-galaxies-as-a-probe-of-extended-dark-objects",
    "cat": "Cosmologia",
    "catCls": "cosmologia",
    ...
    "video": null,
    "audio": null,
    "title": "Binários amplos em galáxias anãs ultrafracas como uma sonda de objetos escuros estendidos",
    "title_pt": "Binários amplos em galáxias anãs ultrafracas como uma sonda de objetos escuros estendidos",
    "title_en": "Wide binaries in ultra-faint dwarf galaxies as a probe of extended dark objects",
    "sub": "Binários estelares amplos são sondas dinâmicas sensíveis da subestrutura da matéria escura.",
    "sub_pt": "Binários estelares amplos são sondas dinâmicas sensíveis da subestrutura da matéria escura.",
    "sub_en": "Wide stellar binaries are sensitive dynamical probes of dark matter substructure. We generalize existing point-mass disruption constraints to spherical extended dark objects and.",
    "excerpt": "Binários estelares amplos são sondas dinâmicas sensíveis da subestrutura da matéria escura. Generalizamos as restrições existentes de ruptura de massa pontual para objetos escuros esféricos estendidos e aplicamos a estrutura resultante à população de.",
    "excerpt_pt": "Binários estelares amplos são sondas dinâmicas sensíveis da subestrutura da matéria escura. Generalizamos as restrições existentes de ruptura de massa pontual para objetos escuros esféricos estendidos e aplicamos a estrutura resultante à população de.",
    "excerpt_en": "Wide stellar binaries are sensitive dynamical probes of dark matter substructure. We generalize existing point-mass disruption constraints to spherical extended dark objects and apply the resulting framework to the population of.",
    "body": "<p>Binários estelares amplos são sondas dinâmicas sensíveis da subestrutura da matéria escura. Tanto indivíduos como organizações que trabalham com arXivLabs abraçaram e aceitaram nossos valores de abertura, comunidade, excelência e privacidade dos dados do usuário.</p><p>ArXiv está comprometido com esses valores e só trabalha com parceiros que os aderem. Tem uma ideia de um projeto que agregue valor à comunidade arXiv? .</p><p>Saiba mais sobre o arXivLabs. Resumo: Binários estelares amplos são sondas dinâmicas sensíveis da subestrutura da matéria escura.</p><p>Derivamos limites de confiança de 95% para a fração de matéria escura em função da massa do perturbador, do raio que abrange 90% da massa e do perfil de densidade, considerando os modelos Navarro-Frenk-White, r^-3/2 e r^-9/4. Objetos suficientemente compactos convergem para o limite de massa pontual, enquanto o tamanho finito suprime a ruptura binária quando o perturbador se torna comparável ao encontro relevante e às escalas binárias.</p><p>As restrições permanecem sensíveis às frações de matéria escura bem abaixo da unidade em uma ampla região do plano do raio de massa e se estendem a objetos substancialmente maiores do que aqueles acessíveis às buscas convencionais por microlentes. Como aplicação, mapeamos os resultados de r^-3/2 em minihalos ultracompactos e derivamos uma restrição ilustrativa no espectro de potência da curvatura primordial.</p><p>Binários anãs ultra-fracas oferecem, portanto, uma sonda puramente gravitacional da abundância de objetos estendidos de matéria escura e do espectro de potência da curvatura primordial em pequena escala.</p><p class=\"art-source\"><a href=\"https://arxiv.org/abs/2607.18185v1\" target=\"_blank\" rel=\"noopener noreferrer\">Fonte</a></p>",
    "body_pt": "<p>Binários estelares amplos são sondas dinâmicas sensíveis da subestrutura da matéria escura. Tanto indivíduos como organizações que trabalham com arXivLabs abraçaram e aceitaram nossos valores de abertura, comunidade, excelência e privacidade dos dados do usuário.</p><p>ArXiv está comprometido com esses valores e só trabalha com parceiros que os aderem. Tem uma ideia de um projeto que agregue valor à comunidade arXiv? .</p><p>Saiba mais sobre o arXivLabs. Resumo: Binários estelares amplos são sondas dinâmicas sensíveis da subestrutura da matéria escura.</p><p>Derivamos limites de confiança de 95% para a fração de matéria escura em função da massa do perturbador, do raio que abrange 90% da massa e do perfil de densidade, considerando os modelos Navarro-Frenk-White, r^-3/2 e r^-9/4. Objetos suficientemente compactos convergem para o limite de massa pontual, enquanto o tamanho finito suprime a ruptura binária quando o perturbador se torna comparável ao encontro relevante e às escalas binárias.</p><p>As restrições permanecem sensíveis às frações de matéria escura bem abaixo da unidade em uma ampla região do plano do raio de massa e se estendem a objetos substancialmente maiores do que aqueles acessíveis às buscas convencionais por microlentes. Como aplicação, mapeamos os resultados de r^-3/2 em minihalos ultracompactos e derivamos uma restrição ilustrativa no espectro de potência da curvatura primordial.</p><p>Binários anãs ultra-fracas oferecem, portanto, uma sonda puramente gravitacional da abundância de objetos estendidos de matéria escura e do espectro de potência da curvatura primordial em pequena escala.</p><p class=\"art-source\"><a href=\"https://arxiv.org/abs/2607.18185v1\" target=\"_blank\" rel=\"noopener noreferrer\">Fonte</a></p>",
    "body_en": "<p>Wide stellar binaries are sensitive dynamical probes of dark matter substructure. We generalize existing point-mass disruption constraints to spherical extended dark objects and apply the resulting framework to the population of. The new analysis still awaits peer review, but it already lays out the central claim clearly.</p><p>That matters because cosmology operates at the edge of what current instruments can measure, where systematic errors and model assumptions are never trivial. Small discrepancies between independent measurements have historically pointed toward missing physics rather than simple calibration errors, and the ongoing tension in the Hubble constant is a live example of how a persistent disagreement between methods can reshape the theoretical landscape. Each new dataset that approaches this territory with independent systematics adds real information to a problem that has resisted easy resolution for more than a decade. Wide stellar binaries are sensitive dynamical probes of dark matter substructure. Both individuals and organizations that work with arXivLabs have embraced and accepted our values of openness, community, excellence, and user data privacy.</p><p>ArXiv is committed to these values and only works with partners that adhere to them. Have an idea for a project that will add value for arXiv&#x27;s community.</p><p>We generalize existing point-mass disruption constraints to spherical extended dark objects and apply the resulting framework to the population of wide-binary candidates. We derive 95% confidence limits on the dark matter fraction as a function of the perturber mass, the radius enclosing 90% of the mass, and the density profile, considering.</p><p>Sufficiently compact objects converge to the point-mass limit, whereas finite size suppresses binary disruption when the perturber becomes comparable to the relevant encounter and. The constraints remain sensitive to dark matter fractions well below unity over a broad region of the mass-radius plane and extend to objects substantially larger than those.</p><p>The relevance goes beyond one dataset because even small shifts in measured parameters can matter when the field is testing the limits of the standard cosmological model. The Lambda-CDM framework describes the observable universe with remarkable economy, but its success rests on two components, dark matter and dark energy, whose physical nature remains entirely unknown. Any credible measurement that tightens or loosens the constraints on those components moves the entire theoretical enterprise forward, regardless of whether the immediate result looks dramatic on its own terms.</p><p>As an application, we map the r^-3/2 results onto ultracompact minihalos and derive an illustrative constraint on the primordial curvature power spectrum. Ultra-faint-dwarf wide binaries therefore offer a purely gravitational probe of the abundance of extended dark matter objects and of the small-scale primordial curvature power.</p><p>Because this is still a preprint, the result should be read with genuine interest and proportionate caution. Peer review is not a guarantee of correctness, but it is a process that forces authors to respond to technical criticism from specialists who have no stake in a particular outcome. Preprints that survive that process, often with substantive revisions, emerge with a stronger evidential base than the version that first appeared. Until that stage is complete, the responsible reading keeps uncertainty explicitly visible rather than treating the claims as established findings.</p><p>The next step is to see whether the effect survives when independent surveys, different calibration strategies and tighter control of systematic uncertainties enter the picture. Programmes such as Euclid, DESI and the Rubin Observatory will deliver datasets over the next several years that cover the same parameter space with largely independent methods. If the current signal persists through those tests, its theoretical implications will become impossible to set aside. Until peer review and independent follow-up address those open questions, skepticism is not a failure of appreciation for the work; it is part of how science decides what to keep.</p><p class=\"art-source\"><a href=\"https://arxiv.org/abs/2607.18185v1\" target=\"_blank\" rel=\"noopener noreferrer\">Source</a></p>",
    "highlights": [
      "Ponto central: Binários estelares amplos são sondas dinâmicas sensíveis da subestrutura da matéria escura.",
      "Dado-chave: Binários estelares amplos são sondas dinâmicas sensíveis da subestrutura da matéria escura.",
      "Resultado ainda sem revisão por pares."
    ],
    "highlights_pt": [
      "Ponto central: Binários estelares amplos são sondas dinâmicas sensíveis da subestrutura da matéria escura.",
    ...
    "highlights_en": [
      "Core point: Wide stellar binaries are sensitive dynamical probes of dark matter substructure.",
      "Key detail: Wide stellar binaries are sensitive dynamical probes of dark matter substructure.",
      "Result not yet peer reviewed."
    ],
    "date": "20 jul 2026",
    "date_pt": "20 jul 2026",
    ...
    "read_pt": "4 min de leitura",
    "read_en": "4 min read",
    "publishedIso": "2026-07-20T17:23:48+00:00",
    "lastModifiedIso": "2026-07-21T17:15:37+00:00",
    ...
    "keywords": [
      ...
      "arXiv Cosmology",
      "Cosmos Week",
      "Binários amplos em galáxias anãs ultrafracas como uma sonda de objetos escuros estendidos"
    ],
    "keywords_pt": [
      "Cosmologia",
      "arXiv Cosmology",
    ...
    "keywords_en": [
      ...
      "arXiv Cosmology",
      "Cosmos Week",
      "Wide binaries in ultrafaint dwarf galaxies as a probe of extended dark objects"
    ],
    "srcUrl": "https://arxiv.org/abs/2607.18185v1",
    "realUrl": "https://www.cosmosweek.com/?article=wide-binaries-in-ultra-faint-dwarf-galaxies-as-a-probe-of-extended-dark-objects",
    "realUrl_pt": "https://www.cosmosweek.com/?article=wide-binaries-in-ultra-faint-dwarf-galaxies-as-a-probe-of-extended-dark-objects",
    "realUrl_en": "https://www.cosmosweek.com/?article=wide-binaries-in-ultra-faint-dwarf-galaxies-as-a-probe-of-extended-dark-objects&lang=en",
    "shareUrl": "https://www.cosmosweek.com/noticia/wide-binaries-in-ultra-faint-dwarf-galaxies-as-a-probe-of-extended-dark-objects/",
    "shareUrl_pt": "https://www.cosmosweek.com/noticia/wide-binaries-in-ultra-faint-dwarf-galaxies-as-a-probe-of-extended-dark-objects/",
    "shareUrl_en": "https://www.cosmosweek.com/en/news/wide-binaries-in-ultra-faint-dwarf-galaxies-as-a-probe-of-extended-dark-objects/",
    "canonicalUrl": "https://www.cosmosweek.com/noticia/wide-binaries-in-ultra-faint-dwarf-galaxies-as-a-probe-of-extended-dark-objects/",
    "canonicalUrl_pt": "https://www.cosmosweek.com/noticia/wide-binaries-in-ultra-faint-dwarf-galaxies-as-a-probe-of-extended-dark-objects/",
    "canonicalUrl_en": "https://www.cosmosweek.com/en/news/wide-binaries-in-ultra-faint-dwarf-galaxies-as-a-probe-of-extended-dark-objects/",
    "defaultLanguage": "pt-BR",
    "availableLanguages": [
      "pt-BR",
      "en-US"
    ...
    "imageAlt": "Binários amplos em galáxias anãs ultrafracas como uma sonda de objetos escuros estendidos",
    "imageAlt_pt": "Binários amplos em galáxias anãs ultrafracas como uma sonda de objetos escuros estendidos",
    "imageAlt_en": "Wide binaries in ultra-faint dwarf galaxies as a probe of extended dark objects",
    "coverageKind": "preprint",
    "coverageKindLabel": "Preprint",
    "coverageKindLabel_pt": "Preprint",
    "coverageKindLabel_en": "Preprint",
  ...
  },
  {
    ...
    "video": null,
    "audio": null,
    "title": "Medições de spin de buraco negro por espectroscopia de reflexão de raios X: critérios de qualidade e recomendações da comunidade",
    "title_pt": "Medições de spin de buraco negro por espectroscopia de reflexão de raios X: critérios de qualidade e recomendações da comunidade",
    "title_en": "Black-Hole Spin Measurements from X-ray Reflection Spectroscopy: Quality Criteria and Community Recommendations",
    "sub": "A espectroscopia de reflexão de raios X fornece um dos métodos eletromagnéticos mais poderosos para medir o spin adimensional de buracos negros em acreção.",
    "sub_pt": "A espectroscopia de reflexão de raios X fornece um dos métodos eletromagnéticos mais poderosos para medir o spin adimensional de buracos negros em acreção.",
    "sub_en": "X-ray reflection spectroscopy provides one of the most powerful electromagnetic methods for measuring the dimensionless spin of accreting black holes.",
    "excerpt": "A espectroscopia de reflexão de raios X fornece um dos métodos eletromagnéticos mais poderosos para medir o spin adimensional de buracos negros em acreção.",
    "excerpt_pt": "A espectroscopia de reflexão de raios X fornece um dos métodos eletromagnéticos mais poderosos para medir o spin adimensional de buracos negros em acreção.",
    "excerpt_en": "X-ray reflection spectroscopy provides one of the most powerful electromagnetic methods for measuring the dimensionless spin of accreting black holes.",
    ...
    "read_pt": "4 min de leitura",
    "read_en": "4 min read",
    "publishedIso": "2026-07-15T21:16:51+00:00",
    "lastModifiedIso": "2026-07-17T16:58:55+00:00",
    ...
    "keywords": [
      ...
      "Cosmos Week",
      "Medições de spin de buraco negro por espectroscopia de reflexão de raios X",
      "critérios de qualidade e recomendações da comunidade"
    ],
    "keywords_pt": [
      "Astrofísica",
      "arXiv High Energy Astrophysics",
    ...
    "keywords_en": [
      ...
      "arXiv High Energy Astrophysics",
      "Cosmos Week",
      "Black hole spin measurements by X-ray reflection spectroscopy",
      "quality criteria and community recommendations"
    ],
    "srcUrl": "https://arxiv.org/abs/2607.14368v1",
    "realUrl": "https://www.cosmosweek.com/?article=black-hole-spin-measurements-from-x-ray-reflection-spectroscopy-quality-criteria-and-community-r",
    "realUrl_pt": "https://www.cosmosweek.com/?article=black-hole-spin-measurements-from-x-ray-reflection-spectroscopy-quality-criteria-and-community-r",
    "realUrl_en": "https://www.cosmosweek.com/?article=black-hole-spin-measurements-from-x-ray-reflection-spectroscopy-quality-criteria-and-community-r&lang=en",
    "shareUrl": "https://www.cosmosweek.com/noticia/black-hole-spin-measurements-from-x-ray-reflection-spectroscopy-quality-criteria-and-community-r/",
    "shareUrl_pt": "https://www.cosmosweek.com/noticia/black-hole-spin-measurements-from-x-ray-reflection-spectroscopy-quality-criteria-and-community-r/",
    "shareUrl_en": "https://www.cosmosweek.com/en/news/black-hole-spin-measurements-from-x-ray-reflection-spectroscopy-quality-criteria-and-community-r/",
    "canonicalUrl": "https://www.cosmosweek.com/noticia/black-hole-spin-measurements-from-x-ray-reflection-spectroscopy-quality-criteria-and-community-r/",
    "canonicalUrl_pt": "https://www.cosmosweek.com/noticia/black-hole-spin-measurements-from-x-ray-reflection-spectroscopy-quality-criteria-and-community-r/",
    "canonicalUrl_en": "https://www.cosmosweek.com/en/news/black-hole-spin-measurements-from-x-ray-reflection-spectroscopy-quality-criteria-and-community-r/",
    "defaultLanguage": "pt-BR",
    "availableLanguages": [
      "pt-BR",
      "en-US"
    ...
    "imageAlt": "Medições de spin de buraco negro por espectroscopia de reflexão de raios X: critérios de qualidade e recomendações da comunidade",
    "imageAlt_pt": "Medições de spin de buraco negro por espectroscopia de reflexão de raios X: critérios de qualidade e recomendações da comunidade",
    "imageAlt_en": "Black-Hole Spin Measurements from X-ray Reflection Spectroscopy: Quality Criteria and Community Recommendations",
    "coverageKind": "preprint",
    "coverageKindLabel": "Preprint",
    "coverageKindLabel_pt": "Preprint",
    "coverageKindLabel_en": "Preprint",
