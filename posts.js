...
window.postsData = [
  {
    ...
    "highlights_en": [
      "Focus: A mobile wastewater treatment system built at NASA’s Kennedy Space Center in Florida that can help prepare for long-duration missions on the Moon and",
  ...
  },
  {
    ...
    "cat": "Astronomia",
    "catCls": "astronomia",
    "img": "https://assets.science.nasa.gov/content/dam/science/cds/citizen-science/projects/2026/Galaxy_clump_featured_image.jpg/jcr:content/renditions/cq5dam.web.1280.1280.jpeg",
    "inline_images": [],
    "video": null,
    "audio": null,
    "title": "Participe como explorador e ajude a desvendar os segredos dos berçários estelares",
    "title_pt": "Participe como explorador e ajude a desvendar os segredos dos berçários estelares",
    "title_en": "Be a Clump Scout and Help Reveal Secrets of Stellar Nurseries",
    "sub": "Participe da identificação de aglomerados de formação estelar em imagens de galáxias e contribua para o treinamento de sistemas de inteligência artificial para essa mesma tarefa.",
    "sub_pt": "Participe da identificação de aglomerados de formação estelar em imagens de galáxias e contribua para o treinamento de sistemas de inteligência artificial para essa mesma tarefa.",
    "sub_en": "Help identify star-forming clumps in galaxy images, and help train machines to do the same.",
    "excerpt": "Participe da identificação de aglomerados de formação estelar em imagens de galáxias e contribua para o treinamento de sistemas de inteligência artificial para essa mesma tarefa.",
    "excerpt_pt": "Participe da identificação de aglomerados de formação estelar em imagens de galáxias e contribua para o treinamento de sistemas de inteligência artificial para essa mesma tarefa.",
    "excerpt_en": "Help identify star-forming clumps in galaxy images, and help train machines to do the same.",
    "body": "<p>A comunidade científica convida o público a participar ativamente na identificação de aglomerados de formação estelar em imagens de galáxias. Esta iniciativa de ciência cidadã visa não apenas mapear esses berçários cósmicos, mas também auxiliar no treinamento de sistemas de inteligência artificial. Diante da vasta quantidade de dados astronômicos gerados por missões recentes, a colaboração humana é crucial para desenvolver um &quot;assistente digital&quot; capaz de processar e analisar essas informações de forma eficiente.</p><p>A necessidade de tal colaboração surge da imensa quantidade de dados coletados por observatórios de ponta. O telescópio espacial Euclid, uma missão da Agência Espacial Europeia (ESA) com contribuições significativas da NASA, por exemplo, já iniciou a captura de imagens de milhões de galáxias. Essas imagens, que superam a capacidade de catalogação de qualquer equipe de cientistas profissionais, oferecem visões de alta definição de galáxias aglomeradas. Elas prometem revelar detalhes intrincados sobre a estrutura interna e a interação entre esses aglomerados estelares. Além do Euclid, dados de projetos como o Sloan Digital Sky Survey e o Hyper Suprime-Cam também contribuem para este vasto acervo.</p><p>Os astrônomos têm grandes expectativas para o uso dessas imagens. Eles buscam obter novas informações sobre quais galáxias abrigam aglomerados estelares, a localização precisa desses aglomerados, e como e por que eles evoluíram ao longo do tempo cósmico. A análise detalhada dessas estruturas é fundamental para a compreensão dos processos de formação e evolução galáctica. No entanto, para transformar essa montanha de dados em conhecimento científico, a participação do público é indispensável.</p><p>A ciência cidadã oferece uma oportunidade única para entusiastas da astronomia contribuírem diretamente para descobertas científicas. Ao se engajar como &quot;explorador&quot; neste projeto, os participantes não apenas ajudam a classificar e identificar características complexas nas imagens, mas também se tornam parte de um esforço global para desvendar mistérios do universo. Essa colaboração é vital para acelerar o ritmo da pesquisa, permitindo que os cientistas se concentrem em análises mais aprofundadas e na formulação de novas teorias, enquanto a comunidade auxilia na etapa inicial de processamento e categorização de dados.</p><p>O desenvolvimento de um &quot;assistente digital&quot; baseado em aprendizado de máquina é uma estratégia inovadora para lidar com a escala sem precedentes dos dados. A inteligência artificial, treinada com a ajuda das classificações humanas, será capaz de identificar padrões e aglomerados de formação estelar de forma autônoma e em larga escala. Este processo de treinamento é iterativo, onde a precisão da máquina melhora à medida que mais dados são analisados e validados por colaboradores humanos. A sinergia entre a percepção humana e a capacidade computacional da IA é a chave para o sucesso deste empreendimento.</p><p>A busca por berçários estelares tem uma longa história na astronomia, com descobertas significativas ocorrendo desde meados do século XX, quando os astrônomos começaram a desvendar as complexidades da formação estelar em diferentes tipos de galáxias. Este projeto atual representa um avanço significativo, combinando a curiosidade humana com as mais recentes tecnologias de observação e análise de dados. A expectativa é que as informações coletadas e processadas por esta colaboração revelem não apenas a distribuição e evolução dos aglomerados estelares, mas também forneçam insights cruciais sobre a formação de estrelas e planetas em todo o universo.</p><p>A participação neste projeto de ciência cidadã é uma oportunidade valiosa para qualquer pessoa interessada em contribuir para a fronteira do conhecimento astronômico. Cada identificação e classificação realizada por um voluntário adiciona uma peça vital ao quebra-cabeça cósmico, impulsionando a pesquisa e ajudando a moldar nossa compreensão do cosmos. Ao se juntar a esta iniciativa, você não apenas ajuda a desvendar os segredos dos berçários estelares, mas também contribui para o avanço da inteligência artificial na ciência.</p>",
    ...
    "highlights": [
      "Em foco: Participe da identificação de aglomerados de formação estelar em imagens de galáxias e contribua para o treinamento de sistemas de inteligência",
      "Detalhe: Origem institucional: distinguir anúncio de evidência",
      "Leitura editorial: release institucional, útil como fonte primária, mas não como validação independente."
    ],
    "highlights_pt": [
    ...
    "highlights_en": [
      "Focus: Help identify star-forming clumps in galaxy images, and help train machines to do the same",
      "Detail: Institutional origin: separate announcement from evidence",
      "Editorial reading: institutional release, useful as a primary source but not independent validation."
    ],
    "date": "02 jun 2026",
    ...
    "realUrl": "https://www.cosmosweek.com/?article=be-a-clump-scout-and-help-reveal-secrets-of-stellar-nurseries",
    "realUrl_pt": "https://www.cosmosweek.com/?article=be-a-clump-scout-and-help-reveal-secrets-of-stellar-nurseries",
    "realUrl_en": "https://www.cosmosweek.com/?article=be-a-clump-scout-and-help-reveal-secrets-of-stellar-nurseries&lang=en",
    "shareUrl": "https://www.cosmosweek.com/noticia/be-a-clump-scout-and-help-reveal-secrets-of-stellar-nurseries/",
    "shareUrl_pt": "https://www.cosmosweek.com/noticia/be-a-clump-scout-and-help-reveal-secrets-of-stellar-nurseries/",
    "shareUrl_en": "https://www.cosmosweek.com/en/news/be-a-clump-scout-and-help-reveal-secrets-of-stellar-nurseries/",
    "canonicalUrl": "https://www.cosmosweek.com/noticia/be-a-clump-scout-and-help-reveal-secrets-of-stellar-nurseries/",
    "canonicalUrl_pt": "https://www.cosmosweek.com/noticia/be-a-clump-scout-and-help-reveal-secrets-of-stellar-nurseries/",
    "canonicalUrl_en": "https://www.cosmosweek.com/en/news/be-a-clump-scout-and-help-reveal-secrets-of-stellar-nurseries/",
    "defaultLanguage": "pt-BR",
    "availableLanguages": [
      "pt-BR",
      "en-US"
    ...
    "imageAlt": "Participe como explorador e ajude a desvendar os segredos dos berçários estelares",
    "imageAlt_pt": "Participe como explorador e ajude a desvendar os segredos dos berçários estelares",
    "imageAlt_en": "Be a Clump Scout and Help Reveal Secrets of Stellar Nurseries",
    "coverageKind": "agency",
    "coverageKindLabel": "Fonte institucional",
    "coverageKindLabel_pt": "Fonte institucional",
    "coverageKindLabel_en": "Institutional source",
  ...
  },
  {
    ...
    "cat": "Astronomia",
    "catCls": "astronomia",
    "img": "https://assets.science.nasa.gov/content/dam/science/esd/eo/images/iotd/2026/fire’s-footprint-on-santa-rosa-island/channelislandsfire_oli_20260524_th.jpg/jcr:content/renditions/cq5dam.web.1280.1280.jpeg",
    "inline_images": [
      {
        "src": "https://assets.science.nasa.gov/dynamicimage/assets/science/esd/eo/images/iotd/2026/fire’s-footprint-on-santa-rosa-island/channelislandsfire653_oli2_20260516.jpg",
        "alt": "",
        "alt_pt": "",
        "alt_en": "",
        "caption": "",
      ...
      {
        "src": "https://assets.science.nasa.gov/dynamicimage/assets/science/esd/eo/images/iotd/2026/fire’s-footprint-on-santa-rosa-island/channelislandsfire653_oli_20260524.jpg",
        "alt": "",
        "alt_pt": "",
        "alt_en": "",
        "caption": "",
      ...
      {
        "src": "https://assets.science.nasa.gov/content/dam/science/esd/eo/images/iotd/2026/fire’s-footprint-on-santa-rosa-island/channelislandsfire_oli_20260524_653_lrg.jpg",
        "alt": "",
        "alt_pt": "",
        "alt_en": "",
        "caption": "",
    ...
    "highlights_en": [
      "Focus: A wildland fire charred grassland, coastal sage scrub, and chaparral across one-third of the island, the second largest of the Channel Islands",
      "Detail: Institutional origin: separate announcement from evidence",
      "Editorial reading: institutional release, useful as a primary source but not independent validation."
    ],
    "date": "02 jun 2026",
    ...
    "realUrl": "https://www.cosmosweek.com/?article=fire-s-footprint-on-santa-rosa-island",
    "realUrl_pt": "https://www.cosmosweek.com/?article=fire-s-footprint-on-santa-rosa-island",
    "realUrl_en": "https://www.cosmosweek.com/?article=fire-s-footprint-on-santa-rosa-island&lang=en",
    "shareUrl": "https://www.cosmosweek.com/noticia/fire-s-footprint-on-santa-rosa-island/",
    "shareUrl_pt": "https://www.cosmosweek.com/noticia/fire-s-footprint-on-santa-rosa-island/",
    "shareUrl_en": "https://www.cosmosweek.com/en/news/fire-s-footprint-on-santa-rosa-island/",
    "canonicalUrl": "https://www.cosmosweek.com/noticia/fire-s-footprint-on-santa-rosa-island/",
    "canonicalUrl_pt": "https://www.cosmosweek.com/noticia/fire-s-footprint-on-santa-rosa-island/",
    "canonicalUrl_en": "https://www.cosmosweek.com/en/news/fire-s-footprint-on-santa-rosa-island/",
    "defaultLanguage": "pt-BR",
    "availableLanguages": [
      "pt-BR",
      "en-US"
    ...
    "imageAlt": "Pegada do Fogo na Ilha de Santa Rosa",
    "imageAlt_pt": "Pegada do Fogo na Ilha de Santa Rosa",
    "imageAlt_en": "Fire’s Footprint on Santa Rosa Island",
    "coverageKind": "agency",
    "coverageKindLabel": "Fonte institucional",
    "coverageKindLabel_pt": "Fonte institucional",
    "coverageKindLabel_en": "Institutional source",
  ...
  },
  {
    ...
    "highlights": [
      ...
      "Dado-chave: Vênus e Júpiter se encontram após o pôr do sol, a Lua passa na frente de Vênus, o verão começa e os tesouros do céu profundo surgem à vista",
    ...
    "highlights_en": [
      ...
      "Key detail: Venus and Jupiter meet after sunset, the Moon passes in front of Venus, summer begins, and deep-sky treasures rise into view",
  ...
  {
    "id": 6,
    "slug": "regression-on-regression-mapping-data-driven-binary-black-hole-merger-rate-fits-to-progenitor-hi",
    "cat": "Astrofísica",
    "catCls": "astrofisica",
    ...
    "video": null,
    "audio": null,
    "title": "Regressão sobre regressão: mapeando as taxas de fusão de buracos negros binários, baseadas em dados, às histórias de seus progenitores",
    "title_pt": "Regressão sobre regressão: mapeando as taxas de fusão de buracos negros binários, baseadas em dados, às histórias de seus progenitores",
    "title_en": "Regression on Regression: Mapping Data-Driven Binary Black Hole Merger Rate Fits to Progenitor Histories",
    "sub": "A taxa de fusão de buracos negros binários é determinada pela taxa de formação de seus progenitores e pela distribuição dos tempos de atraso entre a formação e a fusão, mas essas.",
    "sub_pt": "A taxa de fusão de buracos negros binários é determinada pela taxa de formação de seus progenitores e pela distribuição dos tempos de atraso entre a formação e a fusão, mas essas.",
    "sub_en": "The binary black hole merger rate is governed by the progenitor formation rate and the distribution of delay-times between formation and merger, but these functions remain poorly.",
    "excerpt": "A taxa de fusão de buracos negros binários é determinada pela taxa de formação de seus progenitores e pela distribuição dos tempos de atraso entre a formação e a fusão, mas essas funções ainda são pouco compreendidas.",
    "excerpt_pt": "A taxa de fusão de buracos negros binários é determinada pela taxa de formação de seus progenitores e pela distribuição dos tempos de atraso entre a formação e a fusão, mas essas funções ainda são pouco compreendidas.",
    "excerpt_en": "The binary black hole merger rate is governed by the progenitor formation rate and the distribution of delay-times between formation and merger, but these functions remain poorly constrained.",
    "body": "<p>A taxa de fusão de buracos negros binários é determinada pela taxa de formação de seus progenitores e pela distribuição dos tempos de atraso entre a formação e a fusão. Contudo, essas funções permanecem pouco restritas, dificultando uma compreensão completa dos mecanismos astrofísicos subjacentes. A capacidade de mapear os parâmetros de modelos baseados na física diretamente nos ajustes existentes da taxa de fusão de buracos negros binários (BBH) derivados de dados é crucial para avançar nesse campo. Essa abordagem permite uma interpretação física mais robusta de modelos populacionais flexíveis, sem a necessidade de reanalisar os dados subjacentes dos eventos de ondas gravitacionais, o que seria computacionalmente proibitivo.</p><p>Neste trabalho, introduzimos uma estrutura inovadora que denominamos &#x27;regressão sobre regressão&#x27;. Essa metodologia permite a conexão direta entre os parâmetros de modelos astrofísicos e os resultados empíricos obtidos a partir de observações. Ao invés de realizar análises complexas e demoradas dos dados brutos de ondas gravitacionais, nossa abordagem utiliza os ajustes de dados já existentes para inferir as propriedades físicas dos sistemas. Isso representa um avanço significativo, pois otimiza o processo de interpretação e validação de modelos teóricos, tornando a pesquisa mais eficiente e acessível a uma gama mais ampla de pesquisadores.</p><p>Aplicamos este método aos posteriores da taxa de fusão \\textsc{B-Spline} do Quarto Catálogo Transiente de Ondas Gravitacionais (GWTC-4). Por meio dessa aplicação, ajustamos parâmetros-chave que governam a evolução dos sistemas binários de buracos negros. Estes incluem o tempo de atraso mínimo ($τ_{\\text{min}}$), que representa o período mínimo entre a formação do progenitor e a fusão do buraco negro binário, o índice da lei de potência do tempo de atraso ($α$), que descreve a distribuição temporal dessas fusões, e os parâmetros de formação dos progenitores, que caracterizam as condições iniciais sob as quais esses sistemas se formam. A precisão desses ajustes é fundamental para refinar nossa compreensão dos processos astrofísicos envolvidos.</p><p>Um aspecto importante da nossa análise envolveu a investigação do impacto do número de pontos de ancoragem do redshift. Observamos que o aumento desses pontos de dois para quatro resultou em uma melhoria substancial na qualidade do ajuste. Especificamente, o erro mediano da soma quadrada (SSE) foi reduzido por um fator de aproximadamente 4, 5. Essa melhoria demonstra a sensibilidade do modelo à resolução dos dados de redshift e sugere que uma maior granularidade na caracterização da evolução cosmológica pode levar a inferências mais precisas sobre as taxas de fusão de buracos negros binários.</p><p>Apesar das incertezas observadas para redshifts $z\\gtrsim1$, a forma da taxa de formação de progenitores em baixos redshifts ($z$) mostrou-se notavelmente robusta. Nossos resultados indicam que essa taxa evolui de maneira mais acentuada do que a taxa global de formação de estrelas (SFR). Essa diferença sugere uma preferência por ambientes de baixa metalicidade para a formação dos progenitores de buracos negros binários, um achado que corrobora modelos teóricos que preveem a formação eficiente de buracos negros massivos em condições de menor abundância de elementos pesados. A inclinação no espaço logarítmico da taxa progenitora é aproximadamente 5, 3 vezes mais acentuada do que a SFR no intervalo de $z=0, 1$ a $z=1, 0$, fornecendo uma quantificação precisa dessa divergência.</p><p>Em última análise, nossos resultados apontam para a necessidade de desenvolver e aplicar modelos fenomenológicos mais complexos. Embora a abordagem de &#x27;regressão sobre regressão&#x27; tenha se mostrado eficaz para interpretar os ajustes existentes, a complexidade das taxas de fusão \\textsc{B-Spline} sugere que modelos mais sofisticados serão necessários para capturar plenamente todas as nuances e variações observadas. Isso implica um esforço contínuo na modelagem teórica e na análise de dados para desvendar completamente a história de formação e fusão dos buracos negros binários no universo.</p>",
    "body_pt": "<p>A taxa de fusão de buracos negros binários é determinada pela taxa de formação de seus progenitores e pela distribuição dos tempos de atraso entre a formação e a fusão. Contudo, essas funções permanecem pouco restritas, dificultando uma compreensão completa dos mecanismos astrofísicos subjacentes. A capacidade de mapear os parâmetros de modelos baseados na física diretamente nos ajustes existentes da taxa de fusão de buracos negros binários (BBH) derivados de dados é crucial para avançar nesse campo. Essa abordagem permite uma interpretação física mais robusta de modelos populacionais flexíveis, sem a necessidade de reanalisar os dados subjacentes dos eventos de ondas gravitacionais, o que seria computacionalmente proibitivo.</p><p>Neste trabalho, introduzimos uma estrutura inovadora que denominamos &#x27;regressão sobre regressão&#x27;. Essa metodologia permite a conexão direta entre os parâmetros de modelos astrofísicos e os resultados empíricos obtidos a partir de observações. Ao invés de realizar análises complexas e demoradas dos dados brutos de ondas gravitacionais, nossa abordagem utiliza os ajustes de dados já existentes para inferir as propriedades físicas dos sistemas. Isso representa um avanço significativo, pois otimiza o processo de interpretação e validação de modelos teóricos, tornando a pesquisa mais eficiente e acessível a uma gama mais ampla de pesquisadores.</p><p>Aplicamos este método aos posteriores da taxa de fusão \\textsc{B-Spline} do Quarto Catálogo Transiente de Ondas Gravitacionais (GWTC-4). Por meio dessa aplicação, ajustamos parâmetros-chave que governam a evolução dos sistemas binários de buracos negros. Estes incluem o tempo de atraso mínimo ($τ_{\\text{min}}$), que representa o período mínimo entre a formação do progenitor e a fusão do buraco negro binário, o índice da lei de potência do tempo de atraso ($α$), que descreve a distribuição temporal dessas fusões, e os parâmetros de formação dos progenitores, que caracterizam as condições iniciais sob as quais esses sistemas se formam. A precisão desses ajustes é fundamental para refinar nossa compreensão dos processos astrofísicos envolvidos.</p><p>Um aspecto importante da nossa análise envolveu a investigação do impacto do número de pontos de ancoragem do redshift. Observamos que o aumento desses pontos de dois para quatro resultou em uma melhoria substancial na qualidade do ajuste. Especificamente, o erro mediano da soma quadrada (SSE) foi reduzido por um fator de aproximadamente 4, 5. Essa melhoria demonstra a sensibilidade do modelo à resolução dos dados de redshift e sugere que uma maior granularidade na caracterização da evolução cosmológica pode levar a inferências mais precisas sobre as taxas de fusão de buracos negros binários.</p><p>Apesar das incertezas observadas para redshifts $z\\gtrsim1$, a forma da taxa de formação de progenitores em baixos redshifts ($z$) mostrou-se notavelmente robusta. Nossos resultados indicam que essa taxa evolui de maneira mais acentuada do que a taxa global de formação de estrelas (SFR). Essa diferença sugere uma preferência por ambientes de baixa metalicidade para a formação dos progenitores de buracos negros binários, um achado que corrobora modelos teóricos que preveem a formação eficiente de buracos negros massivos em condições de menor abundância de elementos pesados. A inclinação no espaço logarítmico da taxa progenitora é aproximadamente 5, 3 vezes mais acentuada do que a SFR no intervalo de $z=0, 1$ a $z=1, 0$, fornecendo uma quantificação precisa dessa divergência.</p><p>Em última análise, nossos resultados apontam para a necessidade de desenvolver e aplicar modelos fenomenológicos mais complexos. Embora a abordagem de &#x27;regressão sobre regressão&#x27; tenha se mostrado eficaz para interpretar os ajustes existentes, a complexidade das taxas de fusão \\textsc{B-Spline} sugere que modelos mais sofisticados serão necessários para capturar plenamente todas as nuances e variações observadas. Isso implica um esforço contínuo na modelagem teórica e na análise de dados para desvendar completamente a história de formação e fusão dos buracos negros binários no universo.</p>",
    "body_en": "<p>The binary black hole merger rate is governed by the progenitor formation rate and the distribution of delay-times between formation and merger, but these functions remain poorly constrained. The new analysis still awaits peer review, but it already lays out the central claim clearly.</p><p>The significance lies in astrophysics becomes persuasive only when an observed signal can be tied to a physically defensible explanation. Compact objects such as neutron stars and black holes are natural laboratories for extreme physics, but the distance and complexity of these systems make interpretation difficult without multi-wavelength coverage and careful modeling. A detection without a mechanism is only half a result. the other half comes from showing that the signal fits quantitatively inside a coherent physical picture rather than merely being consistent with a broad family of models. The binary black hole (BBH) merger rate is governed by the progenitor formation rate and the distribution of delay-times between formation and merger, but these functions remain. We introduce a framework that maps the parameters of physics-driven models directly onto existing data-driven fits of the BBH merger rate.</p><p>This ``regression on regression&#x27;&#x27; approach enables physical interpretation of flexible population models without the computational burden of reanalyzing the underlying. Applying this method to the \\textsc{B-Spline} merger-rate posteriors from the Fourth Gravitational-Wave Transient Catalog, we fit the minimum delay time ($τ_{\\text{min}}$).</p><p>Increasing the number of anchoring redshift points from two to four reduces the median sum-squared error (SSE) by a factor of $\\approx 4.5$. However, residuals reveal that the physical model does not pass through all four anchors, exposing model misspecification and demonstrating a key strength of the framework: unlike.</p><p>Despite uncertainties at $z\\gtrsim1$, the shape of the progenitor formation rate at low-$z$ is robust and evolves more steeply than the global star formation rate (SFR). Specifically, the log-space slope of the progenitor rate is $\\approx 5.3$ times steeper than the SFR between $z=0.1$ and $z=1.0$.</p><p>The broader interest lies in turning an observational clue into something that can be weighed against competing models of the underlying physics. Astrophysics does not have the luxury of controlled experiments; everything is inferred from radiation that traveled across cosmic distances under conditions that cannot be reproduced in a terrestrial laboratory. This makes the interpretation chain longer and more uncertain than in bench science, but it also means that a well-constrained measurement of an extreme object carries theoretical information that no earthbound experiment can provide.</p><p>Ultimately, a more complex phenomenological model is required to match the \\textsc{B-Spline} merger rates. Both individuals and organizations that work with arXivLabs have embraced and accepted our values of openness, community, excellence, and user data privacy.</p><p>Because this is still a preprint, the result should be read with genuine interest and proportionate caution. Peer review is not a guarantee of correctness, but it is a process that forces authors to respond to technical criticism from specialists who have no stake in a particular outcome. Preprints that survive that process, often with substantive revisions, emerge with a stronger evidential base than the version that first appeared. Until that stage is complete, the responsible reading keeps uncertainty explicitly visible rather than treating the claims as established findings.</p><p>The next step is to see whether independent datasets and physical modeling converge on the same interpretation. Multi-wavelength follow-up, combining X-ray, radio and optical data where possible, is typically what separates a compelling detection from a robust physical characterization. In high-energy astrophysics, results that initially looked definitive have been revised when data from a second messenger arrived; the current result should be read with that history in mind. Until peer review and independent follow-up address those open questions, skepticism is not a failure of appreciation for the work; it is part of how science decides what to keep.</p><p class=\"art-source\"><a href=\"https://arxiv.org/abs/2606.02431v1\" target=\"_blank\" rel=\"noopener noreferrer\">Source</a></p>",
    "highlights": [
      "Em foco: A taxa de fusão de buracos negros binários é determinada pela taxa de formação de seus progenitores e pela distribuição dos tempos de atraso entre a",
    ...
    "read_pt": "4 min de leitura",
    "read_en": "4 min read",
    "publishedIso": "2026-06-01T16:06:10+00:00",
    "lastModifiedIso": "2026-06-02T19:19:35+00:00",
    ...
    "keywords": [
      ...
      "mapeando a taxa de fusão de buracos negros binários baseada em dados se ajusta às histórias dos progenitores"
    ],
    "keywords_pt": [
      "Astrofísica",
      "arXiv High Energy Astrophysics",
    ...
    "keywords_en": [
      ...
      "data-driven mapping of binary black hole merger rate fits progenitor histories"
    ],
    "srcUrl": "https://arxiv.org/abs/2606.02431v1",
    "realUrl": "https://www.cosmosweek.com/?article=regression-on-regression-mapping-data-driven-binary-black-hole-merger-rate-fits-to-progenitor-hi",
    "realUrl_pt": "https://www.cosmosweek.com/?article=regression-on-regression-mapping-data-driven-binary-black-hole-merger-rate-fits-to-progenitor-hi",
    "realUrl_en": "https://www.cosmosweek.com/?article=regression-on-regression-mapping-data-driven-binary-black-hole-merger-rate-fits-to-progenitor-hi&lang=en",
    "shareUrl": "https://www.cosmosweek.com/noticia/regression-on-regression-mapping-data-driven-binary-black-hole-merger-rate-fits-to-progenitor-hi/",
    "shareUrl_pt": "https://www.cosmosweek.com/noticia/regression-on-regression-mapping-data-driven-binary-black-hole-merger-rate-fits-to-progenitor-hi/",
    "shareUrl_en": "https://www.cosmosweek.com/en/news/regression-on-regression-mapping-data-driven-binary-black-hole-merger-rate-fits-to-progenitor-hi/",
    "canonicalUrl": "https://www.cosmosweek.com/noticia/regression-on-regression-mapping-data-driven-binary-black-hole-merger-rate-fits-to-progenitor-hi/",
    "canonicalUrl_pt": "https://www.cosmosweek.com/noticia/regression-on-regression-mapping-data-driven-binary-black-hole-merger-rate-fits-to-progenitor-hi/",
    "canonicalUrl_en": "https://www.cosmosweek.com/en/news/regression-on-regression-mapping-data-driven-binary-black-hole-merger-rate-fits-to-progenitor-hi/",
    "defaultLanguage": "pt-BR",
    "availableLanguages": [
      "pt-BR",
      "en-US"
    ...
    "imageAlt": "Regressão sobre regressão: mapeando as taxas de fusão de buracos negros binários, baseadas em dados, às histórias de seus progenitores",
    "imageAlt_pt": "Regressão sobre regressão: mapeando as taxas de fusão de buracos negros binários, baseadas em dados, às histórias de seus progenitores",
    "imageAlt_en": "Regression on Regression: Mapping Data-Driven Binary Black Hole Merger Rate Fits to Progenitor Histories",
  ...
  {
    "id": 7,
    "slug": "csst-large-scale-structure-analysis-pipeline-iv-cosmic-voids-identified-from-galaxy-group-sample",
    "cat": "Cosmologia",
    "catCls": "cosmologia",
    ...
    "read_pt": "4 min de leitura",
    "read_en": "4 min read",
    "publishedIso": "2026-06-01T08:45:59+00:00",
    "lastModifiedIso": "2026-06-02T19:19:35+00:00",
    ...
    "keywords": [
      ...
      "arXiv Cosmology",
      "Cosmos Week",
      "Pipeline de análise de estrutura em grande escala CSST",
      "IV. Vazios Cósmicos Identificados em Amostras de Grupos de Galáxias como Sondas da Estrutura em Grande Escala"
    ],
    "keywords_pt": [
      "Cosmologia",
      "arXiv Cosmology",
    ...
    "keywords_en": [
      ...
      "IV. Cosmic Voids Identified in Samples of Galaxy Groups as Probes of Large-Scale Structure"
    ],
    "srcUrl": "https://arxiv.org/abs/2606.01907v1",
    "realUrl": "https://www.cosmosweek.com/?article=csst-large-scale-structure-analysis-pipeline-iv-cosmic-voids-identified-from-galaxy-group-sample",
    "realUrl_pt": "https://www.cosmosweek.com/?article=csst-large-scale-structure-analysis-pipeline-iv-cosmic-voids-identified-from-galaxy-group-sample",
    "realUrl_en": "https://www.cosmosweek.com/?article=csst-large-scale-structure-analysis-pipeline-iv-cosmic-voids-identified-from-galaxy-group-sample&lang=en",
    "shareUrl": "https://www.cosmosweek.com/noticia/csst-large-scale-structure-analysis-pipeline-iv-cosmic-voids-identified-from-galaxy-group-sample/",
    "shareUrl_pt": "https://www.cosmosweek.com/noticia/csst-large-scale-structure-analysis-pipeline-iv-cosmic-voids-identified-from-galaxy-group-sample/",
    "shareUrl_en": "https://www.cosmosweek.com/en/news/csst-large-scale-structure-analysis-pipeline-iv-cosmic-voids-identified-from-galaxy-group-sample/",
    "canonicalUrl": "https://www.cosmosweek.com/noticia/csst-large-scale-structure-analysis-pipeline-iv-cosmic-voids-identified-from-galaxy-group-sample/",
    "canonicalUrl_pt": "https://www.cosmosweek.com/noticia/csst-large-scale-structure-analysis-pipeline-iv-cosmic-voids-identified-from-galaxy-group-sample/",
    "canonicalUrl_en": "https://www.cosmosweek.com/en/news/csst-large-scale-structure-analysis-pipeline-iv-cosmic-voids-identified-from-galaxy-group-sample/",
    "defaultLanguage": "pt-BR",
    "availableLanguages": [
      "pt-BR",
      "en-US"
    ...
    "imageAlt": "Pipeline de Análise de Estrutura em Grande Escala do CSST: IV. Vazios Cósmicos Identificados em Amostras de Grupos de Galáxias como Sondas da Estrutura em Grande Escala",
    "imageAlt_pt": "Pipeline de Análise de Estrutura em Grande Escala do CSST: IV. Vazios Cósmicos Identificados em Amostras de Grupos de Galáxias como Sondas da Estrutura em Grande Escala",
    "imageAlt_en": "CSST large-scale structure analysis pipeline: IV. Cosmic Voids Identified from Galaxy Group Samples as Probes of the Large-scale Structure",
    "coverageKind": "preprint",
    "coverageKindLabel": "Preprint",
    "coverageKindLabel_pt": "Preprint",
    "coverageKindLabel_en": "Preprint",
  ...
  },
  {
    ...
    "highlights": [
      ...
      "Dado-chave: O estudo apoiado pelo NIH é o maior já realizado para comparar intervenções com fluidos para prevenir danos renais graves em crianças tratadas de",
      "Origem institucional: distinguir anúncio de evidência."
    ],
    "highlights_pt": [
      "Ponto central: O estudo apoiado pelo NIH é o maior já realizado para comparar intervenções com fluidos para prevenir danos renais graves em crianças tratadas de.",
