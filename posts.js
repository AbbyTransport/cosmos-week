...
window.postsData = [
  ...
  },
  {
    ...
    "highlights": [
      "Em foco: Para a reserva Pleasant Point Passamaquoddy, ou Sipayik, o oceano sempre foi um professor",
      "Detalhe: Origem institucional: distinguir anúncio de evidência",
      "Leitura editorial: release institucional, útil como fonte primária, mas não como validação independente."
    ],
    "highlights_pt": [
  ...
  },
  {
    ...
    "highlights": [
      "Em foco: Observações de polarização em comprimentos de onda milimétricos podem ser usadas para estudar plasma magnetizado em jatos lançados por buracos negros",
  ...
  {
    "id": 5,
    "slug": "present-day-cosmic-acceleration-from-sdss-and-desi-bao-a-call-for-finer-tomography-of-the-desi-b",
    "cat": "Cosmologia",
    "catCls": "cosmologia",
    ...
    "video": null,
    "audio": null,
    "title": "Aceleração cósmica atual do SDSS e DESI BAO: um apelo para uma tomografia mais refinada do DESI Bright Galaxy Survey",
    "title_pt": "Aceleração cósmica atual do SDSS e DESI BAO: um apelo para uma tomografia mais refinada do DESI Bright Galaxy Survey",
    "title_en": "Present Day Cosmic Acceleration from SDSS and DESI BAO: A Call for Finer Tomography of the DESI Bright Galaxy Survey",
    "sub": "O Data Release ~ 2 da colaboração DESI fornece medições de oscilação acústica bárion de mais de 14 milhões de galáxias e quasares, e uma análise conjunta de supernovas DESI BAO.",
    "sub_pt": "O Data Release ~ 2 da colaboração DESI fornece medições de oscilação acústica bárion de mais de 14 milhões de galáxias e quasares, e uma análise conjunta de supernovas DESI BAO.",
    "sub_en": "The DESI collaboration's Data Release~2 provides baryon acoustic oscillation measurements from over 14 million galaxies and quasars, and a joint analysis of DESI BAO, CMB, and.",
    "excerpt": "O Data Release ~ 2 da colaboração DESI fornece medições de oscilação acústica bárion de mais de 14 milhões de galáxias e quasares, e uma análise conjunta de supernovas DESI BAO, CMB e Tipo ~ Ia revela uma preferência pela escuridão que evolui no tempo.",
    "excerpt_pt": "O Data Release ~ 2 da colaboração DESI fornece medições de oscilação acústica bárion de mais de 14 milhões de galáxias e quasares, e uma análise conjunta de supernovas DESI BAO, CMB e Tipo ~ Ia revela uma preferência pela escuridão que evolui no tempo.",
    "excerpt_en": "The DESI collaboration's Data Release~2 provides baryon acoustic oscillation measurements from over 14 million galaxies and quasars, and a joint analysis of DESI BAO, CMB, and Type~Ia Supernovae reveals a preference for time-evolving dark.",
    "body": "<p>O Data Release ~ 2 da colaboração DESI fornece medições de oscilação acústica bárion de mais de 14 milhões de galáxias e quasares, e uma análise conjunta de supernovas DESI BAO, CMB e Tipo ~ Ia revela uma preferência pela escuridão que evolui no tempo.</p><p>O Data Release ~ 2 (DR2) da colaboração DESI fornece medições de oscilação acústica bárion (BAO) de mais de 14 milhões de galáxias e quasares, e uma análise conjunta de DESI BAO, CMB e Supernovas Tipo ~ Ia revela uma preferência pela energia escura que evolui no tempo. Quantificamos essa preferência em relação ao SDSS BAO e relatamos três resultados principais.</p><p>Primeiro, DESI+Planck favorece um $w_0 = -0, 41^{+0, 21}_{-0, 22}$ mais alto do que SDSS+Planck ($w_0 = -0, 71^{+0, 19}_{-0, 18}$). Em segundo lugar, DESI+Planck prefere um parâmetro de desaceleração cuja mediana esteja no lado da desaceleração ($q_0 = 0, 10^{+0, 21}_{-0, 23}$, consistente com $q_0 = 0$ em $1σ$), enquanto SDSS+Planck prefere um valor negativo ($q_0 =-0, 22^{+0, 20}_{-0, 21}$) indicando expansão.</p><p>Terceiro, argumentamos que esta discrepância surge da diferença no menor redshift efetivo investigado por cada pesquisa: $z_{\\rm eff} \\approx 0, 295$ para DESI versus $z_{\\rm eff} \\approx 0, 15$ para SDSS. Como quantidades atuais, $w_0$ e $q_0$ são sensíveis ao redshift mais baixo sondado: dados próximos a $z = 0$ os restringem diretamente, enquanto dados de redshift mais alto dependem da extrapolação da parametrização da energia escura (aqui CPL).</p><p>Atingindo $z_{\\rm eff} \\aproximadamente 0, 15$, o SDSS restringe $w_0$ e $q_0$ de forma baseada em dados, encontrando consistência com $w_0 = -1$ e aceleração. Limitado a $z_{\\rm eff} \\gtrsim 0, 295$, o DESI depende mais de extrapolação, gerando $q_0$ positivo e $w_0$ bem acima de $-1$.</p><p>Adicionar a amostra de supernova Pantheon+ restaura informações de baixo redshift, retornando $q_0$ para valores negativos e reduzindo a tensão com $Λ\\text{CDM}$.</p><p class=\"art-source\"><a href=\"https://arxiv.org/abs/2607.07348v1\" target=\"_blank\" rel=\"noopener noreferrer\">Fonte</a></p>",
    "body_pt": "<p>O Data Release ~ 2 da colaboração DESI fornece medições de oscilação acústica bárion de mais de 14 milhões de galáxias e quasares, e uma análise conjunta de supernovas DESI BAO, CMB e Tipo ~ Ia revela uma preferência pela escuridão que evolui no tempo.</p><p>O Data Release ~ 2 (DR2) da colaboração DESI fornece medições de oscilação acústica bárion (BAO) de mais de 14 milhões de galáxias e quasares, e uma análise conjunta de DESI BAO, CMB e Supernovas Tipo ~ Ia revela uma preferência pela energia escura que evolui no tempo. Quantificamos essa preferência em relação ao SDSS BAO e relatamos três resultados principais.</p><p>Primeiro, DESI+Planck favorece um $w_0 = -0, 41^{+0, 21}_{-0, 22}$ mais alto do que SDSS+Planck ($w_0 = -0, 71^{+0, 19}_{-0, 18}$). Em segundo lugar, DESI+Planck prefere um parâmetro de desaceleração cuja mediana esteja no lado da desaceleração ($q_0 = 0, 10^{+0, 21}_{-0, 23}$, consistente com $q_0 = 0$ em $1σ$), enquanto SDSS+Planck prefere um valor negativo ($q_0 =-0, 22^{+0, 20}_{-0, 21}$) indicando expansão.</p><p>Terceiro, argumentamos que esta discrepância surge da diferença no menor redshift efetivo investigado por cada pesquisa: $z_{\\rm eff} \\approx 0, 295$ para DESI versus $z_{\\rm eff} \\approx 0, 15$ para SDSS. Como quantidades atuais, $w_0$ e $q_0$ são sensíveis ao redshift mais baixo sondado: dados próximos a $z = 0$ os restringem diretamente, enquanto dados de redshift mais alto dependem da extrapolação da parametrização da energia escura (aqui CPL).</p><p>Atingindo $z_{\\rm eff} \\aproximadamente 0, 15$, o SDSS restringe $w_0$ e $q_0$ de forma baseada em dados, encontrando consistência com $w_0 = -1$ e aceleração. Limitado a $z_{\\rm eff} \\gtrsim 0, 295$, o DESI depende mais de extrapolação, gerando $q_0$ positivo e $w_0$ bem acima de $-1$.</p><p>Adicionar a amostra de supernova Pantheon+ restaura informações de baixo redshift, retornando $q_0$ para valores negativos e reduzindo a tensão com $Λ\\text{CDM}$.</p><p class=\"art-source\"><a href=\"https://arxiv.org/abs/2607.07348v1\" target=\"_blank\" rel=\"noopener noreferrer\">Fonte</a></p>",
    "body_en": "<p>The DESI collaboration&#x27;s Data Release~2 provides baryon acoustic oscillation measurements from over 14 million galaxies and quasars, and a joint analysis of DESI BAO, CMB, and Type~Ia Supernovae reveals a preference for time-evolving dark. The new analysis still awaits peer review, but it already lays out the central claim clearly.</p><p>That matters because cosmology operates at the edge of what current instruments can measure, where systematic errors and model assumptions are never trivial. Small discrepancies between independent measurements have historically pointed toward missing physics rather than simple calibration errors, and the ongoing tension in the Hubble constant is a live example of how a persistent disagreement between methods can reshape the theoretical landscape. Each new dataset that approaches this territory with independent systematics adds real information to a problem that has resisted easy resolution for more than a decade. The DESI collaboration&#x27;s Data Release~2 (DR2) provides baryon acoustic oscillation (BAO) measurements from over 14 million galaxies and quasars, and a joint analysis of DESI BAO. We quantify this preference relative to SDSS BAO and report three key results.</p><p>First, DESI+Planck favors a higher $w_0 = -0.41^{+0.21}_{-0.22}$ than SDSS+Planck ($w_0 = -0.71^{+0.19}_{-0.18}$). Second, DESI+Planck prefers a deceleration parameter whose median lies on the decelerating side ($q_0 = 0.10^{+0.21}_{-0.</p><p>As present-day quantities, $w_0$ and $q_0$ are sensitive to the lowest probed redshift: data near $z = 0$ constrain them directly, whereas higher-redshift data rely on. Reaching $z_{\\rm eff} \\approx 0.15$, SDSS constrains $w_0$ and $q_0$ in a data-driven way, finding consistency with $w_0 = -1$ and acceleration.</p><p>Limited to $z_{\\rm eff} \\gtrsim 0.295$, DESI relies more on extrapolation, driving $q_0$ positive and $w_0$ well above $-1$. Adding the Pantheon+ supernova sample restores low-redshift information, returning $q_0$ to negative values and reducing tension with $Λ\\text{CDM}$.</p><p>The relevance goes beyond one dataset because even small shifts in measured parameters can matter when the field is testing the limits of the standard cosmological model. The Lambda-CDM framework describes the observable universe with remarkable economy, but its success rests on two components, dark matter and dark energy, whose physical nature remains entirely unknown. Any credible measurement that tightens or loosens the constraints on those components moves the entire theoretical enterprise forward, regardless of whether the immediate result looks dramatic on its own terms.</p><p>We therefore propose that the apparent DESI preference for a non-accelerating present epoch in the BAO+CMB combination reflects redshift sampling rather than new physics, and. Both individuals and organizations that work with arXivLabs have embraced and accepted our values of openness, community, excellence, and user data privacy.</p><p>Because this is still a preprint, the result should be read with genuine interest and proportionate caution. Peer review is not a guarantee of correctness, but it is a process that forces authors to respond to technical criticism from specialists who have no stake in a particular outcome. Preprints that survive that process, often with substantive revisions, emerge with a stronger evidential base than the version that first appeared. Until that stage is complete, the responsible reading keeps uncertainty explicitly visible rather than treating the claims as established findings.</p><p>The next step is to see whether the effect survives when independent surveys, different calibration strategies and tighter control of systematic uncertainties enter the picture. Programmes such as Euclid, DESI and the Rubin Observatory will deliver datasets over the next several years that cover the same parameter space with largely independent methods. If the current signal persists through those tests, its theoretical implications will become impossible to set aside. Until peer review and independent follow-up address those open questions, skepticism is not a failure of appreciation for the work; it is part of how science decides what to keep.</p><p class=\"art-source\"><a href=\"https://arxiv.org/abs/2607.07348v1\" target=\"_blank\" rel=\"noopener noreferrer\">Source</a></p>",
    "highlights": [
    ...
    "read_pt": "4 min de leitura",
    "read_en": "4 min read",
    "publishedIso": "2026-07-08T12:38:37+00:00",
    "lastModifiedIso": "2026-07-09T17:47:29+00:00",
    ...
    "keywords": [
      ...
      "arXiv Cosmology",
      "Cosmos Week",
      "Aceleração cósmica atual do SDSS e DESI BAO",
      "um apelo para uma tomografia mais refinada do DESI Bright Galaxy Survey"
    ],
    "keywords_pt": [
      "Cosmologia",
      "arXiv Cosmology",
    ...
    "keywords_en": [
      ...
      "arXiv Cosmology",
      "Cosmos Week",
      "Current cosmic acceleration of SDSS and DESI BAO",
      "a call for more refined tomography from the DESI Bright Galaxy Survey"
    ],
    "srcUrl": "https://arxiv.org/abs/2607.07348v1",
    "realUrl": "https://www.cosmosweek.com/?article=present-day-cosmic-acceleration-from-sdss-and-desi-bao-a-call-for-finer-tomography-of-the-desi-b",
    "realUrl_pt": "https://www.cosmosweek.com/?article=present-day-cosmic-acceleration-from-sdss-and-desi-bao-a-call-for-finer-tomography-of-the-desi-b",
    "realUrl_en": "https://www.cosmosweek.com/?article=present-day-cosmic-acceleration-from-sdss-and-desi-bao-a-call-for-finer-tomography-of-the-desi-b&lang=en",
    "shareUrl": "https://www.cosmosweek.com/noticia/present-day-cosmic-acceleration-from-sdss-and-desi-bao-a-call-for-finer-tomography-of-the-desi-b/",
    "shareUrl_pt": "https://www.cosmosweek.com/noticia/present-day-cosmic-acceleration-from-sdss-and-desi-bao-a-call-for-finer-tomography-of-the-desi-b/",
    "shareUrl_en": "https://www.cosmosweek.com/en/news/present-day-cosmic-acceleration-from-sdss-and-desi-bao-a-call-for-finer-tomography-of-the-desi-b/",
    "canonicalUrl": "https://www.cosmosweek.com/noticia/present-day-cosmic-acceleration-from-sdss-and-desi-bao-a-call-for-finer-tomography-of-the-desi-b/",
    "canonicalUrl_pt": "https://www.cosmosweek.com/noticia/present-day-cosmic-acceleration-from-sdss-and-desi-bao-a-call-for-finer-tomography-of-the-desi-b/",
    "canonicalUrl_en": "https://www.cosmosweek.com/en/news/present-day-cosmic-acceleration-from-sdss-and-desi-bao-a-call-for-finer-tomography-of-the-desi-b/",
    "defaultLanguage": "pt-BR",
    "availableLanguages": [
      "pt-BR",
      "en-US"
    ...
    "imageAlt": "Aceleração cósmica atual do SDSS e DESI BAO: um apelo para uma tomografia mais refinada do DESI Bright Galaxy Survey",
    "imageAlt_pt": "Aceleração cósmica atual do SDSS e DESI BAO: um apelo para uma tomografia mais refinada do DESI Bright Galaxy Survey",
    "imageAlt_en": "Present Day Cosmic Acceleration from SDSS and DESI BAO: A Call for Finer Tomography of the DESI Bright Galaxy Survey",
    "coverageKind": "preprint",
    "coverageKindLabel": "Preprint",
    "coverageKindLabel_pt": "Preprint",
    "coverageKindLabel_en": "Preprint",
  ...
  },
  {
    ...
    "cat": "Física",
    "catCls": "fisica",
    "img": "https://assets.science.nasa.gov/content/dam/science/psd/planetary-science-division/2026/nh-hibernation_wakeUp_062426.jpg/jcr:content/renditions/cq5dam.web.1280.1280.jpeg",
    "inline_images": [],
    "video": null,
    "audio": null,
    ...
    "body": "<p>Após o seu período de hibernação mais longo de quase um ano, a sonda New Horizons da NASA emergiu com boa saúde e está pronta para começar a transmitir dados científicos recolhidos na distante Cintura de Kuiper, muito além de Plutão. 3 min de leitura A nave espacial New Horizons da NASA acorda da hibernação com boa saúde Após o seu período de hibernação mais longo de quase um ano, a nave espacial New Horizons da NASA emergiu com boa saúde e está pronta para começar a transmitir dados científicos recolhidos.</p><p>A partir da esquerda, os controladores de voo Mark Lahr e Josh Albers, e a gerente de operações da missão, Alice Bowman, monitoram a transmissão de telemetria da espaçonave New Horizons da NASA para o centro de operações da missão no Laboratório de Física Aplicada Johns Hopkins. Agora, a aproximadamente 9, 5 mil milhões de quilómetros da Terra, a New Horizons está pronta para começar a transmitir dados científicos depois de ter despertado do seu período de hibernação mais longo de sempre, de quase um ano.</p><p>NASA/Johns Hopkins APL/SwRI/Justin Gladden Em 23 de junho, os controladores de vôo do Laboratório de Física Aplicada (APL) Johns Hopkins em Laurel, Maryland, confirmaram que a New Horizons, agindo com base em comandos armazenados vinculados ao seu computador principal em julho.</p><p>Com a sonda agora a aproximadamente 9, 5 mil milhões de quilómetros da Terra, os sinais de rádio que transportam essa confirmação demoraram cerca de 8 horas e 52 minutos a chegar ao Centro de Operações da Missão APL através da estação Deep Space Network da NASA, perto de Madrid.</p><p>Para obter mais informações sobre a missão New Horizons da NASA, visite: https: //science. nasa. gov/mission/new-horizons/ Continue explorando Descubra mais tópicos da NASA New Horizons Kuiper Belt Asteróides, cometas e meteoros Nosso sistema solar. A espaçonave New Horizons da NASA emergiu com boa saúde e está pronta para começar a transmitir Artigo Após seu período de hibernação mais longo de quase um ano.</p><p>A sonda New Horizons da NASA emergiu com boa saúde e está pronta para começar a transmitir dados científicos recolhidos na distante Cintura de Kuiper, muito além de Plutão.</p><p class=\"art-source\"><a href=\"https://science.nasa.gov/missions/new-horizons/nasas-new-horizons-spacecraft-wakes-from-hibernation-in-good-health/\" target=\"_blank\" rel=\"noopener noreferrer\">Fonte</a></p>",
    ...
    "highlights": [
      "Em foco: Após o seu período de hibernação mais longo de quase um ano, a sonda New Horizons da NASA emergiu com boa saúde e está pronta para começar a",
      "Detalhe: Origem institucional: distinguir anúncio de evidência",
      "Leitura editorial: release institucional, útil como fonte primária, mas não como validação independente."
    ],
    "highlights_pt": [
    ...
    "lastModifiedIso": "2026-07-08T17:16:19+00:00",
    "source": "NASA News Releases",
    "sourceDomain": "science. nasa. gov",
    "sourceType": "agency",
    "sourceTypeLabel": "Fonte institucional",
    ...
    "realUrl": "https://www.cosmosweek.com/?article=nasa-s-new-horizons-spacecraft-wakes-from-hibernation-in-good-health",
    "realUrl_pt": "https://www.cosmosweek.com/?article=nasa-s-new-horizons-spacecraft-wakes-from-hibernation-in-good-health",
    "realUrl_en": "https://www.cosmosweek.com/?article=nasa-s-new-horizons-spacecraft-wakes-from-hibernation-in-good-health&lang=en",
    "shareUrl": "https://www.cosmosweek.com/noticia/nasa-s-new-horizons-spacecraft-wakes-from-hibernation-in-good-health/",
    "shareUrl_pt": "https://www.cosmosweek.com/noticia/nasa-s-new-horizons-spacecraft-wakes-from-hibernation-in-good-health/",
    "shareUrl_en": "https://www.cosmosweek.com/en/news/nasa-s-new-horizons-spacecraft-wakes-from-hibernation-in-good-health/",
    "canonicalUrl": "https://www.cosmosweek.com/noticia/nasa-s-new-horizons-spacecraft-wakes-from-hibernation-in-good-health/",
    "canonicalUrl_pt": "https://www.cosmosweek.com/noticia/nasa-s-new-horizons-spacecraft-wakes-from-hibernation-in-good-health/",
    "canonicalUrl_en": "https://www.cosmosweek.com/en/news/nasa-s-new-horizons-spacecraft-wakes-from-hibernation-in-good-health/",
    "defaultLanguage": "pt-BR",
    "availableLanguages": [
      "pt-BR",
      "en-US"
    ...
    "imageAlt": "A nave espacial New Horizons da NASA acorda da hibernação com boa saúde",
    "imageAlt_pt": "A nave espacial New Horizons da NASA acorda da hibernação com boa saúde",
    "imageAlt_en": "NASA’s New Horizons Spacecraft Wakes from Hibernation in Good Health",
    "coverageKind": "agency",
    "coverageKindLabel": "Fonte institucional",
    "coverageKindLabel_pt": "Fonte institucional",
    "coverageKindLabel_en": "Institutional source",
  ...
  },
  {
    ...
    "highlights": [
      ...
      "Dado-chave: Ao longo dos anos, os astronautas a bordo da Estação Espacial Internacional fotografaram várias cidades que sediaram a Copa do Mundo FIFA de 2026",
      "Origem institucional: distinguir anúncio de evidência."
    ],
    "highlights_pt": [
      "Ponto central: Ao longo dos anos, os astronautas a bordo da Estação Espacial Internacional fotografaram várias cidades que sediaram a Copa do Mundo FIFA de 2026.",
    ...
    "highlights_en": [
      ...
      "Key detail: Over the years, astronauts aboard the International Space Station have photographed several of the cities hosting the 2026 FIFA World Cup",
      "Institutional origin: separate announcement from evidence."
    ],
    "date": "07 jul 2026",
    "date_pt": "07 jul 2026",
