...
window.postsData = [
  {
    ...
    "lastModifiedIso": "2026-09-19T18:14:53+00:00",
  ...
  },
  {
    ...
    "body": "<p>Os registros de temperatura caíram no centro e no sul dos EUA à medida que o equinócio de outono se aproximava. Artigo Sentindo o calor oculto dos poloneses 3 min de leitura Novas animações da missão PREFIRE da NASA revelam dois anos de oscilações sazonais de temperatura no Ártico e na Antártica.</p><p>Imagem do dia do Observatório da Terra O Observatório da Terra da NASA traz para você a Terra, todos os dias, com histórias detalhadas e imagens impressionantes. Produziu um calor fora de época e, em alguns lugares, recorde em 15 de setembro de 2026, conforme mostrado neste mapa de temperaturas do ar modeladas do GEOS (Goddard Earth Observing System).</p><p>Observatório da Terra da NASA/Michala Garrison Embora o calendário indicasse que o verão astronômico estava acabando, uma parte do centro-sul dos Estados Unidos estava sufocante sob uma cúpula de calor em meados de setembro de 2026. Foi produzido combinando observações de satélite com temperaturas previstas por uma versão do modelo GEOS (Goddard Earth Observing System), que utiliza equações matemáticas para representar processos físicos na atmosfera.</p><p>Vários locais estabeleceram novos recordes diários de altas temperaturas em 15 de setembro. O período de temperaturas fora de época segue-se ao período mais quente de junho a agosto nos Estados Unidos contíguos, em um recorde de 132 anos, de acordo com a NOAA.</p><p>Imagem do NASA Earth Observatory por Michala Garrison, usando dados GEOS-FP do Global Modeling and Assimilation Office da NASA GSFC. Você também pode estar interessado em: Mantenha-se atualizado com o conteúdo mais recente da NASA enquanto exploramos o universo e descobrimos mais sobre nosso planeta natal.</p><p>Artigo Sentindo o calor oculto dos poloneses 3 min de leitura Novas animações da missão PREFIRE da NASA revelam dois anos de oscilações sazonais de temperatura no Ártico e na Antártida.</p><p class=\"art-source\"><a href=\"https://science.nasa.gov/earth/earth-observatory/summer-goes-out-with-a-heat-dome/\" target=\"_blank\" rel=\"noopener noreferrer\">Fonte</a></p>",
    ...
    "lastModifiedIso": "2026-09-17T19:18:30+00:00",
    "source": "NASA News Releases",
    "sourceDomain": "science. nasa. gov",
    "sourceType": "agency",
    "sourceTypeLabel": "Fonte institucional",
  ...
  },
  {
    ...
    "lastModifiedIso": "2026-09-16T19:07:11+00:00",
    "source": "NASA News Releases",
    "sourceDomain": "science. nasa. gov",
    "sourceType": "agency",
    "sourceTypeLabel": "Fonte institucional",
