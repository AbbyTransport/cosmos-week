...
window.postsData = [
  ...
  {
    "id": 5,
    "slug": "galaxy-clusters-selected-via-the-sunyaev-zel-dovich-effect-in-5-year-data-from-the-spt-3g-main-s",
    "cat": "Cosmologia",
    "catCls": "cosmologia",
    ...
    "video": null,
    "audio": null,
    "title": "Aglomerados de galáxias selecionados através do efeito Sunyaev-Zel'dovich em dados de 5 anos da pesquisa principal SPT-3G",
    "title_pt": "Aglomerados de galáxias selecionados através do efeito Sunyaev-Zel'dovich em dados de 5 anos da pesquisa principal SPT-3G",
    "title_en": "Galaxy Clusters Selected via the Sunyaev-Zel'dovich Effect in 5 year data from the SPT-3G Main Survey",
    "sub": "Relatamos um novo catálogo de aglomerados de galáxias, selecionado usando o efeito térmico Sunyaev-Zel'dovich, a partir de 5 anos de observações do campo principal do SPT-3G.",
    "sub_pt": "Relatamos um novo catálogo de aglomerados de galáxias, selecionado usando o efeito térmico Sunyaev-Zel'dovich, a partir de 5 anos de observações do campo principal do SPT-3G.",
    "sub_en": "We report a new galaxy cluster catalog, selected using the thermal Sunyaev-Zel'dovich effect, from 5 years of observations of the SPT-3G Main field.",
    "excerpt": "Relatamos um novo catálogo de aglomerados de galáxias, selecionado usando o efeito térmico Sunyaev-Zel'dovich, a partir de 5 anos de observações do campo principal do SPT-3G.",
    "excerpt_pt": "Relatamos um novo catálogo de aglomerados de galáxias, selecionado usando o efeito térmico Sunyaev-Zel'dovich, a partir de 5 anos de observações do campo principal do SPT-3G.",
    "excerpt_en": "We report a new galaxy cluster catalog, selected using the thermal Sunyaev-Zel'dovich effect, from 5 years of observations of the SPT-3G Main field.",
    "body": "<p>Relatamos um novo catálogo de aglomerados de galáxias, selecionado usando o efeito térmico Sunyaev-Zel&#x27;dovich (SZ), a partir de 5 anos de observações do campo principal do SPT-3G. Este trabalho apresenta uma compilação abrangente de aglomerados identificados por meio de dados de alta resolução, contribuindo significativamente para o estudo da formação e evolução de estruturas cósmicas. A metodologia empregada garante uma seleção robusta, permitindo investigações detalhadas sobre as propriedades desses sistemas massivos no universo.</p><p>Os dados utilizados foram extraídos de observações com resolução de minuto de arco, apresentando níveis de ruído branco de 3, 2, 2, 5 e 8, 9 $\\mu$K-arcmin nas frequências de 95, 150 e 220 GHz, respectivamente. A amostra resultante compreende 8.892 candidatos a aglomerados, detectados com uma significância superior a $\\xi=4$. A pureza esperada para esta amostra é de mais de 82%. Adicionalmente, por meio da análise de dados ópticos e infravermelhos complementares, conseguimos confirmar 7.190 desses candidatos como aglomerados de galáxias, solidificando a confiabilidade do catálogo.</p><p>A amostra de aglomerados abrange um vasto intervalo de massa, com valores a partir de $7, 9 \\times 10^{13}$ $M_\\\\odot/h_{70}$. Dentro deste catálogo, identificamos 271 aglomerados localizados em redshifts superiores a $z&gt;1, 5$, o que os torna objetos valiosos para o estudo da evolução de aglomerados em épocas cosmológicas mais remotas. A distribuição de massa e redshift desses aglomerados oferece insights cruciais sobre os mecanismos de crescimento e agregação de matéria escura e bariônica ao longo da história do universo.</p><p>Realizamos uma correspondência cruzada detalhada com catálogos existentes, incluindo o eRASS1 de aglomerados e catálogos de fontes pontuais. Este processo resultou na identificação de 1.279 correspondências com o eRASS1 e 1.319 correspondências com as fontes pontuais, respectivamente. A comparação das estimativas de massa obtidas para os aglomerados do SPT com as do eROSITA demonstrou uma concordância relativa, reforçando a consistência e a precisão das nossas medições. Essa validação inter-catálogo é fundamental para a robustez dos resultados apresentados.</p><p>Para assegurar a confiabilidade dos dados, conduzimos uma série de verificações de validação rigorosas, utilizando divisões de dados internos e comparações com amostras externas. Esses testes revelaram um aumento na emissão correlacionada, especificamente a emissão &quot;empoeirada&quot;, em função do redshift. Observamos um incremento de temperatura na banda de 220 GHz que é aproximadamente 17 vezes maior para aglomerados em $z\\\\sim1.5$ em comparação com aqueles em $z\\\\sim0.25$. No entanto, as evidências de emissão síncrotron correlacionada foram consideradas fracas, sugerindo diferentes mecanismos de emissão dominantes em distintas faixas de redshift.</p><p>Finalmente, a análise dos dados permitiu identificar vários aglomerados que se destacam como promissores candidatos a lentes gravitacionais fortes. Esses objetos são de particular interesse, pois podem oferecer oportunidades únicas para investigar a distribuição de massa em escalas cosmológicas e para detectar galáxias distantes que seriam, de outra forma, inobserváveis. Estudos futuros focados nesses candidatos podem revelar informações valiosas sobre a matéria escura e a formação de galáxias em épocas primordiais.</p>",
    "body_pt": "<p>Relatamos um novo catálogo de aglomerados de galáxias, selecionado usando o efeito térmico Sunyaev-Zel&#x27;dovich (SZ), a partir de 5 anos de observações do campo principal do SPT-3G. Este trabalho apresenta uma compilação abrangente de aglomerados identificados por meio de dados de alta resolução, contribuindo significativamente para o estudo da formação e evolução de estruturas cósmicas. A metodologia empregada garante uma seleção robusta, permitindo investigações detalhadas sobre as propriedades desses sistemas massivos no universo.</p><p>Os dados utilizados foram extraídos de observações com resolução de minuto de arco, apresentando níveis de ruído branco de 3, 2, 2, 5 e 8, 9 $\\mu$K-arcmin nas frequências de 95, 150 e 220 GHz, respectivamente. A amostra resultante compreende 8.892 candidatos a aglomerados, detectados com uma significância superior a $\\xi=4$. A pureza esperada para esta amostra é de mais de 82%. Adicionalmente, por meio da análise de dados ópticos e infravermelhos complementares, conseguimos confirmar 7.190 desses candidatos como aglomerados de galáxias, solidificando a confiabilidade do catálogo.</p><p>A amostra de aglomerados abrange um vasto intervalo de massa, com valores a partir de $7, 9 \\times 10^{13}$ $M_\\\\odot/h_{70}$. Dentro deste catálogo, identificamos 271 aglomerados localizados em redshifts superiores a $z&gt;1, 5$, o que os torna objetos valiosos para o estudo da evolução de aglomerados em épocas cosmológicas mais remotas. A distribuição de massa e redshift desses aglomerados oferece insights cruciais sobre os mecanismos de crescimento e agregação de matéria escura e bariônica ao longo da história do universo.</p><p>Realizamos uma correspondência cruzada detalhada com catálogos existentes, incluindo o eRASS1 de aglomerados e catálogos de fontes pontuais. Este processo resultou na identificação de 1.279 correspondências com o eRASS1 e 1.319 correspondências com as fontes pontuais, respectivamente. A comparação das estimativas de massa obtidas para os aglomerados do SPT com as do eROSITA demonstrou uma concordância relativa, reforçando a consistência e a precisão das nossas medições. Essa validação inter-catálogo é fundamental para a robustez dos resultados apresentados.</p><p>Para assegurar a confiabilidade dos dados, conduzimos uma série de verificações de validação rigorosas, utilizando divisões de dados internos e comparações com amostras externas. Esses testes revelaram um aumento na emissão correlacionada, especificamente a emissão &quot;empoeirada&quot;, em função do redshift. Observamos um incremento de temperatura na banda de 220 GHz que é aproximadamente 17 vezes maior para aglomerados em $z\\\\sim1.5$ em comparação com aqueles em $z\\\\sim0.25$. No entanto, as evidências de emissão síncrotron correlacionada foram consideradas fracas, sugerindo diferentes mecanismos de emissão dominantes em distintas faixas de redshift.</p><p>Finalmente, a análise dos dados permitiu identificar vários aglomerados que se destacam como promissores candidatos a lentes gravitacionais fortes. Esses objetos são de particular interesse, pois podem oferecer oportunidades únicas para investigar a distribuição de massa em escalas cosmológicas e para detectar galáxias distantes que seriam, de outra forma, inobserváveis. Estudos futuros focados nesses candidatos podem revelar informações valiosas sobre a matéria escura e a formação de galáxias em épocas primordiais.</p>",
    "body_en": "<p>The new analysis still awaits peer review, but it already lays out the central claim clearly.</p><p>That matters because cosmology operates at the edge of what current instruments can measure, where systematic errors and model assumptions are never trivial. Small discrepancies between independent measurements have historically pointed toward missing physics rather than simple calibration errors, and the ongoing tension in the Hubble constant is a live example of how a persistent disagreement between methods can reshape the theoretical landscape. Each new dataset that approaches this territory with independent systematics adds real information to a problem that has resisted easy resolution for more than a decade. We report a new galaxy cluster catalog, selected using the thermal Sunyaev-Zel&#x27;dovich (SZ) effect, from 5 years of observations of the SPT-3G Main field. Drawn from arcminute-resolution data with white noise levels of 3.2, 2.5, and 8.9 $μ$K-arcmin at 95, 150, and 220 GHz, respectively, the sample consists of 8, 892 cluster.</p><p>Using optical and infrared data we have confirmed 7, 190 candidates as clusters. The sample spans a mass range $7.9 \\times 10^{13}$ $M_\\odot/h_{70}$ \\ $ 1$ and 271 at $z&gt;1.5$.</p><p>Compared to previous SZ cluster samples from South Pole Telescope and Atacama Cosmology Telescope data, the SPT-3G sample is highly consistent in mass and redshift but is. We cross match with eRASS1 cluster and point source catalogs, finding 1, 279 and 1, 319 matches, respectively.</p><p>The SPT and eROSITA cluster mass estimates are in relatively good agreement. We perform a series of validation checks using both internal data splits and comparisons to external samples.</p><p>The relevance goes beyond one dataset because even small shifts in measured parameters can matter when the field is testing the limits of the standard cosmological model. The Lambda-CDM framework describes the observable universe with remarkable economy, but its success rests on two components, dark matter and dark energy, whose physical nature remains entirely unknown. Any credible measurement that tightens or loosens the constraints on those components moves the entire theoretical enterprise forward, regardless of whether the immediate result looks dramatic on its own terms.</p><p>These tests show increasing correlated (dusty) emission with redshift, with a $\\sim17\\times$ larger 220 GHz temperature increment for clusters at $z\\sim1.5$ than $z\\sim0. Finally, a number of clusters are flagged as candidate strong gravitational lenses.</p><p>Because this is still a preprint, the result should be read with genuine interest and proportionate caution. Peer review is not a guarantee of correctness, but it is a process that forces authors to respond to technical criticism from specialists who have no stake in a particular outcome. Preprints that survive that process, often with substantive revisions, emerge with a stronger evidential base than the version that first appeared. Until that stage is complete, the responsible reading keeps uncertainty explicitly visible rather than treating the claims as established findings.</p><p>The next step is to see whether the effect survives when independent surveys, different calibration strategies and tighter control of systematic uncertainties enter the picture. Programmes such as Euclid, DESI and the Rubin Observatory will deliver datasets over the next several years that cover the same parameter space with largely independent methods. If the current signal persists through those tests, its theoretical implications will become impossible to set aside. Until peer review and independent follow-up address those open questions, skepticism is not a failure of appreciation for the work; it is part of how science decides what to keep.</p><p class=\"art-source\"><a href=\"https://arxiv.org/abs/2607.01175v1\" target=\"_blank\" rel=\"noopener noreferrer\">Source</a></p>",
    "highlights": [
      "Em foco: Relatamos um novo catálogo de aglomerados de galáxias, selecionado usando o efeito térmico Sunyaev-Zel'dovich, a partir de 5 anos de observações do",
    ...
    "read_pt": "4 min de leitura",
    "read_en": "4 min read",
    "publishedIso": "2026-07-01T17:06:26+00:00",
    "lastModifiedIso": "2026-07-02T17:22:06+00:00",
    ...
    "keywords": [
      ...
      "arXiv Cosmology",
      "Cosmos Week",
      "Aglomerados de galáxias selecionados através do efeito Sunyaev",
      "Zel'dovich em dados de 5 anos da pesquisa principal SPT"
    ],
    "keywords_pt": [
      "Cosmologia",
      "arXiv Cosmology",
    ...
    "keywords_en": [
      ...
      "arXiv Cosmology",
      "Cosmos Week",
      "Galaxy clusters selected through the Sunyaev effect",
      "Zel'dovich on 5-year data from the SPT main survey"
    ],
    "srcUrl": "https://arxiv.org/abs/2607.01175v1",
    "realUrl": "https://www.cosmosweek.com/?article=galaxy-clusters-selected-via-the-sunyaev-zel-dovich-effect-in-5-year-data-from-the-spt-3g-main-s",
    "realUrl_pt": "https://www.cosmosweek.com/?article=galaxy-clusters-selected-via-the-sunyaev-zel-dovich-effect-in-5-year-data-from-the-spt-3g-main-s",
    "realUrl_en": "https://www.cosmosweek.com/?article=galaxy-clusters-selected-via-the-sunyaev-zel-dovich-effect-in-5-year-data-from-the-spt-3g-main-s&lang=en",
    "shareUrl": "https://www.cosmosweek.com/noticia/galaxy-clusters-selected-via-the-sunyaev-zel-dovich-effect-in-5-year-data-from-the-spt-3g-main-s/",
    "shareUrl_pt": "https://www.cosmosweek.com/noticia/galaxy-clusters-selected-via-the-sunyaev-zel-dovich-effect-in-5-year-data-from-the-spt-3g-main-s/",
    "shareUrl_en": "https://www.cosmosweek.com/en/news/galaxy-clusters-selected-via-the-sunyaev-zel-dovich-effect-in-5-year-data-from-the-spt-3g-main-s/",
    "canonicalUrl": "https://www.cosmosweek.com/noticia/galaxy-clusters-selected-via-the-sunyaev-zel-dovich-effect-in-5-year-data-from-the-spt-3g-main-s/",
    "canonicalUrl_pt": "https://www.cosmosweek.com/noticia/galaxy-clusters-selected-via-the-sunyaev-zel-dovich-effect-in-5-year-data-from-the-spt-3g-main-s/",
    "canonicalUrl_en": "https://www.cosmosweek.com/en/news/galaxy-clusters-selected-via-the-sunyaev-zel-dovich-effect-in-5-year-data-from-the-spt-3g-main-s/",
    "defaultLanguage": "pt-BR",
    "availableLanguages": [
      "pt-BR",
      "en-US"
    ...
    "imageAlt": "Aglomerados de galáxias selecionados através do efeito Sunyaev-Zel'dovich em dados de 5 anos da pesquisa principal SPT-3G",
    "imageAlt_pt": "Aglomerados de galáxias selecionados através do efeito Sunyaev-Zel'dovich em dados de 5 anos da pesquisa principal SPT-3G",
    "imageAlt_en": "Galaxy Clusters Selected via the Sunyaev-Zel'dovich Effect in 5 year data from the SPT-3G Main Survey",
  ...
  {
    "id": 7,
    "slug": "smoking-gun-evidence-for-hierarchical-black-hole-mergers",
    "cat": "Astrofísica",
    "catCls": "astrofisica",
    ...
    "highlights_en": [
      "Focus: How stellar-mass black holes grow after their birth is a central open question in astrophysics",
      "Editorial reading: provisional result, not yet formally peer reviewed."
    ],
    "date": "01 jul 2026",
    "date_pt": "01 jul 2026",
    ...
    "read_pt": "4 min de leitura",
    "read_en": "4 min read",
    "publishedIso": "2026-07-01T16:08:46+00:00",
    "lastModifiedIso": "2026-07-02T17:22:06+00:00",
    ...
    "keywords": [
      ...
      "Cosmos Week",
      "Evidências fumegantes para fusões hierárquicas de buracos negros"
    ],
    "keywords_pt": [
      "Astrofísica",
      "arXiv High Energy Astrophysics",
    ...
    "keywords_en": [
      ...
      "arXiv High Energy Astrophysics",
      "Cosmos Week",
      "Smoking Evidence for Hierarchical Black Hole Mergers"
    ],
    "srcUrl": "https://arxiv.org/abs/2607.01121v1",
    "realUrl": "https://www.cosmosweek.com/?article=smoking-gun-evidence-for-hierarchical-black-hole-mergers",
    "realUrl_pt": "https://www.cosmosweek.com/?article=smoking-gun-evidence-for-hierarchical-black-hole-mergers",
    "realUrl_en": "https://www.cosmosweek.com/?article=smoking-gun-evidence-for-hierarchical-black-hole-mergers&lang=en",
    "shareUrl": "https://www.cosmosweek.com/noticia/smoking-gun-evidence-for-hierarchical-black-hole-mergers/",
    "shareUrl_pt": "https://www.cosmosweek.com/noticia/smoking-gun-evidence-for-hierarchical-black-hole-mergers/",
    "shareUrl_en": "https://www.cosmosweek.com/en/news/smoking-gun-evidence-for-hierarchical-black-hole-mergers/",
    "canonicalUrl": "https://www.cosmosweek.com/noticia/smoking-gun-evidence-for-hierarchical-black-hole-mergers/",
    "canonicalUrl_pt": "https://www.cosmosweek.com/noticia/smoking-gun-evidence-for-hierarchical-black-hole-mergers/",
    "canonicalUrl_en": "https://www.cosmosweek.com/en/news/smoking-gun-evidence-for-hierarchical-black-hole-mergers/",
    "defaultLanguage": "pt-BR",
    "availableLanguages": [
      "pt-BR",
      "en-US"
    ...
    "imageAlt": "Evidências Robustas para Fusões Hierárquicas de Buracos Negros",
    "imageAlt_pt": "Evidências Robustas para Fusões Hierárquicas de Buracos Negros",
    "imageAlt_en": "Smoking-gun evidence for hierarchical black-hole mergers",
    "coverageKind": "preprint",
    "coverageKindLabel": "Preprint",
    "coverageKindLabel_pt": "Preprint",
    "coverageKindLabel_en": "Preprint",
  ...
  },
  {
    ...
    "highlights": [
      ...
      "Dado-chave: O Observatório Vera C",
      "Origem institucional: distinguir anúncio de evidência."
    ],
    "highlights_pt": [
      "Ponto central: O Observatório Vera C. Rubin, uma iniciativa conjunta da Fundação Nacional de Ciência (NSF) e do Escritório de Ciência do Departamento de Energia.",
