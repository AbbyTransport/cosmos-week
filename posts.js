...
window.postsData = [
  {
    ...
    "cat": "Astronomia",
    "catCls": "astronomia",
    "img": "https://www.nasa.gov/wp-content/uploads/2026/07/meir.jpg",
    "inline_images": [],
    "video": null,
    "audio": null,
    ...
    "body": "<p>A NASA fornecerá cobertura enquanto os astronautas se aventuram fora da Estação Espacial Internacional durante três caminhadas espaciais em agosto para continuar a atualizar os painéis solares, substituir uma antena de comunicações e conectar cabos de energia e dados de apoio.</p><p>A astronauta da NASA Jessica Meir trabalha dentro da câmara de descompressão Quest da Estação Espacial Internacional em março, seu reflexo visível na viseira do capacete de um traje espacial enquanto ela instala componentes de pernas e braços e troca peças entre trajes.</p><p>Programa de Órbita Terrestre Baixa Chris Dobbins, diretor de voo de caminhada espacial Chloe Mehring, diretor de voo de caminhada espacial A mídia dos Estados Unidos interessada em comparecer pessoalmente deve entrar em contato com a redação de Johnson até às 15h. 29 de julho, em jsccommu@mail. nasa. gov.</p><p>6 Os astronautas da NASA Jessica Meir e Anil Menon sairão da câmara de descompressão da Quest para instalar o hardware que modificará o canal de energia 3B da estação e prepará-lo-á para a futura instalação de um Roll-Out Solar Array da Estação Espacial Internacional (IROSA). 2026 Localização Sede da NASA Termos relacionados Humanos no espaço Estação Espacial Internacional (ISS).</p><p>AVISO DE MÍDIA M26-058 Sede da NASA A astronauta da NASA Jessica Meir trabalha dentro da câmara de descompressão Quest da Estação Espacial Internacional em março, seu reflexo visível na viseira do capacete de um traje espacial enquanto ela instala componentes de pernas e braços. EDT, quinta-feira, 30 de julho, do Johnson Space Center da NASA em Houston.</p><p>Saiba onde assistir online: A mídia dos Estados Unidos interessada em comparecer pessoalmente deve entrar em contato com a redação da Johnson até às 15h, quarta-feira, 29 de julho, em jsccommu@mail. nasa. gov.</p><p class=\"art-source\"><a href=\"https://www.nasa.gov/news-release/nasa-to-cover-three-us-spacewalks-host-preview-news-conference/\" target=\"_blank\" rel=\"noopener noreferrer\">Fonte</a></p>",
    ...
    "body_en": "<p>NASA will provide coverage as astronauts venture outside the International Space Station during three spacewalks in August to continue upgrading solar arrays, replace a communications antenna, and connect power and data cables in support. The institutional report frames the development in practical terms and ties it to the broader mission or observing effort.</p><p>The significance lies in astronomy does not advance on single detections. The field builds confidence by accumulating independent observations across different wavelengths, instruments and epochs until isolated signals become defensible conclusions. What looks convincing in one dataset can dissolve when a second instrument looks at the same target, and what looks marginal can solidify when follow-up campaigns confirm the original reading. The current standard requires that a result survive this triangulation before the community treats it as settled. Low Earth Orbit Program Chris Dobbins, spacewalk flight director Chloe Mehring, spacewalk flight director United States-based media interested in attending in person must contact. July 29, at jsccommu@mail. nasa. gov.</p><p>6 NASA astronauts Jessica Meir and Anil Menon will exit the Quest airlock to install hardware that will modify the station’s 3B power channel and prepare it for the future. 2026 Location NASA Headquarters Related Terms Humans in Space International Space Station (ISS).</p><p>MEDIA ADVISORY M26-058 NASA Headquarters NASA astronaut Jessica Meir works inside the International Space Station’s Quest airlock in March, her reflection visible in a spacesuit. EDT, Thursday, July 30, from NASA’s Johnson Space Center in Houston.</p><p>United States-based media interested in attending in person must contact the Johnson newsroom no later than 3 p. m, Wednesday, July 29, at jsccommu@mail. nasa. gov. NASA astronauts Jessica Meir and Anil Menon will exit the Quest airlock to install hardware that will modify the station’s 3B power channel and prepare it for the future.</p><p>What gives the story weight is not just the object itself, but the way the measurement trims the range of plausible physical explanations. Astronomy has accumulated enough cases to know that the most interesting results are rarely the ones that confirm expectations cleanly; they are the ones that confirm some expectations while complicating others, or that open a parameter space that previous instruments could not reach. The scientific community evaluates these contributions by asking whether the new data constrain a model in a way that older data could not, and whether those constraints survive systematic review.</p><p>Meir will serve as spacewalk crew member 1 and will wear a suit with red stripes. The antenna is a critical communication system NASA uses to transmit data and high‑speed communication between the Mission Control Center in Houston and the space station.</p><p>Because the account originates with NASA News Releases, it functions best as a primary institutional report that is close to the data and operations, not as independent scientific validation. Institutional communications are produced by organizations with legitimate interests in presenting their work in a favorable light, which does not make them unreliable but does make them partial. Details that complicate the narrative, including instrument limitations, unexpected failures and results below projections, tend to be minimized relative to progress messages. Technical documentation and peer-reviewed publications, where they exist, provide the complementary layer that institutional releases cannot substitute.</p><p>The next step is to see whether other instruments and other wavelengths tell the same story. Campaigns with JWST, the VLT, the forthcoming Extremely Large Telescopes and radio arrays will provide the spectral coverage and spatial resolution needed to move from detection to physical characterization. The timeline for that kind of confirmation is typically measured in years, not months, which is worth keeping in mind when reading the current result.</p><p class=\"art-source\"><a href=\"https://www.nasa.gov/news-release/nasa-to-cover-three-us-spacewalks-host-preview-news-conference/\" target=\"_blank\" rel=\"noopener noreferrer\">Source</a></p>",
    "highlights": [
      "Em foco: A NASA fornecerá cobertura enquanto os astronautas se aventuram fora da Estação Espacial Internacional durante três caminhadas espaciais em agosto",
    ...
    "highlights_en": [
      "Focus: NASA will provide coverage as astronauts venture outside the International Space Station during three spacewalks in August to continue upgrading",
    ...
    "realUrl": "https://www.cosmosweek.com/?article=nasa-to-cover-three-us-spacewalks-host-preview-news-conference",
    "realUrl_pt": "https://www.cosmosweek.com/?article=nasa-to-cover-three-us-spacewalks-host-preview-news-conference",
    "realUrl_en": "https://www.cosmosweek.com/?article=nasa-to-cover-three-us-spacewalks-host-preview-news-conference&lang=en",
    "shareUrl": "https://www.cosmosweek.com/noticia/nasa-to-cover-three-us-spacewalks-host-preview-news-conference/",
    "shareUrl_pt": "https://www.cosmosweek.com/noticia/nasa-to-cover-three-us-spacewalks-host-preview-news-conference/",
    "shareUrl_en": "https://www.cosmosweek.com/en/news/nasa-to-cover-three-us-spacewalks-host-preview-news-conference/",
    "canonicalUrl": "https://www.cosmosweek.com/noticia/nasa-to-cover-three-us-spacewalks-host-preview-news-conference/",
    "canonicalUrl_pt": "https://www.cosmosweek.com/noticia/nasa-to-cover-three-us-spacewalks-host-preview-news-conference/",
    "canonicalUrl_en": "https://www.cosmosweek.com/en/news/nasa-to-cover-three-us-spacewalks-host-preview-news-conference/",
    ...
    "imageAlt": "NASA cobrirá três caminhadas espaciais nos EUA e apresentará conferência de notícias prévia",
    "imageAlt_pt": "NASA cobrirá três caminhadas espaciais nos EUA e apresentará conferência de notícias prévia",
    "imageAlt_en": "NASA to Cover Three US Spacewalks, Host Preview News Conference",
    "coverageKind": "agency",
  ...
  },
  {
    ...
    "cat": "Astronomia",
    "catCls": "astronomia",
    "img": "https://assets.science.nasa.gov/content/dam/science/missions/hubble/releases/2026/07/STScI-01KXZZ6H029XBJTKYKRPARFJE9.jpg/jcr:content/renditions/cq5dam.web.1280.1280.jpeg",
    "inline_images": [
      {
        "src": "https://assets.science.nasa.gov/content/dam/science/missions/hubble/releases/2026/07/STScI-01KY7FCQSFZQV2HS57RRQSQF9N.jpg/jcr:content/renditions/cq5dam.web.1280.1280.jpeg",
        "alt": "",
        "alt_pt": "",
        "alt_en": "",
        "caption": "",
    ...
    "body": "<p>O Hubble da NASA descobriu que a formação de estrelas na galáxia de Andrômeda sofreu um declínio de 500 milhões de anos. Processamento de imagem: Joseph DePasquale (STScI) Um novo estudo usando dados do Telescópio Espacial Hubble da NASA descobriu que a formação de estrelas na vizinha galáxia de Andrômeda sofreu um declínio de 500 milhões de anos, com uma queda ainda mais acentuada nos últimos 40.</p><p>Para ver este vídeo, ative o JavaScript e considere atualizar para um navegador que suporte vídeo HTML5. Este filme, criado a partir de uma análise de dados do Telescópio Espacial Hubble da NASA, demonstra como a taxa de formação de estrelas na galáxia de Andrômeda diminuiu nos últimos 500 milhões de anos.</p><p>Compartilhar detalhes Última atualização em 27 de julho de 2026 Editora Andrea Gianopoulos Localização NASA Goddard Space Flight Center Contato com a mídia Claire Andreoli Goddard Space Flight Center da NASA Greenbelt, Maryland claire. andreoli@nasa. O Telescópio Espacial Hubble da NASA descobriu que a formação de estrelas na galáxia de Andrômeda sofreu um declínio de 500 milhões de anos.</p><p>Localizada a cerca de 2, 5 milhões de anos-luz da Terra, praticamente o nosso quintal cósmico, Andrómeda oferece uma oportunidade para os astrónomos examinarem detalhadamente as suas populações estelares, levando a uma melhor compreensão do passado de galáxias como a nossa. No total, a equipa mediu cerca de 200 milhões de estrelas individuais em toda a galáxia, dando-lhes uma imagem detalhada da atividade passada de Andrómeda.</p><p>Os dados da pesquisa do Tesouro Pancromático do Sul de Andrômeda do Hubble permitiram à equipe estudar a história da formação estelar em Andrômeda, perto de M32. A equipe planeja continuar analisando os dados do Hubble e combiná-los com dados de observatórios terrestres para obter informações adicionais sobre a história de Andrômeda.</p><p>O gigantesco campo de visão de Roman pode cobrir pelo menos 100 vezes mais área que o Hubble em comprimentos de onda do infravermelho próximo numa única observação.</p><p class=\"art-source\"><a href=\"https://science.nasa.gov/missions/hubble/nasas-hubble-shows-star-formation-in-andromeda-galaxy-winding-down/\" target=\"_blank\" rel=\"noopener noreferrer\">Fonte</a></p>",
    "body_pt": "<p>O Hubble da NASA descobriu que a formação de estrelas na galáxia de Andrômeda sofreu um declínio de 500 milhões de anos. Processamento de imagem: Joseph DePasquale (STScI) Um novo estudo usando dados do Telescópio Espacial Hubble da NASA descobriu que a formação de estrelas na vizinha galáxia de Andrômeda sofreu um declínio de 500 milhões de anos, com uma queda ainda mais acentuada nos últimos 40.</p><p>Para ver este vídeo, ative o JavaScript e considere atualizar para um navegador que suporte vídeo HTML5. Este filme, criado a partir de uma análise de dados do Telescópio Espacial Hubble da NASA, demonstra como a taxa de formação de estrelas na galáxia de Andrômeda diminuiu nos últimos 500 milhões de anos.</p><p>Compartilhar detalhes Última atualização em 27 de julho de 2026 Editora Andrea Gianopoulos Localização NASA Goddard Space Flight Center Contato com a mídia Claire Andreoli Goddard Space Flight Center da NASA Greenbelt, Maryland claire. andreoli@nasa. O Telescópio Espacial Hubble da NASA descobriu que a formação de estrelas na galáxia de Andrômeda sofreu um declínio de 500 milhões de anos.</p><p>Localizada a cerca de 2, 5 milhões de anos-luz da Terra, praticamente o nosso quintal cósmico, Andrómeda oferece uma oportunidade para os astrónomos examinarem detalhadamente as suas populações estelares, levando a uma melhor compreensão do passado de galáxias como a nossa. No total, a equipa mediu cerca de 200 milhões de estrelas individuais em toda a galáxia, dando-lhes uma imagem detalhada da atividade passada de Andrómeda.</p><p>Os dados da pesquisa do Tesouro Pancromático do Sul de Andrômeda do Hubble permitiram à equipe estudar a história da formação estelar em Andrômeda, perto de M32. A equipe planeja continuar analisando os dados do Hubble e combiná-los com dados de observatórios terrestres para obter informações adicionais sobre a história de Andrômeda.</p><p>O gigantesco campo de visão de Roman pode cobrir pelo menos 100 vezes mais área que o Hubble em comprimentos de onda do infravermelho próximo numa única observação.</p><p class=\"art-source\"><a href=\"https://science.nasa.gov/missions/hubble/nasas-hubble-shows-star-formation-in-andromeda-galaxy-winding-down/\" target=\"_blank\" rel=\"noopener noreferrer\">Fonte</a></p>",
    "body_en": "<p>NASA’s Hubble finds that star formation in the Andromeda galaxy has undergone a 500-million-year decline. The institutional report frames the development in practical terms and ties it to the broader mission or observing effort.</p><p>It matters because astronomy does not advance on single detections. The field builds confidence by accumulating independent observations across different wavelengths, instruments and epochs until isolated signals become defensible conclusions. What looks convincing in one dataset can dissolve when a second instrument looks at the same target, and what looks marginal can solidify when follow-up campaigns confirm the original reading. The current standard requires that a result survive this triangulation before the community treats it as settled. Joseph DePasquale (STScI) A new study using data from NASA’s Hubble Space Telescope finds that star formation in the nearby Andromeda galaxy has undergone a 500-million-year. To view this video please enable JavaScript, and consider upgrading to a web browser that supports HTML5 video This movie, created from an analysis of data from NASA’s Hubble.</p><p>Share Details Last Updated Jul 27, 2026 Editor Andrea Gianopoulos Location NASA Goddard Space Flight Center Contact Media Claire Andreoli NASA’s Goddard Space Flight Center. NASA’s Hubble Space Telescope finds that star formation in the Andromeda galaxy has undergone a 500-million-year decline.</p><p>Located about 2.5 million light-years from Earth, practically our cosmic backyard, Andromeda offers an opportunity for astronomers to examine its stellar populations in detail. In total, the team measured about 200 million individual stars across the galaxy, giving them a detailed picture of Andromeda’s past activity.</p><p>Survey data from the Panchromatic Hubble Andromeda Southern Treasury allowed the team to study the history of star formation in Andromeda near M32. To view this video please enable JavaScript, and consider upgrading to a web browser that supports HTML5 video The team plans to continue analyzing the Hubble data and combine it.</p><p>What gives the story weight is not just the object itself, but the way the measurement trims the range of plausible physical explanations. Astronomy has accumulated enough cases to know that the most interesting results are rarely the ones that confirm expectations cleanly; they are the ones that confirm some expectations while complicating others, or that open a parameter space that previous instruments could not reach. The scientific community evaluates these contributions by asking whether the new data constrain a model in a way that older data could not, and whether those constraints survive systematic review.</p><p>Roman’s gigantic field of view can cover at least 100 times as much area as Hubble at near-infrared wavelengths in a single observation. A newly approved Roman observing program will image the entirety of Andromeda’s disk and areas of its surrounding halo, allowing astronomers to measure hundreds of millions of.</p><p>Because the account originates with NASA News Releases, it functions best as a primary institutional report that is close to the data and operations, not as independent scientific validation. Institutional communications are produced by organizations with legitimate interests in presenting their work in a favorable light, which does not make them unreliable but does make them partial. Details that complicate the narrative, including instrument limitations, unexpected failures and results below projections, tend to be minimized relative to progress messages. Technical documentation and peer-reviewed publications, where they exist, provide the complementary layer that institutional releases cannot substitute.</p><p>The next step is to see whether other instruments and other wavelengths tell the same story. Campaigns with JWST, the VLT, the forthcoming Extremely Large Telescopes and radio arrays will provide the spectral coverage and spatial resolution needed to move from detection to physical characterization. The timeline for that kind of confirmation is typically measured in years, not months, which is worth keeping in mind when reading the current result.</p><p class=\"art-source\"><a href=\"https://science.nasa.gov/missions/hubble/nasas-hubble-shows-star-formation-in-andromeda-galaxy-winding-down/\" target=\"_blank\" rel=\"noopener noreferrer\">Source</a></p>",
    "highlights": [
      "Em foco: O Hubble da NASA descobriu que a formação de estrelas na galáxia de Andrômeda sofreu um declínio de 500 milhões de anos",
      "Detalhe: Origem institucional: distinguir anúncio de evidência",
      "Leitura editorial: release institucional, útil como fonte primária, mas não como validação independente."
    ],
    "highlights_pt": [
    ...
    "realUrl": "https://www.cosmosweek.com/?article=nasa-s-hubble-shows-star-formation-in-andromeda-galaxy-winding-down",
    "realUrl_pt": "https://www.cosmosweek.com/?article=nasa-s-hubble-shows-star-formation-in-andromeda-galaxy-winding-down",
    "realUrl_en": "https://www.cosmosweek.com/?article=nasa-s-hubble-shows-star-formation-in-andromeda-galaxy-winding-down&lang=en",
    "shareUrl": "https://www.cosmosweek.com/noticia/nasa-s-hubble-shows-star-formation-in-andromeda-galaxy-winding-down/",
    "shareUrl_pt": "https://www.cosmosweek.com/noticia/nasa-s-hubble-shows-star-formation-in-andromeda-galaxy-winding-down/",
    "shareUrl_en": "https://www.cosmosweek.com/en/news/nasa-s-hubble-shows-star-formation-in-andromeda-galaxy-winding-down/",
    "canonicalUrl": "https://www.cosmosweek.com/noticia/nasa-s-hubble-shows-star-formation-in-andromeda-galaxy-winding-down/",
    "canonicalUrl_pt": "https://www.cosmosweek.com/noticia/nasa-s-hubble-shows-star-formation-in-andromeda-galaxy-winding-down/",
    "canonicalUrl_en": "https://www.cosmosweek.com/en/news/nasa-s-hubble-shows-star-formation-in-andromeda-galaxy-winding-down/",
    "defaultLanguage": "pt-BR",
    "availableLanguages": [
      "pt-BR",
      "en-US"
    ...
    "imageAlt": "Hubble da NASA mostra formação de estrelas na galáxia de Andrômeda diminuindo",
    "imageAlt_pt": "Hubble da NASA mostra formação de estrelas na galáxia de Andrômeda diminuindo",
    "imageAlt_en": "NASA’s Hubble Shows Star Formation in Andromeda Galaxy Winding Down",
    "coverageKind": "agency",
    "coverageKindLabel": "Fonte institucional",
    "coverageKindLabel_pt": "Fonte institucional",
    "coverageKindLabel_en": "Institutional source",
  ...
  },
  {
    ...
    "highlights": [
      ...
      "Dado-chave: Cientistas dos Institutos Nacionais de Saúde e seus colegas decifraram uma via reguladora crucial na defesa imunológica do corpo contra a.",
    ...
    "highlights_en": [
      ...
      "Key detail: Scientists at the National Institutes of Health and their colleagues have deciphered a crucial regulatory pathway in the body’s immunologic.",
  ...
  },
  {
    ...
    "highlights": [
      ...
      "Dado-chave: As diferenças na rocha subjacente e na forma como os rios distribuem os sedimentos fazem com que a costa a oeste de Portland pareça diferente",
      "Origem institucional: distinguir anúncio de evidência."
    ],
    "highlights_pt": [
      "Ponto central: As diferenças na rocha subjacente e na forma como os rios distribuem os sedimentos fazem com que a costa a oeste de Portland pareça diferente.",
    ...
    "highlights_en": [
      ...
      "Key detail: Differences in the underlying bedrock and how rivers distribute sediment make the coastlines west of Portland look unlike those northeast of the.",
      "Institutional origin: separate announcement from evidence."
    ],
    "date": "21 jul 2026",
    "date_pt": "21 jul 2026",
